...
use OCA\Mail\Migration\Version5010Date20260722000000;
...
class Version5010Date20260722000000Test extends TestCase {
	public function testPostgresCreatesTheDescendingIndexConcurrently(): void {
		...
		$migration = new Version5010Date20260722000000($connection);
