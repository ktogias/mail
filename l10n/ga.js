OC.L10N.register(
    ...
    "Mark messages as read" : "Marcáil teachtaireachtaí mar léite",
    ...
    "Send" : "Seol",
    "Refresh" : "Athnuaigh",
    "Heading1" : "Ceannteideal1",
    "Heading2" : "Ceannteideal2",
    "Heading3" : "Ceannteideal3",
    "About" : "Faoi",
    ...
    "_After %n second_::_After %n seconds_" : ["Tar éis %n soicind","Tar éis %n soicind","Tar éis %n soicind","Tar éis %n soicind","Tar éis %n soicind"],
    ...
    "Messages with no 'To' recipients may be rejected by some mail providers." : "D’fhéadfadh roinnt soláthraithe ríomhphoist teachtaireachtaí gan aon fhaighteoir ‘Chuig’ a dhiúltú.",
    "Cc" : "Cc",
    "Bcc" : "Bcc",
    "Subject" : "Ábhar",
    "Subject …" : "Ábhar …",
    ...
    "Remove attachment {fileName}" : "Bain an ceangaltán {fileName}",
    "Add as attachment" : "Cuir leis mar cheangaltán",
    "Add as share link" : "Cuir leis mar nasc comhroinnte",
    ...
    "Delegated access to {displayName}" : "Rochtain tarmligthe chuig {displayName}",
    "Could not delegate access" : "Níorbh fhéidir rochtain a tharmligean",
    "Revoked access for {displayName}" : "Rochtain curtha ar ceal do {displayName}",
    ...
    "Message saved to Files" : "Teachtaireacht sábháilte chuig Comhaid",
    "Message could not be saved" : "Níorbh fhéidir an teachtaireacht a shábháil",
    "This summary was AI-generated" : "Gineadh an achoimre seo le hintleacht shaorga",
    "Encrypted message" : "Teachtaireacht criptithe",
    "This message is unread" : "Tá an teachtaireacht seo gan léamh",
    "Choose a folder to store the message in" : "Roghnaigh fillteán chun an teachtaireacht a stóráil ann",
    "Unfavorite" : "Mí-mheas",
    ...
    "Save message to Files" : "Sábháil teachtaireacht chuig Comhaid",
    ...
    "Could not generate direct link: Message ID is missing" : "Níorbh fhéidir nasc díreach a ghiniúint: Tá ID an teachtaireachta ar iarraidh",
    "Direct link copied to clipboard" : "Cóipeáladh nasc díreach chuig an ngearrthaisce",
    "Copy direct link" : "Cóipeáil nasc díreach",
    "Forward" : "Ar aghaidh",
    "Only for message recipients" : "Do fhaighteoirí teachtaireachtaí amháin",
    ...
    "Restore composer" : "Athchóirigh an cumadóir",
    "Maximize composer" : "Cumadóir a uasmhéadú",
    "Minimize composer" : "Cumadóir a íoslaghdú",
    "Close contact info" : "Dún faisnéis teagmhála",
    ...
    "Signature …" : "Síniú …",
    "This signature is larger than 2 MB, usually because an image is embedded in it. It is added to every message you send and may slow down the editor." : "Tá an síniú seo níos mó ná 2 MB, de ghnáth toisc go bhfuil íomhá leabaithe ann. Cuirtear le gach teachtaireacht a sheolann tú é agus d’fhéadfadh sé moill a chur ar an eagarthóir.",
    "This signature contains images. New messages will use rich text, even though your writing mode is set to plain text." : "Tá íomhánna sa síniú seo. Úsáidfear téacs saibhir i dteachtaireachtaí nua, cé go bhfuil do mhodh scríbhneoireachta socraithe go téacs simplí.",
    ...
    "This summary is AI-generated and may contain mistakes." : "Gineadh an achoimre seo le hintleacht shaorga agus d’fhéadfadh botúin a bheith ann.",
    ...
    "Text blocks are reusable pieces of text that can be inserted in messages. Visit the Settings panel to create your own." : "Is píosaí téacs in-athúsáidte iad bloic téacs is féidir a chur isteach i dteachtaireachtaí. Tabhair cuairt ar an bpainéal Socruithe chun do chuid féin a chruthú.",
    ...
    "Insert image from Files" : "Cuir íomhá isteach ó Chomhaid",
    "Choose an image" : "Roghnaigh íomhá",
    "Select an image" : "Roghnaigh íomhá",
    "Insert {name}" : "Cuir isteach {name}",
    "The selected image is too large to embed" : "Tá an íomhá roghnaithe ró-mhór le leabú",
    "Could not insert the selected image" : "Níorbh fhéidir an íomhá roghnaithe a chur isteach",
    "All" : "Gach",
    "Drafts" : "Dréachtaí",
    ...
    "Date:" : "Dáta:",
    "Printing from the browser menu is not supported" : "Ní thacaítear le priontáil ón roghchlár brabhsálaí",
    "To print this email, press {shortcut}, or use the \"Print message\" action in the message menu." : "Chun an ríomhphost seo a phriontáil, brúigh {shortcut}, nó bain úsáid as an ngníomh \"Priontáil teachtaireacht\" sa roghchlár teachtaireachtaí.",
