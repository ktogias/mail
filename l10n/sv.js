OC.L10N.register(
    ...
    "{account_email} has been delegated to you" : "{account_email} har delegerats till dig",
    "{user} delegated {account} to you" : "{user} delegerade {account} till dig",
    "{account_email} is no longer delegated to you" : "{account_email}är inte längre delegerat till dig",
    "{user} revoked delegation for {account}" : "{user} återkallade delegation för {account}",
    "Mail Application" : "E-postapp",
    "Mails" : "E-post",
    "Sender email: %1$s is not in the address book, but the sender name: %2$s is in the address book with the following email: %3$s" : "Avsändarens e-postadress %1$s finns inte i adressboken, men avsändarnamnet %2$s finns där med följande e-postadress: %3$s",
    "Sender email: %1$s is not in the address book, but the sender name: %2$s is in the address book with the following emails: %3$s" : "Avsändarens e-postadress %1$s finns inte i adressboken, men avsändarnamnet %2$s finns där med följande e-postadresser: %3$s",
    ...
    "Reply-To email: %1$s is different from sender email: %2$s" : "Svarsadressen %1$s skiljer sig från avsändarens e-postadress %2$s",
    ...
    "Mail Transport configuration" : "Konfiguration av e-posttransport",
    ...
    "**💌 A mail app for Nextcloud**\n\n- **🚀 Integration with other Nextcloud apps!** Currently Contacts, Calendar & Files – more to come.\n- **📥 Multiple mail accounts!** Personal and company account? No problem, and a nice unified inbox. Connect any IMAP account.\n- **🔒 Send & receive encrypted mails!** Using the great [Mailvelope](https://mailvelope.com) browser extension.\n- **🙈 We’re not reinventing the wheel!** Based on the great [Horde](https://www.horde.org) libraries.\n- **📬 Want to host your own mail server?** We do not have to reimplement this as you could set up [Mail-in-a-Box](https://mailinabox.email)!\n\n## Ethical AI Rating\n\n### Priority Inbox\n\nPositive:\n* The software for training and inferencing of this model is open source.\n* The model is created and trained on-premises based on the user's own data.\n* The training data is accessible to the user, making it possible to check or correct for bias or optimise the performance and CO2 usage.\n\n### Thread Summaries (opt-in)\n\n**Rating:** 🟢/🟡/🟠/🔴\n\nThe rating depends on the installed text processing backend. See [the rating overview](https://docs.nextcloud.com/server/latest/admin_manual/ai/index.html) for details.\n\nLearn more about the Nextcloud Ethical AI Rating [in our blog](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/)." : "**💌 En e-postapp för Nextcloud**\n\n- **🚀 Integrering med andra Nextcloud-appar!** För närvarande Kontakter, Kalender och Filer – fler kommer.\n- **📥 Flera e-postkonton!** Privat- och företagskonto? Inga problem, och dessutom en praktisk gemensam inkorg. Anslut valfritt IMAP-konto.\n- **🔒 Skicka och ta emot krypterad e-post!** Med det utmärkta webbläsartillägget [Mailvelope](https://mailvelope.com).\n- **🙈 Vi uppfinner inte hjulet på nytt!** Bygger på de utmärkta biblioteken från [Horde](https://www.horde.org).\n- **📬 Vill du driva en egen e-postserver?** Vi behöver inte återskapa detta eftersom du kan konfigurera [Mail-in-a-Box](https://mailinabox.email)!\n\n## Etisk AI-klassificering\n\n### Prioriterad inkorg\n\nPositivt:\n* Programvaran för träning och inferens av modellen har öppen källkod.\n* Modellen skapas och tränas lokalt utifrån användarens egna data.\n* Träningsdata är tillgängliga för användaren, vilket gör det möjligt att kontrollera eller korrigera snedvridningar och optimera prestanda och koldioxidanvändning.\n\n### Trådsammanfattningar (valfritt)\n\n**Klassificering:** 🟢/🟡/🟠/🔴\n\nKlassificeringen beror på den installerade bakänden för textbearbetning. Mer information finns i [översikten över klassificeringar](https://docs.nextcloud.com/server/latest/admin_manual/ai/index.html).\n\nLäs mer om Nextclouds etiska AI-klassificering [i vår blogg](https://nextcloud.com/blog/nextcloud-ethical-ai-rating/).",
    ...
    "Snoozed messages are moved in:" : "Uppskjutna meddelanden flyttas till:",
    ...
    "Checking mail host connectivity" : "Kontrollerar anslutningen till e-postservern",
    ...
    "Google requires OAuth authentication. If your Nextcloud admin has not configured Google OAuth, you can use a Google App Password instead." : "Google kräver OAuth-autentisering. Om Nextcloud-administratören inte har konfigurerat Google OAuth kan du använda ett applösenord från Google i stället.",
    "Microsoft requires OAuth authentication. Ask your Nextcloud admin to configure Microsoft OAuth in the admin settings." : "Microsoft kräver OAuth-autentisering. Be Nextcloud-administratören att konfigurera Microsoft OAuth i administratörsinställningarna.",
    ...
    "Activate" : "Aktivera",
    "Make mails available to Context Chat" : "Gör e-post tillgänglig för Context Chat",
    ...
    "Could not update preference" : "Det gick inte att uppdatera inställningen",
    "Mail settings" : "E-postinställningar",
    "General" : "Allmänt",
    "Set as default mail app" : "Använd som standardapp för e-post",
    "{email} (delegated)" : "{email} (delegerat)",
    ...
    "Security" : "Säkerhet",
    "Manage your internal addresses and domains to ensure recognized contacts stay unmarked" : "Hantera interna adresser och domäner så att kända kontakter inte markeras",
    "S/MIME" : "S/MIME",
    ...
    "This application includes CKEditor, an open-source editor. Copyright © CKEditor contributors. Licensed under GPLv2." : "Den här appen innehåller CKEditor, en redigerare med öppen källkod. Copyright © CKEditor-bidragsgivarna. Licensierad under GPLv2.",
    ...
    "Could not update certificate" : "Det gick inte att uppdatera certifikat",
    ...
    "Error saving draft" : "Det gick inte att spara utkastet",
    ...
    "Remove attachment {fileName}" : "Ta bort bilaga {fileName}",
    "Add as attachment" : "Lägg till som bilaga",
    "Add as share link" : "Lägg till som delningslänk",
    "_The attachment exceed the allowed attachments size of {size}. Please share the file via link instead._::_The attachments exceed the allowed attachments size of {size}. Please share the files via link instead._" : ["Bilagan överskrider den tillåtna bilagestorleken på {size}. Dela filen via en länk i stället.","Bilagorna överskrider den tillåtna bilagestorleken på {size}. Dela filerna via länkar i stället."],
    ...
    "Expand composer" : "Expandera redigeraren",
    "Close composer" : "Stäng redigeraren",
    "Confirm" : "Bekräfta",
    "Delegate access" : "Delegera behörighet",
    "Revoke" : "Återkalla",
    "{userId} will no longer be able to act on your behalf" : "{userId} kommer inte längre att kunna agera för din räkning",
    "Could not fetch delegates" : "Det gick inte att hämta ombud",
    "Delegated access to {displayName}" : "Delegerad åtkomst till {displayName}",
    "Could not delegate access" : "Det gick inte att delegera åtkomst",
    "Revoked access for {displayName}" : "Återkallade tillgång för {displayName}",
    "Could not revoke delegation" : "Det gick inte att återkalla delegeringen",
    "Delegation" : "Delegering",
    "Allow users to send, receive, and delete mail on your behalf" : "Låt användare skicka, ta emot och radera e-post åt dig",
    "Revoke access" : "Återkalla åtkomst",
    "Add delegate" : "Lägg till delegering",
    "Select a user" : "Välj en användare",
    "They will be able to send, receive, and delete mail on your behalf" : "De kommer att kunna skicka, ta emot och radera post åt dig",
    "Revoke access?" : "Återkalla åtkomst?",
    ...
    "No messages in this folder" : "Det finns inga meddelanden i den här mappen",
    ...
    "Set reminder for this weekend" : "Ange en påminnelse för den här helgen",
    "Next week – {timeLocale}" : "Nästa vecka – {timeLocale}",
    "Set reminder for next week" : "Ställ in påminnelse för nästa vecka",
    "Could not apply tag, configured tag not found" : "Det gick inte att använda taggen eftersom den konfigurerade taggen inte hittades",
    "Could not move thread, destination mailbox not found" : "Det gick inte att flytta tråden eftersom målmappen inte hittades",
    "Could not execute quick action" : "Det gick inte att utföra snabbåtgärden",
    "Quick action executed" : "Snabbval utfört",
    "No trash folder configured" : "Ingen mapp för papperskorgen är konfigurerad",
    "Could not delete message" : "Det gick inte att ta bort meddelandet",
    "Could not archive message" : "Det gick inte att arkivera meddelandet",
    "Thread was snoozed" : "Tråden sköts upp",
    "Could not snooze thread" : "Kunde inte skjuta upp tråden",
    "Thread was unsnoozed" : "Tråden är inte längre uppskjuten",
    "Could not unsnooze thread" : "Kunde inte ta bort uppskjutningen av tråden",
    "Message saved to Files" : "Meddelandet sparades i Filer",
    "Message could not be saved" : "Meddelandet kunde inte sparas",
    "This summary was AI-generated" : "Den här sammanfattningen genererades av AI",
    "Encrypted message" : "Krypterat meddelande",
    "This message is unread" : "Det här meddelandet är oläst",
    "Choose a folder to store the message in" : "Välj en mapp där meddelandet ska sparas",
    "Unfavorite" : "Inte favorit",
    "Favorite" : "Favorit",
    "Unread" : "Oläst",
    "Read" : "Läs",
    "Unimportant" : "Oviktigt",
    "Mark not spam" : "Markera som inte skräppost",
    ...
    "Back" : "Tillbaka",
    "Set custom snooze" : "Ange egen tid för uppskjutning",
    ...
    "Save message to Files" : "Spara meddelandet i Filer",
    ...
    "_Unfavorite {number}_::_Unfavorite {number}_" : ["Ta bort {number} från favoriter","Ta bort {number} från favoriter"],
    "_Favorite {number}_::_Favorite {number}_" : ["Markera {number} som favorit","Markera {number} som favoriter"],
    "_Unselect {number}_::_Unselect {number}_" : ["Avmarkera {number}","Avmarkera {number}"],
    "_Mark {number} as spam_::_Mark {number} as spam_" : ["Markera {number} som skräppost","Markera {number} som skräppost"],
    "_Mark {number} as not spam_::_Mark {number} as not spam_" : ["Markera {number} som inte skräppost","Markera {number} som inte skräppost"],
    "_Edit tags for {number}_::_Edit tags for {number}_" : ["Redigera taggar för {number}","Redigera taggar för {number}"],
    ...
    "This description was generated by AI." : "Den här beskrivningen genererades av AI.",
    "Event created" : "Evenemang skapat",
    "Could not create event" : "Det gick inte att skapa händelsen",
    ...
    "You tentatively accepted this invitation" : "Du svarade preliminärt ja på den här inbjudan",
    ...
    "Could not remove internal address {sender}" : "Det gick inte att ta bort den interna adressen {sender}",
    "Could not add internal address {address}" : "Det gick inte att lägga till den interna adressen {address}",
    "individual" : "individ",
    "domain" : "domän",
    "Remove" : "Ta bort",
    "Add internal address" : "Lägg till intern adress",
    "Add internal email or domain" : "Lägg till intern e-postadress eller domän",
    ...
    "Could not mark message as seen/unseen" : "Det gick inte att markera meddelandet som läst eller oläst",
    ...
    "Messages will automatically be marked as important using AI. The system learns from which messages you interact with or mark as important. In the beginning you might have to manually change the importance to teach it, but it will improve over time" : "Meddelanden markeras automatiskt som viktiga med hjälp av AI. Systemet lär sig av vilka meddelanden du interagerar med eller markerar som viktiga. I början kan du behöva ändra prioriteten manuellt för att lära systemet, men det förbättras med tiden",
    ...
    "AI identifies messages sent by you that likely require a reply but did not receive one after a couple of days and shows them here" : "AI identifierar meddelanden som du har skickat och som sannolikt behöver ett svar men inte har fått något efter några dagar, och visar dem här",
    "Favorites" : "Favoriter",
    ...
    "Load more follow ups" : "Läs in fler uppföljningar",
    ...
    "Could not send mdn" : "Det gick inte att skicka läskvittot",
    ...
    "Message was snoozed" : "Meddelandet sköts upp",
    "Could not snooze message" : "Kunde inte skjuta upp meddelandet",
    "Message was unsnoozed" : "Meddelandet är inte längre uppskjutet",
    "Could not unsnooze message" : "Kunde inte ta bort uppskjutningen av meddelandet",
    "Could not generate direct link: Message ID is missing" : "Kunde inte skapa en direktlänk: meddelande-ID saknas",
    "Direct link copied to clipboard" : "Direktlänk kopierad till urklipp",
    "Copy direct link" : "Kopiera direktlänk",
    ...
    "Create mail filter" : "Skapa e-postfilter",
    "Download thread data for debugging" : "Hämta tråddata för felsökning",
    "Suggested replies are using AI" : "Föreslagna svar använder AI",
    ...
    "Download Zip" : "Hämta ZIP-arkiv",
    "_View {count} more attachment_::_View {count} more attachments_" : ["Visa ytterligare {count} bilaga","Visa ytterligare {count} bilagor"],
    ...
    "could not delete account" : "det gick inte att ta bort kontot",
    "Provisioned account is disabled" : "Det provisionerade kontot är inaktiverat",
    ...
    "Delegate account" : "Delegera konto",
    ...
    "Failed to save message" : "Det gick inte att spara meddelandet",
    "Failed to save draft" : "Det gick inte att spara utkastet",
    "attachment" : "bilaga",
    "attached" : "bifogad",
    ...
    "Could not open outbox" : "Det gick inte att öppna utkorgen",
    "Pending or not sent messages will show up here" : "Väntande eller oskickade meddelanden visas här",
    "Could not copy to \"Sent\" folder" : "Det gick inte att kopiera till mappen ”Skickat”",
    "Mail server error" : "Server fel",
    "Message could not be sent" : "Det gick inte att skicka meddelandet",
    ...
    "Could not copy email address to clipboard" : "Det gick inte att kopiera e-postadressen till urklipp",
    ...
    "An error occurred, unable to rename the tag." : "Ett fel uppstod. Det gick inte att byta namn på taggen.",
    ...
    "An error occurred, unable to create the tag." : "Ett fel uppstod. Det gick inte att skapa taggen.",
    "Add default tags" : "Lägg till standardtaggar",
    "Add tag" : "Lägg till tagg",
    "Saving tag …" : "Sparar tagg ...",
    "Task created" : "Uppgift skapad",
    "Could not create task" : "Kunde inte skapa uppgiften",
    "No calendars with task list support" : "Inga kalendrar med stöd för uppgiftslistor",
    "Summarizing thread failed." : "Det gick inte att sammanfatta tråden.",
    ...
    "Signature unverified " : "Signaturen är inte verifierad",
    ...
    "Could not unsubscribe from mailing list" : "Det gick inte att avsluta prenumerationen på e-postlistan",
    ...
    "Mark as unfavorite" : "Ta bort från favoriter",
    ...
    "{name} Assistant" : "Assistenten {name}",
    ...
    "The message could not be translated" : "Det gick inte att översätta meddelandet",
    "Translation copied to clipboard" : "Översättningen har kopierats till urklipp",
    "Translation could not be copied" : "Det gick inte att kopiera översättningen",
    ...
    "This translation is generated using AI and may contain inaccuracies" : "Den här översättningen har genererats med AI och kan innehålla felaktigheter",
    ...
    "Could not remove trusted sender {sender}" : "Det gick inte att ta bort den betrodda avsändaren {sender}",
    ...
    "Stop ends all processing" : "Om du stoppar avslutas all bearbetning",
    "Sender" : "Avsändare",
    "Recipient" : "Mottagare",
    ...
    "Delete mail filter {filterName}?" : "Ta bort e-postfiltret {filterName}?",
    ...
    "Could not save filter" : "Det gick inte att spara filtret",
    "Filter deleted" : "Filtret är raderat",
    "Could not delete filter" : "Det gick inte att ta bort filtret",
    ...
    "Failed to delete quick action" : "Det gick inte att ta bort snabbåtgärden",
    "Failed to update quick action" : "Det gick inte att uppdatera snabbåtgärden",
    ...
    "Failed to create quick action" : "Det gick inte att skapa snabbåtgärden",
    "Failed to add steps to quick action" : "Det gick inte att lägga till steg i snabbåtgärden",
    "Quick action created" : "Snabbval skapat",
    "Failed to delete action step" : "Det gick inte att ta bort åtgärdssteget",
    ...
    "Error saving config" : "Det gick inte att spara konfigurationen",
    "Saved config for \"{domain}\"" : "Sparade konfiguration för \"{domain}\"",
    "Could not save provisioning setting" : "Kunde inte spara provisioneringsinställningen",
    "_Successfully provisioned {count} account._::_Successfully provisioned {count} accounts._" : ["Provisionerade {count} konto.","Provisionerade {count} konton."],
    "There was an error when provisioning accounts." : "Ett fel inträffade när konton provisionerades.",
    "Successfully deleted and deprovisioned accounts for \"{domain}\"" : "Konton för ”{domain}” har tagits bort och avprovisionerats",
    "Error when deleting and deprovisioning accounts for \"{domain}\"" : "Fel när konton för ”{domain}” togs bort och avprovisionerades",
    "Could not save default classification setting" : "Det gick inte att spara standardinställningen för klassificering",
    "Mail app" : "Mail-appen",
    "The mail app allows users to read mails on their IMAP accounts." : "Mail-appen gör det möjligt för användare att läsa e-post från sina IMAP-konton.",
    ...
    "Account provisioning" : "Kontoprovisionering",
    "A provisioning configuration will provision all accounts with a matching email address." : "En provisioneringskonfiguration provisionerar alla konton med en matchande e-postadress.",
    "Using the wildcard (*) in the provisioning domain field will create a configuration that applies to all users, provided they do not match another configuration." : "Om jokertecknet (*) används i fältet för provisioneringsdomän skapas en konfiguration som gäller alla användare, förutsatt att de inte matchar någon annan konfiguration.",
    "The provisioning mechanism will prioritise specific domain configurations over the wildcard domain configuration." : "Provisioneringsmekanismen prioriterar specifika domänkonfigurationer framför konfigurationen med en jokerteckendomän.",
    ...
    "These settings can be used in conjunction with each other." : "Dessa inställningar kan användas tillsammans.",
    ...
    "This setting only makes most sense if you use the same user back-end for your Nextcloud and mail server of your organization." : "Den här inställningen är främst användbar om organisationens Nextcloud- och e-postserver använder samma användarbakände.",
    "Provisioning Configurations" : "Provisioneringskonfigurationer",
    "Add new config" : "Lägg till ny konfiguration",
    "Provision all accounts" : "Provisionera alla konton",
    ...
    "Anti Spam Service" : "Antispamtjänst",
    ...
    "Gmail allows users to access their email via IMAP. For security reasons this access is only possible with an OAuth 2.0 connection or Google accounts that use two-factor authentication and app passwords." : "Gmail låter användare komma åt sin e-post via IMAP. Av säkerhetsskäl krävs antingen en OAuth 2.0-anslutning eller ett Google-konto med tvåfaktorsautentisering och ett applösenord.",
    "You have to register a new Client ID for a \"Web application\" in the Google Cloud console. Add the URL {url} as authorized redirect URI." : "Du måste registrera ett nytt klient-ID för en ”webbapp” i Google Cloud-konsolen. Lägg till URL:en {url} som auktoriserad omdirigerings-URI.",
    "Microsoft integration" : "Microsoft-integrering",
    "Microsoft requires you to access your emails via IMAP using OAuth 2.0 authentication. To do this, you need to register an app with Microsoft Entra ID, formerly known as Microsoft Azure Active Directory." : "Microsoft kräver att du använder OAuth 2.0-autentisering för att komma åt e-post via IMAP. Registrera därför en app i Microsoft Entra ID, tidigare Microsoft Azure Active Directory.",
    ...
    "Message View Mode" : "Visningsläge för meddelanden",
    "Show only the selected message" : "Visa endast det valda meddelandet",
    "Successfully set up anti spam email addresses" : "Antispamadresserna har konfigurerats",
    "Error saving anti spam email addresses" : "Det gick inte att spara antispamadresserna",
    "Successfully deleted anti spam reporting email" : "E-postadressen för skräppostrapportering har tagits bort",
    "Error deleting anti spam reporting email" : "Det gick inte att ta bort e-postadressen för skräppostrapportering",
    "Anti Spam" : "Antispam",
    "Add the email address of your anti spam report service here." : "Lägg till e-postadressen till tjänsten för skräppostrapportering här.",
    ...
    "\"Mark as Spam\" Email Address" : "E-postadress för ”Markera som skräppost”",
    "\"Mark Not Junk\" Email Address" : "E-postadress för ”Markera som inte skräppost”",
    "Reset" : "Återställ",
    "Google integration configured" : "Google-integrationen har konfigurerats",
    "Could not configure Google integration" : "Det gick inte att konfigurera Google-integrationen",
    "Google integration unlinked" : "Google-integrationen har kopplats från",
    "Could not unlink Google integration" : "Det gick inte att koppla från Google-integrationen",
    "Client ID" : "Klient-ID",
    "Client secret" : "Klienthemlighet",
    "Unlink" : "Koppla från",
    "Microsoft integration configured" : "Microsoft-integrationen har konfigurerats",
    "Could not configure Microsoft integration" : "Det gick inte att konfigurera Microsoft-integrationen",
    "Microsoft integration unlinked" : "Microsoft-integrationen har kopplats från",
    "Could not unlink Microsoft integration" : "Det gick inte att koppla från Microsoft-integrationen",
    "Tenant ID (optional)" : "Klientorganisations-ID (valfritt)",
    "Domain Match: {provisioningDomain}" : "Domänmatchning: {provisioningDomain}",
    ...
    "Sieve" : "Sieve",
    "Enable sieve integration" : "Aktivera Sieve-integrering",
    "LDAP aliases integration" : "LDAP-aliasintegrering",
    "Enable LDAP aliases integration" : "Aktivera LDAP-aliasintegrering",
    "The LDAP aliases integration reads an attribute from the configured LDAP directory to provision email aliases." : "LDAP-aliasintegreringen läser ett attribut från den konfigurerade LDAP-katalogen för att provisionera e-postalias.",
    ...
    "Failed to import the certificate. Please make sure that the private key matches the certificate and is not protected by a passphrase." : "Det gick inte att importera certifikatet. Kontrollera att den privata nyckeln matchar certifikatet och inte är skyddad av en lösenfras.",
    "Failed to import the certificate" : "Det gick inte att importera certifikatet",
    ...
    "The private key is only required if you intend to send signed and encrypted emails using this certificate." : "Den privata nyckeln krävs endast om du vill skicka signerade och krypterade e-postmeddelanden med certifikatet.",
    "Submit" : "Skicka",
    "No text blocks available" : "Det finns inga textblock",
    "Text block deleted" : "Textblocket har tagits bort",
    "Failed to delete text block" : "Det gick inte att ta bort textblocket",
    "Text block shared with {sharee}" : "Textblocket har delats med {sharee}",
    "Failed to share text block with {sharee}" : "Det gick inte att dela textblocket med {sharee}",
    "Share deleted for {name}" : "Delning borttagen för {name}",
    "Failed to delete share with {name}" : "Det gick inte att ta bort delning med {name}",
    "Guest" : "Gäst",
    "Group" : "Grupp",
    "Failed to save text block" : "Det gick inte att spara textblocket",
    "Shared" : "Delad",
    "Edit {title}" : "Uppdatera {title}",
    "Delete {title}" : "Ta bort {title}",
    "Edit text block" : "Redigera textblock",
    "Shares" : "Delningar",
    "Search for users or groups" : "Sök användare eller grupper",
    "Insert" : "Infoga",
    "Choose a text block to insert at the cursor" : "Välj ett textblock att infoga vid markören",
    ...
    "To add a mail account, please contact your administrator." : "Kontakta administratören för att lägga till ett e-postkonto.",
    "All" : "Alla",
    "Drafts" : "Utkast",
    ...
    "There is already a message in progress. All unsaved changes will be lost if you continue!" : "Ett meddelande redigeras redan. Alla osparade ändringar går förlorade om du fortsätter.",
    "Discard changes" : "Släng ändringar",
    "Discard unsaved changes" : "Kassera osparade ändringar",
    "Keep editing message" : "Fortsätt uppdatera meddelande",
    "(All or part of this reply was generated by AI)" : "(Hela eller delar av svaret genererades av AI)",
    "Attachments were not copied. Please add them manually." : "Bifogade filer kopierades inte, lägg till dem manuellt.",
    "Could not create snooze mailbox" : "Det gick inte att skapa mappen för uppskjutna meddelanden",
    "Sorry, the message could not be loaded. The draft may no longer exist. Please refresh the page and try again." : "Meddelandet kunde tyvärr inte läsas in. Utkastet kanske inte längre finns. Uppdatera sidan och försök igen.",
    "Sending message…" : "Skickar meddelandet …",
    "Message sent" : "Meddelande skickat",
    "Could not send message" : "Det gick inte att skicka meddelandet",
    "Message copied to \"Sent\" folder" : "Meddelandet kopierades till mappen ”Skickat”",
    "Could not copy message to \"Sent\" folder" : "Det gick inte att kopiera meddelandet till mappen ”Skickat”",
    "Could not load {tag}{name}{endtag}" : "Det gick inte att läsa in {tag}{name}{endtag}",
    "There was a problem loading {tag}{name}{endtag}" : "Ett problem uppstod när {tag}{name}{endtag} lästes in",
