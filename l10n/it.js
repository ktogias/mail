OC.L10N.register(
    ...
    "Mark messages as read" : "Segna tutti i messaggi come letti",
    ...
    "_After %n second_::_After %n seconds_" : ["Dopo %n secondo","Dopo %n secondi","Dopo %n secondi"],
    ...
    "Remove attachment {fileName}" : "Rimuovi allegato {fileName}",
    "Add as attachment" : "Aggiungi come allegato",
    "Add as share link" : "Aggiungi link condiviso",
    ...
    "Delegated access to {displayName}" : "Accesso delegato a {displayName}",
    "Could not delegate access" : "Non è stato possibile delegare l’accesso",
    "Revoked access for {displayName}" : "Accesso revocato a {displayName}",
    ...
    "Message could not be saved" : "Il messaggio non può essere salvato",
    "This summary was AI-generated" : "Questo riepilogo è stato generato dall’IA",
    "Encrypted message" : "Messaggio cifrato",
    "This message is unread" : "Questo messaggio è non letto",
    "Choose a folder to store the message in" : "Scegli una cartella in cui salvare il messaggio",
    ...
    "Save message to Files" : "Salva il messaggio in Files",
    ...
    "This description was generated by AI." : "Questa descrizione è stata generata dall'IA",
    ...
    "Could not generate direct link: Message ID is missing" : "Impossibile generare il link diretto: manca l’ID del messaggio.",
    "Direct link copied to clipboard" : "Collegamento diretto copiato negli appunti",
    "Copy direct link" : "Copia il link diretto",
    "Forward" : "Inoltra",
    ...
    "Restore composer" : "Ripristina compositore",
    "Maximize composer" : "Espandi finestra",
    "Minimize composer" : "Riduci finestra",
    "Close contact info" : "Chiudi le informazioni di contatto",
    ...
    "This signature is larger than 2 MB, usually because an image is embedded in it. It is added to every message you send and may slow down the editor." : "Questa firma supera i 2 MB, solitamente perché contiene un’immagine incorporata. Viene aggiunta a ogni messaggio inviato e potrebbe rallentare l’editor.",
    "This signature contains images. New messages will use rich text, even though your writing mode is set to plain text." : "Questa firma contiene immagini. I nuovi messaggi utilizzeranno il testo formattato, anche se la modalità di scrittura è impostata su testo semplice.",
    ...
    "This summary is AI-generated and may contain mistakes." : "Questo riepilogo è stato generato dall’IA e potrebbe contenere errori.",
    ...
    "Text blocks are reusable pieces of text that can be inserted in messages. Visit the Settings panel to create your own." : "I blocchi di testo sono porzioni di testo riutilizzabili che possono essere inserite nei messaggi. Vai al pannello Impostazioni per crearne di personalizzati.",
    ...
    "Insert image from Files" : "Inserisci una immagine da Files",
    "Choose an image" : "Scegli un'immagine",
    "Select an image" : "Seleziona un'immagine",
    "Insert {name}" : "Inserisci {name}",
    "The selected image is too large to embed" : "L’immagine selezionata è troppo grande per essere incorporata.",
    "Could not insert the selected image" : "Non è possibile inserire l'immagine selezionata",
    "All" : "Tutti",
    "Drafts" : "Bozze",
    ...
    "Date:" : "Data:",
    "Printing from the browser menu is not supported" : "La stampa dal menu del browser non è supportata",
    "To print this email, press {shortcut}, or use the \"Print message\" action in the message menu." : "Per stampare questa email, premi {shortcut}, oppure usa l’azione “Stampa messaggio” nel menu del messaggio.",
