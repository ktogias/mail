OC.L10N.register(
    ...
    "{account_email} has been delegated to you" : "{account_email} было делегировано вам",
    "{user} delegated {account} to you" : "{user} делегирован {account} вам",
    "{account_email} is no longer delegated to you" : "{account_email} вам больше не делегируется",
    "{user} revoked delegation for {account}" : "{user} отозвал делегирование для {account}",
    ...
    "Mail server marked this message as phishing attempt" : "Почтовый сервер пометил это сообщение как попытку фишинга",
    ...
    "Reply-To email: %1$s is different from sender email: %2$s" : "Reply-To email: %1$s отличается от отправителя email: %2$s",
    "Mail connection performance" : "Производительность почтового соединения",
    "Slow mail service detected (%1$s) an attempt to connect to several accounts took an average of %2$s seconds per account" : "Обнаружен медленный почтовый сервис (%1$s) попытка подключения к нескольким аккаунтам занимала в среднем %2$s секунды на аккаунт",
    "Slow mail service detected (%1$s) an attempt to perform a mail box list operation on several accounts took an average of %2$s seconds per account" : "Обнаружена медленная почтовая служба (%1$s) попытка выполнить операцию списка почтовых ящиков на нескольких учетных записях заняла в среднем %2$s секунд на один аккаунт",
    "Mail Transport configuration" : "Конфигурация почтового транспорта",
    ...
    "Mail account parameters, aliases and preferences" : "Параметры почтовой учетной записи, псевдонимы и настройки",
    ...
    "IMAP server denied authentication" : "Серверу IMAP отказано в проверке подлинности",
    "SMTP server denied authentication" : "SMTP-серверу отказано в проверке подлинности",
    "IMAP authentication error" : "Ошибка аутентификации по IMAP",
    "SMTP authentication error" : "Ошибка SMTP-аутентификации",
    ...
    "Password" : "Пароль",
    "Enable mark as important classification" : "Включить пометку как важную классификацию",
    "Manual" : "Вручную",
    ...
    "Google requires OAuth authentication. If your Nextcloud admin has not configured Google OAuth, you can use a Google App Password instead." : "Google требует аутентификацию OAuth. Если ваш администратор Nextcloud не настроил Google OAuth, вместо этого вы можете использовать пароль приложения Google.",
    "Microsoft requires OAuth authentication. Ask your Nextcloud admin to configure Microsoft OAuth in the admin settings." : "Microsoft требует аутентификации OAuth. Попросите администратора Nextcloud настроить Microsoft OAuth в настройках администратора.",
    ...
    "Classification settings" : "Параметры классификации",
    "Filters" : "Фильтры",
    "Quick actions" : "Быстрые действия",
    "Sieve script editor" : "Редактор Sieve",
    "Mail server" : "Почтовый сервер",
    "Sieve server" : "Сервер Sieve",
    "Folder search" : "Поиск по папкам",
    ...
    "Cancel" : "Отмена",
    "Search the body of messages in priority Inbox" : "Поиск по тексту сообщений в приоритетном почтовом ящике",
    "Activate" : "Активировать",
    "Make mails available to Context Chat" : "Сделайте почту доступной для контекстного чата",
    "Remind about messages that require a reply but received none" : "Напомнить о сообщениях, требующих ответа, но не полученных",
    "Highlight external addresses" : "Выделите внешние адреса",
    "Could not update preference" : "Не удалось обновить свойство",
    "Mail settings" : "Параметры эл. почты",
    "General" : "Основные",
    "Set as default mail app" : "Установлено в качестве почтового приложения по умолчанию",
    "{email} (delegated)" : "{email} (делегировано)",
    "Add mail account" : "Добавить учётную запись",
    "Appearance" : "Внешний вид",
    "Show all messages in thread" : "Показывать все сообщения в теме",
    "When off, only the selected message will be shown" : "Когда он выключен, будет отображаться только выбранное сообщение",
    "Sort favorites up" : "Сортировка избранного по категориям",
    "When on, favorite messages will be sorted to the top of folders" : "Когда этот параметр включен, избранные сообщения будут отсортированы по верхним папкам",
    "Layout" : "Расположение",
    "Vertical split" : "Вертикальное разделение",
    "Horizontal split" : "Горизонтальное разделение",
    "List" : "Список",
    "Use compact mode" : "Использовать компактный режим",
    "Sorting" : "Сортировка",
    ...
    "Ok" : "OK",
    "Avatars from Gravatar and favicons" : "Аватары из Gravatar и значки",
    "Manually" : "Вручную",
    "Reply position" : "Позиция для ответа",
    "Top" : "Верх",
    "Bottom" : "Низ",
    "Text blocks" : "Текстовые блоки",
    "Reusable pieces of text that can be inserted in messages" : "Многократно используемые фрагменты текста, которые можно вставлять в сообщения",
    "Shared with me" : "Поделились с вами",
    "Privacy" : "Конфиденциальность",
    "Data collection" : "Сбор данных",
    "Allow the app to collect and process data locally to adapt to your preferences" : "Разрешите приложению собирать и обрабатывать данные локально, чтобы адаптироваться к вашим предпочтениям",
    "Always show images from" : "Всегда показывать изображения с",
    "Security" : "Безопасность",
    "Manage your internal addresses and domains to ensure recognized contacts stay unmarked" : "Управляйте своими внутренними адресами и доменами, чтобы распознанные контакты оставались незамеченными",
    "S/MIME" : "S/MIME",
    ...
    "Step 1" : "Шаг 1",
    "Install the browser extension" : "Установите расширение для браузера",
    "Step 2" : "Шаг 2",
    "Enable for the current domain" : "Включить для текущего домена",
    ...
    "This application includes CKEditor, an open-source editor. Copyright © CKEditor contributors. Licensed under GPLv2." : "Это приложение включает в себя CKEditor, редактор с открытым исходным кодом. Авторские права © Авторы CKEditor. Лицензия GPLv2.",
    "Automatically create tentative appointments in calendar" : "Автоматическое создание предварительных встреч в календаре",
    ...
    "Contact or email address …" : "Контактное лицо или адрес электронной почты",
    "Cc" : "Коп",
    "Bcc" : "СкрКоп",
    "Subject" : "Тема",
    "Subject …" : "Тема",
    ...
    "Expand composer" : "Развернуть композер",
    "Close composer" : "Закрыть композер",
    "Confirm" : "Подтвердить",
    "Delegate access" : "Делегировать доступ",
    "Revoke" : "Отозвать",
    "{userId} will no longer be able to act on your behalf" : "{userId} больше не сможет действовать от вашего имени",
    "Could not fetch delegates" : "Не удалось получить делегатов",
    "Delegated access to {displayName}" : "Делегирован доступ к {displayName}",
    "Could not delegate access" : "Не удалось делегировать доступ",
    "Revoked access for {displayName}" : "Отменён доступ для {displayName}",
    "Could not revoke delegation" : "Не удалось отозвать делегирование",
    "Delegation" : " Делегирование",
    "Allow users to send, receive, and delete mail on your behalf" : "Разрешить пользователям отправлять, получать и удалять почту от вашего имени",
    "Revoke access" : "Отозвать доступ",
    "Add delegate" : "Добавить делегата",
    "Select a user" : "Выберите пользователя",
    "They will be able to send, receive, and delete mail on your behalf" : "Они смогут отправлять, получать и удалять почту от вашего имени",
    "Revoke access?" : "Отозвать доступ?",
    ...
    "No subject" : "Без темы",
    "{markup-start}Draft:{markup-end} {subject}" : "{markup-start} Черновик:{markup-end} {subject}",
    ...
    "Could not apply tag, configured tag not found" : "Не удалось применить тег, настроенный тег не найден",
    "Could not move thread, destination mailbox not found" : "Не удалось переместить тему, почтовый ящик назначения не найден",
    "Could not execute quick action" : "Не удалось выполнить быстрое действие",
    "Quick action executed" : "Быстрое действие выполнено",
    ...
    "Thread was snoozed" : "Тред был отложен",
    "Could not snooze thread" : "Не удалось отложить тред",
    "Thread was unsnoozed" : "Тред не был отложен",
    "Could not unsnooze thread" : "Не удалось отменить отмену треда",
    ...
    "Reply with meeting" : "Ответить при встрече",
    "Create task" : "Создать задачу",
    "Download message" : "Скачать письмо",
    "Delete thread" : "Удалить ветку",
    "Delete message" : "Удалить сообщение",
    "Back to all actions" : "Вернуться ко всем действиям",
    "Manage quick actions" : "Управление быстрыми действиями",
    ...
    "_Mark {number} as spam_::_Mark {number} as spam_" : ["Отметить {number} как спам","Отметить {number} как спам","Отметить {number} как спам","Отметить {number} как спам"],
    "_Mark {number} as not spam_::_Mark {number} as not spam_" : ["Отметить {number} как не спам","Отметить {number} как не спам","Отметить {number} как не спам","Отметить {number} как не спам"],
    "_Edit tags for {number}_::_Edit tags for {number}_" : ["Редактировать теги для {number}","Редактировать теги для {number}","Редактировать теги для {number}","Редактировать теги для {number}"],
    ...
    "This description was generated by AI." : "Это описание было создано AI.",
    ...
    "All day" : "Весь день",
    "Attendees" : "Участники",
    "You can only invite attendees if your account has an email address set" : "Вы можете приглашать участников только в том случае, если в вашем аккаунте указан адрес электронной почты",
    ...
    "This message has an attached invitation but the invitation dates are in the past" : "К этому сообщению прикреплено приглашение, но даты приглашения уже в прошлом",
    "This message has an attached invitation but the invitation does not contain a participant that matches any configured mail account address" : "К этому сообщению прикреплено приглашение, но оно не содержит участника, соответствующего любому настроенному адресу почтового аккаунта",
    ...
    "To archive a message please configure an archive folder in account settings" : "Чтобы заархивировать сообщение, настройте папку архива в настройках аккаунта",
    ...
    "Favorites" : "Избранные",
    "Favorites info" : "Информация об избранном",
    "Load more favorites" : "Загрузить больше избранных",
    "Follow up" : "Следовать за",
    "Follow up info" : "Последующая информация",
    "Load more follow ups" : "Загрузить больше отслеживаемых",
    "Important info" : "Важная информация",
    "Load more important messages" : "Загрузить больше важных сообщений",
    "Other" : "Прочие",
    "Load more other messages" : "Загрузить больше других сообщений",
    ...
    "Suggested replies are using AI" : "Предлагаемые ответы используют ИИ",
    ...
    "This account cannot connect" : "Этот аккаунт не может подключиться",
    "Connection failed. Please verify your information and try again" : "Соединение не удалось. Проверьте вашу информацию и повторите попытку",
    "Change password" : "Сменить пароль",
    "Used quota: {quota}% ({limit})" : "Использовано квоты: {quota}% ({limit})",
    "Used quota: {quota}%" : "Использовано квоты: {quota}%",
    "Unable to create mailbox. The name likely contains invalid characters. Please try another name." : "Невозможно создать почтовый ящик. Вероятно, имя содержит недопустимые символы. Попробуйте другое имя.",
    ...
    "Delegate account" : "Делегировать аккаунт",
    ...
    "Please wait 10 minutes before repairing again" : "Пожалуйста, подождите 10 минут перед повторным восстановлением",
    ...
    "Outbox" : "Исходящие",
    "Translate this message to {language}" : "Перевести это сообщение на {language}",
    ...
    "attachment" : "вложение",
    "attached" : "прикрепить",
    "No \"sent\" folder configured. Please pick one in the account settings." : "Папка «Отправленные» не настроена. Пожалуйста, выберите одну в настройках аккаунта.",
    ...
    "Your message has no subject. Do you want to send it anyway?" : "У вашего сообщения нет темы. Вы все равно хотите его отправить?",
    ...
    "Welcome to {productName} Mail" : "Добро пожаловать в {productName} почту",
    "Start writing a message by clicking below or select an existing message to display its contents" : "Начните писать сообщение, нажав кнопку ниже, или выберите существующее сообщение, чтобы отобразить его содержимое",
    ...
    "Copy to \"Sent\" Folder" : "Скопировать в папку «Отправленные»",
    "Copy to Sent Folder" : "Скопировать в папку Отправленные",
    ...
    "Select CC recipients" : "Выбрать получателей CC",
    "Select BCC recipients" : "Выбрать получателей BCC",
    "Tags" : "Метки",
    ...
    "To me" : "Мне",
    "Enable mail body search" : "Включить поиск по телу письма",
    "Sieve is a powerful language for writing filters for your mailbox. You can manage the sieve scripts in Mail if your email service supports it. Sieve is also required to use Autoresponder and Filters." : "Sieve — мощный язык для написания фильтров для вашего почтового ящика. Вы можете управлять сценариями фильтрации в Mail, если ваша служба электронной почты поддерживает это. Sieve также необходим для использования автоответчика и фильтров.",
    ...
    "Saving new tag name …" : "Сохранение нового имени тега …",
    ...
    "Newest message" : "Самое свежее сообщение",
    ...
    "This translation is generated using AI and may contain inaccuracies" : "Этот перевод создан с использованием ИИ и может содержать неточности",
    ...
    "Train" : "Поезд",
    "Mark message as" : "Отметить сообщение как",
    ...
    "Hang tight while the filters load" : "Держитесь крепче, пока загружаются фильтры",
    "Filter is active" : "Фильтр активен",
    "Filter is not active" : "Фильтр не активен",
    "If all the conditions are met, the actions will be performed" : "Если все условия соблюдены, действия будут выполнены",
    "If any of the conditions are met, the actions will be performed" : "При выполнении любого из условий действия будут выполнены",
    "Help" : "Справка",
    "contains" : "содержит",
    "A substring match. The field matches if the provided value is contained within it. For example, \"report\" would match \"port\"." : "Совпадение подстроки. Поле соответствует, если в нем содержится указанное значение. Например, \"report\" будет соответствовать \"port\".",
    "matches" : "соответствует",
    "A pattern match using wildcards. The \"*\" symbol represents any number of characters (including none), while \"?\" represents exactly one character. For example, \"*report*\" would match \"Business report 2024\"." : "Соответствие шаблону с использованием подстановочных знаков. Символ \"*\" представляет любое количество символов (в том числе ни одного), а символ \"?\" представляет ровно один символ. Например, \"*report*\" будет соответствовать \"Business report 2024\".",
    "Enter subject" : "Введите тему",
    "Enter sender" : "Введите отправителя",
    "Enter recipient" : "Введите получателя",
    "is exactly" : "это точно",
    "Conditions" : "Условие",
    ...
    "Tag" : "Метка",
    "delete" : "удалить",
    "Edit quick action" : "Изменить быстрое действие",
    "Add quick action" : "Добавить быстрое действие",
    "Quick action deleted" : "Быстрое действие удалено",
    "Failed to delete quick action" : "Не удалось удалить быстрое действие",
    "Failed to update quick action" : "Не удалось обновить быстрое действие",
    "Failed to update step in quick action" : "Не удалось обновить шаг в быстром действии",
    "Quick action updated" : "Быстрое действие обновлено",
    "Failed to create quick action" : "Не удалось создать быстрое действие",
    "Failed to add steps to quick action" : "Не удалось добавить шаги к быстрому действию",
    "Quick action created" : "Быстрое действие создано",
    "Failed to delete action step" : "Не удалось удалить шаг действия",
    "No quick actions yet." : "Быстрых действий пока нет.",
    "Edit" : "Редактирование",
    "Quick action name" : "Название быстрого действия",
    "Do the following actions" : "Выполнить следующие действия",
    "Add another action" : "Добавить ещё одно действие",
    ...
    "Microsoft requires you to access your emails via IMAP using OAuth 2.0 authentication. To do this, you need to register an app with Microsoft Entra ID, formerly known as Microsoft Azure Active Directory." : "Microsoft требует, чтобы вы получали доступ к своей электронной почте через IMAP с использованием аутентификации OAuth 2.0. Для этого вам необходимо зарегистрировать приложение с помощью Microsoft Entra ID, ранее известного как Microsoft Azure Active Directory.",
    "Redirect URI" : "Адрес перенаправления",
    "For more details, please click here to open our documentation." : "Для получения более подробной информации нажмите здесь, чтобы открыть нашу документацию.",
    "User Interface Preference Defaults" : "Настройки пользовательского интерфейса по умолчанию",
    "These settings are used to pre-configure the user interface preferences they can be overridden by the user in the mail settings" : "Эти настройки используются для предварительной настройки предпочтений пользовательского интерфейса. Пользователь может их переопределить в настройках почты",
    "Message View Mode" : "Режим отображения сообщения",
    "Show only the selected message" : "Показать только выбранное сообщение",
    ...
    "Insert" : "Вставить",
    "Choose a text block to insert at the cursor" : "Выберите текстовый блок для вставки под курсором",
    ...
    "(All or part of this reply was generated by AI)" : "(Весь или часть этого ответа была создана ИИ)",
    ...
    "Sorry, the message could not be loaded. The draft may no longer exist. Please refresh the page and try again." : "Извините, сообщение не удалось загрузить. Возможно, черновик больше не существует. Пожалуйста, обновите страницу и повторите попытку.",
    "Sending message…" : "Отправка сообщения…",
    "Message sent" : "Сообщение отправлено",
    "Could not send message" : "Не удалось отправить сообщение",
    "Message copied to \"Sent\" folder" : "Сообщение скопировано в папку \"Отправленные\"",
    "Could not copy message to \"Sent\" folder" : "Не удалось скопировать сообщение в папку \"Отправленные\"",
