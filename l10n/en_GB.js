OC.L10N.register(
    ...
    "{account_email} has been delegated to you" : "{account_email} has been delegated to you",
    "{user} delegated {account} to you" : "{user} delegated {account} to you",
    "{account_email} is no longer delegated to you" : "{account_email} is no longer delegated to you",
    "{user} revoked delegation for {account}" : "{user} revoked delegation for {account}",
    ...
    "Google requires OAuth authentication. If your Nextcloud admin has not configured Google OAuth, you can use a Google App Password instead." : "Google requires OAuth authentication. If your Nextcloud admin has not configured Google OAuth, you can use a Google App Password instead.",
    "Microsoft requires OAuth authentication. Ask your Nextcloud admin to configure Microsoft OAuth in the admin settings." : "Microsoft requires OAuth authentication. Ask your Nextcloud admin to configure Microsoft OAuth in the admin settings.",
    ...
    "{email} (delegated)" : "{email} (delegated)",
    ...
    "Messages with no 'To' recipients may be rejected by some mail providers." : "Messages with no 'To' recipients may be rejected by some mail providers.",
    "Cc" : "Cc",
    "Bcc" : "Bcc",
    "Subject" : "Subject",
    "Subject …" : "Subject …",
    ...
    "Add as attachment" : "Add as attachment",
    "Add as share link" : "Add as share link",
    ...
    "Revoke" : "Revoke",
    "{userId} will no longer be able to act on your behalf" : "{userId} will no longer be able to act on your behalf",
    "Could not fetch delegates" : "Could not fetch delegates",
    "Delegated access to {displayName}" : "Delegated access to {displayName}",
    "Could not delegate access" : "Could not delegate access",
    "Revoked access for {displayName}" : "Revoked access for {displayName}",
    "Could not revoke delegation" : "Could not revoke delegation",
    "Delegation" : "Delegation",
    "Allow users to send, receive, and delete mail on your behalf" : "Allow users to send, receive, and delete mail on your behalf",
    "Revoke access" : "Revoke access",
    "Add delegate" : "Add delegate",
    "Select a user" : "Select a user",
    "They will be able to send, receive, and delete mail on your behalf" : "They will be able to send, receive, and delete mail on your behalf",
    "Revoke access?" : "Revoke access?",
    ...
    "Message saved to Files" : "Message saved to Files",
    "Message could not be saved" : "Message could not be saved",
    "This summary was AI-generated" : "This summary was AI-generated",
    "Encrypted message" : "Encrypted message",
    "This message is unread" : "This message is unread",
    "Choose a folder to store the message in" : "Choose a folder to store the message in",
    ...
    "Save message to Files" : "Save message to Files",
    ...
    "This description was generated by AI." : "This description was generated by AI.",
    ...
    "Could not generate direct link: Message ID is missing" : "Could not generate direct link: Message ID is missing",
    ...
    "Suggested replies are using AI" : "Suggested replies are using AI",
    ...
    "Restore composer" : "Restore composer",
    "Maximize composer" : "Maximize composer",
    "Minimize composer" : "Minimize composer",
    "Close contact info" : "Close contact info",
    ...
    "Signature …" : "Signature …",
    "This signature is larger than 2 MB, usually because an image is embedded in it. It is added to every message you send and may slow down the editor." : "This signature is larger than 2 MB, usually because an image is embedded in it. It is added to every message you send and may slow down the editor.",
    "This signature contains images. New messages will use rich text, even though your writing mode is set to plain text." : "This signature contains images. New messages will use rich text, even though your writing mode is set to plain text.",
    ...
    "Text blocks are reusable pieces of text that can be inserted in messages. Visit the Settings panel to create your own." : "Text blocks are reusable pieces of text that can be inserted in messages. Visit the Settings panel to create your own.",
    ...
    "Insert image from Files" : "Insert image from Files",
    "Choose an image" : "Choose an image",
    "Select an image" : "Select an image",
    "Insert {name}" : "Insert {name}",
    "The selected image is too large to embed" : "The selected image is too large to embed",
    "Could not insert the selected image" : "Could not insert the selected image",
    "All" : "All",
    "Drafts" : "Drafts",
    ...
    "(All or part of this reply was generated by AI)" : "(All or part of this reply was generated by AI)",
    ...
    "Date:" : "Date:",
    "Printing from the browser menu is not supported" : "Printing from the browser menu is not supported",
    "To print this email, press {shortcut}, or use the \"Print message\" action in the message menu." : "To print this email, press {shortcut}, or use the \"Print message\" action in the message menu.",
    ...
    "The mail server is temporarily busy. Please try again." : "The mail server is temporarily busy. Please try again.",
