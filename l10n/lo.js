OC.L10N.register(
    ...
    "Load more" : "Load more",
    "_Mark {number} read_::_Mark {number} read_" : ["Mark {number} read"],
    "_Mark {number} unread_::_Mark {number} unread_" : ["Mark {number} unread"],
    "_Mark {number} as important_::_Mark {number} as important_" : ["Mark {number} as important"],
    "_Mark {number} as unimportant_::_Mark {number} as unimportant_" : ["Mark {number} as unimportant"],
    "_Unfavorite {number}_::_Unfavorite {number}_" : ["Unfavorite {number}"],
    "_Favorite {number}_::_Favorite {number}_" : ["Favorite {number}"],
    "_Unselect {number}_::_Unselect {number}_" : ["Unselect {number}"],
    "_Mark {number} as spam_::_Mark {number} as spam_" : ["Mark {number} as spam"],
    "_Mark {number} as not spam_::_Mark {number} as not spam_" : ["Mark {number} as not spam"],
    "_Edit tags for {number}_::_Edit tags for {number}_" : ["Edit tags for {number}"],
    "_Move {number} thread_::_Move {number} threads_" : ["Move {number} threads"],
    "_Forward {number} as attachment_::_Forward {number} as attachment_" : ["Forward {number} as attachment"],
    ...
    "_View {count} more attachment_::_View {count} more attachments_" : ["View {count} more attachments"],
    ...
    "_{total} message_::_{total} messages_" : ["{total} messages"],
    "_{unread} unread of {total}_::_{unread} unread of {total}_" : ["{unread} unread of {total}"],
    "Loading …" : "Loading …",
    ...
    "_Successfully provisioned {count} account._::_Successfully provisioned {count} accounts._" : ["Successfully provisioned {count} accounts."],
