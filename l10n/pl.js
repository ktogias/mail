OC.L10N.register(
    ...
    "Mail server marked this message as phishing attempt" : "Serwer pocztowy oznaczył tę wiadomość jako próbę phishingu",
    ...
    "Reply-To email: %1$s is different from sender email: %2$s" : "Adres e-mail Reply-To: %1$s różni się od adresu nadawcy: %2$s",
    ...
    "IMAP server denied authentication" : "Serwer IMAP odmówił uwierzytelnienia",
    "SMTP server denied authentication" : "Serwer SMTP odmówił uwierzytelnienia",
    "IMAP authentication error" : "Błąd uwierzytelniania IMAP",
    "SMTP authentication error" : "Błąd uwierzytelniania SMTP",
    ...
    "Password" : "Hasło",
    "Enable mark as important classification" : "Włącz klasyfikację oznaczania jako ważne",
    "Manual" : "Ręcznie",
    ...
    "Classification settings" : "Ustawienia klasyfikacji",
    "Filters" : "Filtry",
    ...
    "Cancel" : "Anuluj",
    "Search the body of messages in priority Inbox" : "Przeszukuj treść wiadomości w skrzynce priorytetowej",
    "Activate" : "Aktywuj",
    "Make mails available to Context Chat" : "Udostępnij wiadomości e-mail w kontekście czatu",
    ...
    "Highlight external addresses" : "Wyróżniaj adresy zewnętrzne",
    ...
    "When off, only the selected message will be shown" : "Gdy wyłączone, wyświetlana będzie tylko wybrana wiadomość",
    "Sort favorites up" : "Sortuj ulubione na górze",
    "When on, favorite messages will be sorted to the top of folders" : "Gdy włączone, ulubione wiadomości będą sortowane na górze folderów",
    "Layout" : "Wygląd",
    "Vertical split" : "Podział pionowy",
    "Horizontal split" : "Pionowo",
    "List" : "Lista",
    "Use compact mode" : "Użyj trybu kompaktowego",
    "Sorting" : "Sortuj",
    ...
    "Ok" : "OK",
    "Avatars from Gravatar and favicons" : "Awatary z Gravatar i favicon",
    "Manually" : "Ręcznie",
    "Reply position" : "Pozycja odpowiedzi",
    "Top" : "Góra",
    "Bottom" : "Dół",
    "Text blocks" : "Bloki tekstowe",
    "Reusable pieces of text that can be inserted in messages" : "Fragmenty tekstu wielokrotnego użytku , które można wstawiać do wiadomości",
    "Shared with me" : "Udostępnione dla mnie",
    "Privacy" : "Prywatność",
    "Data collection" : "Zbieranie danych",
    "Allow the app to collect and process data locally to adapt to your preferences" : "Zezwól aplikacji na lokalne zbieranie i przetwarzanie danych w celu dostosowania do Twoich preferencji",
    "Always show images from" : "Zawsze pokazuj obrazy od",
    "Security" : "Bezpieczeństwo",
    "Manage your internal addresses and domains to ensure recognized contacts stay unmarked" : "Zarządzaj wewnętrznymi adresami i domenami, aby rozpoznane kontakty pozostawały nieoznaczone",
    "S/MIME" : "S/MIME",
    ...
    "Step 2" : "Krok 2",
    "Enable for the current domain" : "Włącz dla bieżącej domeny",
    ...
    "Automatically create tentative appointments in calendar" : "Automatycznie twórz wstępne wydarzenia w kalendarzu",
    ...
    "This account cannot connect" : "To konto nie może się połączyć",
    "Connection failed. Please verify your information and try again" : "Połączenie nie powiodło się. Sprawdź swoje dane i spróbuj ponownie",
    ...
    "attached" : "załączono",
    "No \"sent\" folder configured. Please pick one in the account settings." : "Nie skonfigurowano folderu „wysłane”. Wybierz go w ustawieniach konta.",
    ...
    "Saving new tag name …" : "Zapisywanie nowej nazwy tagu ...",
    ...
    "Train" : "Pociąg",
    "Mark message as" : "Oznacz wiadomość jako",
