OC.L10N.register(
    ...
    "Mail Application" : "Застосунок Пошта",
    "Mails" : "Пошта",
    ...
    "Classification settings" : "Налаштування класифікації",
    "Filters" : "Фільтри",
    ...
    "Folder search" : "Пошук у каталогах",
    ...
    "Could not apply tag, configured tag not found" : "Не вдалося застосувати мітку, мітку не знайдено",
    ...
    "No trash folder configured" : "Не налаштовано каталог для кошика",
    ...
    "To archive a message please configure an archive folder in account settings" : "Щоб заархівувати повідомлення, будь ласка, налаштуйте каталог для архіву в налаштуваннях обліковогоо запису",
    ...
    "Could not open folder" : "Не вдалося відкрити каталог",
    ...
    "Repair folder" : "Відновити каталог",
    ...
    "Could not copy to \"Sent\" folder" : "Не вдалося скопіювати до каталогу \"Надіслані\"",
    ...
    "Copy to \"Sent\" Folder" : "Копіювати до каталогу \"Надіслані\"",
    "Copy to Sent Folder" : "Копіювати до каталогу Надіслані",
    ...
    "Copy translated text" : "Копіювати перекладений текст",
    ...
    "Move into folder" : "Перемістити до каталогу",
    "Stop" : "Стоп",
    ...
    "You have to register a new Client ID for a \"Web application\" in the Google Cloud console. Add the URL {url} as authorized redirect URI." : "Вам потрібно зареєструвати новий ідентифікатор клієнта для вебзастосунку в консолі Google Cloud. Додайте URL-адресу {url} як авторизований URI перенаправлення.",
    ...
    "With the settings above, the app will create account settings in the following way:" : "Із наведеними вище налаштуваннями застосунок створить налаштування облікового запису таким чином:",
    ...
    "Message copied to \"Sent\" folder" : "Повідомлення скопійовано до каталогу \"Надіслані\"",
    "Could not copy message to \"Sent\" folder" : "Не вдалося скопіювати повідомлення до каталогу \"Надіслані\"",
