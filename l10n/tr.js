OC.L10N.register(
    ...
    "IMAP server denied authentication" : "IMAP sunucusunda kimlik doğrulanamadı",
    "SMTP server denied authentication" : "SMTP sunucusunda kimlik doğrulanamadı",
    "IMAP authentication error" : "IMAP kimlik doğrulama sorunu",
    "SMTP authentication error" : "SMTP kimlik doğrulama sorunu",
    ...
    "Password" : "Parola",
    "Enable mark as important classification" : "Önemli olarak işaretle sınıflaması kullanılsın",
    "Manual" : "El ile",
    ...
    "Make mails available to Context Chat" : "E-postalar ContextChat ile kullanılabilsin",
    ...
    "Sort favorites up" : "Sık kullanılanlar üstte sıralansın",
    "When on, favorite messages will be sorted to the top of folders" : "Açıldığında, sıralamada sık kullanılan iletiler klasörlerin üstünde yer alır ",
    "Layout" : "Yerleşim",
    ...
    "Mark messages as read" : "İletileri okunmuş olarak işaretle",
    "Immediately" : "Hemen",
    "Manually" : "El ile",
    ...
    "Security" : "Güvenlik",
    "Manage your internal addresses and domains to ensure recognized contacts stay unmarked" : "Bilinen kişilerin işaretlenmeden kalmasını sağlamak için iç adreslerinizi ve etki alanlarını yönetin",
    "S/MIME" : "S/MIME",
    ...
    "Heading3" : "3. başlık",
    "About" : "Hakkında",
    "Acknowledgements" : "Telif hakları",
    ...
    "_After %n second_::_After %n seconds_" : ["%n saniye sonra","%n saniye sonra"],
    "Automatically create tentative appointments in calendar" : "Takvimde otomatik olarak belirsiz randevular oluşturulsun",
    ...
    "Mark as AI generated" : "YZ ile oluşturulmuş olarak işaretle",
    ...
    "Remove attachment {fileName}" : "{fileName} ek dosyasını kaldır",
    "Add as attachment" : "Dosya olarak ekle",
    "Add as share link" : "Paylaşım bağlantısı olarak ekle",
    ...
    "Delegated access to {displayName}" : "Yetki {displayName} kullanıcısına devredildi",
    "Could not delegate access" : "Yetki devredilemedi",
    "Revoked access for {displayName}" : "Yetki devri {displayName} kullanıcısından geri alındı",
    ...
    "Message saved to Files" : "İleti Dosyalar içine kaydedildi",
    "Message could not be saved" : "İleti kaydedilemedi",
    ...
    "Choose a folder to store the message in" : "İletinin depolanacağı bir klasör seçin",
    ...
    "Save message to Files" : "İletileri Dosyalar içine kaydet",
    ...
    "Messages will automatically be marked as important using AI. The system learns from which messages you interact with or mark as important. In the beginning you might have to manually change the importance to teach it, but it will improve over time" : "İletiler yapay zeka ile otomatik olarak önemli olarak işaretlenecektir. Sistem, hangi iletilerle etkileşimde bulunduğunuzu veya önemli olarak işaretlediğinizi öğrenir. Başlangıçta öğretmek için önem derecesini el ile değiştirmeniz gerekebilir. Ancak işaretleme zamanla iyileşir.",
    ...
    "AI identifies messages sent by you that likely require a reply but did not receive one after a couple of days and shows them here" : "Yapay zeka, sizin tarafınızdan gönderilen ve bir yanıt verilmesi gereken ancak birkaç gün sonra bir yanıt verilmeyen iletileri belirler ve bunları burada görüntüler",
    ...
    "Could not generate direct link: Message ID is missing" : "Doğrudan bağlantı oluşturulamadı. İleti kimliği eksik",
    "Direct link copied to clipboard" : "Doğrudan bağlantı panoya kopyalandı",
    "Copy direct link" : "Doğrudan bağlantıyı kopyala",
    "Forward" : "İlet",
    ...
    "Delete all messages" : "Tüm iletileri sil",
    "Outbox" : "Giden kutusu",
    ...
    "attachment" : "ek dosya",
    "attached" : "ekte",
    "No \"sent\" folder configured. Please pick one in the account settings." : "\"Gönderilmiş\" klasörü yapılandırılmamış. Lütfen hesap ayarlarından bir klasör seçin.",
    ...
    "Restore composer" : "Oluşturucuyu geri yükle",
    "Maximize composer" : "Oluşturucuyu büyüt",
    "Minimize composer" : "Oluşturucuyu küçült",
    "Close contact info" : "Kişi bilgilerini kapat",
    ...
    "Signature …" : "İmza…",
    "This signature is larger than 2 MB, usually because an image is embedded in it. It is added to every message you send and may slow down the editor." : "Bu imza, büyük olasılıkla içinde gömülü bir görsel olduğundan 2 MB boyutundan büyük. Gönderdiğiniz her iletiye eklenir ve düzenleyiciyi yavaşlatabilir.",
    "This signature contains images. New messages will use rich text, even though your writing mode is set to plain text." : "Bu imzada görseller var. Yazma kipiniz düz yazı olarak ayarlanmış olsa bile, yeni iletilerde zengin yazı biçimi kullanılacak.",
    ...
    "Contains AI content" : "YZ ile oluşturulmuş içerik ",
    ...
    "Train" : "Tren",
    "Mark message as" : "İletiyi şöyle işaretle",
    ...
    "Could not save default classification setting" : "Varsayılan sınıflama ayarı kaydedilemedi",
    ...
    "Text blocks are reusable pieces of text that can be inserted in messages. Visit the Settings panel to create your own." : "Yazı blokları, iletilere eklenebilen yeniden kullanılabilir yazı parçalarıdır. Kendi yazı bloğunuzu oluşturmak için Ayarlar panosuna gidin.",
    ...
    "Insert image from Files" : "Dosyalar uygulamasından görsel ekle",
    "Choose an image" : "Bir görsel seçin",
    "Select an image" : "Bir görsel seçin",
    "Insert {name}" : "{name} görselini ekle",
    "The selected image is too large to embed" : "Seçilmiş görsel eklenmek için çok büyük",
    "Could not insert the selected image" : "Seçilmiş görsel eklenemedi",
    "All" : "Tümü",
    "Drafts" : "Taslaklar",
    ...
    "Date:" : "Tarih:",
    "Printing from the browser menu is not supported" : "Tarayıcı menüsünden yazdırma desteklenmiyor",
    "To print this email, press {shortcut}, or use the \"Print message\" action in the message menu." : "Bu e-postayı yazdırmak için {shortcut} üzerine ya da ileti menüsündeki \"İletiyi yazdır\" üzerine basın.",
