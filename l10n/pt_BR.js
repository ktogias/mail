OC.L10N.register(
    ...
    "Checking mail host connectivity" : "Verificando a conectividade do hospedeiro de e-mail",
    ...
    "Mark messages as read" : "Marcar mensagens como lidas",
    ...
    "_After %n second_::_After %n seconds_" : ["Após %n segundo","Após %n de segundos","Após %n segundos"],
    ...
    "Messages with no 'To' recipients may be rejected by some mail providers." : "Mensagens sem destinatários no campo ‘Para’ podem ser rejeitadas por alguns provedores de e-mail.",
    "Cc" : "Cc",
    "Bcc" : "Cco",
    "Subject" : "Assunto",
    "Subject …" : "Assunto …",
    ...
    "Mark as AI generated" : "Marcar como gerado por IA",
    ...
    "Add as attachment" : "Adicionar como anexo",
    "Add as share link" : "Adicionar como link de compartilhamento",
    ...
    "Message saved to Files" : "Mensagem salva em Arquivos",
    "Message could not be saved" : "Não foi possível salvar a mensagem",
    ...
    "Choose a folder to store the message in" : "Escolha uma pasta para salvar a mensagem",
    ...
    "Save message to Files" : "Salvar mensagem em Arquivos",
    ...
    "Restore composer" : "Restaurar compositor",
    "Maximize composer" : "Maximizar compositor",
    "Minimize composer" : "Minimizar compositor",
    "Close contact info" : "Fechar as informações de contato",
    ...
    "Sieve host" : "Hospedeiro do Sieve",
    ...
    "Signature …" : "Assinatura …",
    "This signature is larger than 2 MB, usually because an image is embedded in it. It is added to every message you send and may slow down the editor." : "Essa assinatura tem mais de 2 MB, geralmente porque contém uma imagem incorporada. Ela é adicionada a todas as mensagens que você envia e pode tornar o editor mais lento.",
    "This signature contains images. New messages will use rich text, even though your writing mode is set to plain text." : "Essa assinatura contém imagens. As novas mensagens serão enviadas em texto formatado, mesmo que seu modo de redação esteja configurado para texto simples.",
    ...
    "Contains AI content" : "Contém conteúdo gerado por IA",
    ...
    "Text blocks are reusable pieces of text that can be inserted in messages. Visit the Settings panel to create your own." : "Os blocos de texto são trechos reutilizáveis que podem ser inseridos nas mensagens. Acesse o painel de Configurações para criar os seus próprios.",
