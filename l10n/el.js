OC.L10N.register(
    ...
    "Later" : "Αργότερα",
    "Mail" : "Αλληλογραφία",
    "You are reaching your mailbox quota limit for {account_email}" : "Φτάνετε το όριο χώρου του γραμματοκιβωτίου σας για {account_email}",
    ...
    "{account_email} has been delegated to you" : "Το {account_email} σάς έχει εκχωρηθεί",
    "{user} delegated {account} to you" : "Ο/Η {user} σάς εκχώρησε το {account}",
    "{account_email} is no longer delegated to you" : "Το {account_email} δεν είναι πλέον εκχωρημένο σε εσάς",
    "{user} revoked delegation for {account}" : "Ο/Η {user} ανάκλησε την εκχώρηση για το {account}",
    ...
    "Mail server marked this message as phishing attempt" : "Ο διακομιστής αλληλογραφίας σήμανε αυτό το μήνυμα ως προσπάθεια phishing",
    ...
    "Reply-To email: %1$s is different from sender email: %2$s" : "Email απάντησης: %1$s είναι διαφορετικό από το email αποστολέα: %2$s",
    ...
    "Mail account parameters, aliases and preferences" : "Παράμετροι, ψευδώνυμα και προτιμήσεις λογαριασμού αλληλογραφίας",
    ...
    "IMAP server denied authentication" : "Ο διακομιστής IMAP απέρριψε την πιστοποίηση",
    "SMTP server denied authentication" : "Ο διακομιστής SMTP απέρριψε την πιστοποίηση",
    "IMAP authentication error" : "Σφάλμα πιστοποίησης IMAP",
    "SMTP authentication error" : "Σφάλμα πιστοποίησης SMTP",
    ...
    "Enable mark as important classification" : "Ενεργοποίηση ταξινόμησης σήμανσης ως σημαντικού",
    "Manual" : "Χειροκίνητα",
    ...
    "Google requires OAuth authentication. If your Nextcloud admin has not configured Google OAuth, you can use a Google App Password instead." : "Η Google απαιτεί πιστοποίηση OAuth. Εάν ο διαχειριστής του Nextcloud δεν έχει διαμορφώσει το Google OAuth, μπορείτε να χρησιμοποιήσετε έναν Κωδικό πρόσβασης εφαρμογής Google.",
    "Microsoft requires OAuth authentication. Ask your Nextcloud admin to configure Microsoft OAuth in the admin settings." : "Η Microsoft απαιτεί πιστοποίηση OAuth. Ζητήστε από τον διαχειριστή του Nextcloud να διαμορφώσει το Microsoft OAuth στις ρυθμίσεις διαχειριστή.",
    ...
    "Classification settings" : "Ρυθμίσεις ταξινόμησης",
    "Filters" : "Φίλτρα",
    ...
    "Cancel" : "Ακύρωση",
    "Search the body of messages in priority Inbox" : "Αναζήτηση στο σώμα των μηνυμάτων στα Εισερχόμενα προτεραιότητας",
    "Activate" : "Ενεργοποίηση",
    "Make mails available to Context Chat" : "Διάθεση αλληλογραφίας στο Context Chat",
    ...
    "Highlight external addresses" : "Επισήμανση εξωτερικών διευθύνσεων",
    "Could not update preference" : "Δεν ήταν δυνατή η ενημέρωση της προτίμησης",
    "Mail settings" : "Ρυθμίσεις αλληλογραφίας",
    "General" : "Γενικά",
    "Set as default mail app" : "Ορισμός ως προεπιλεγμένη εφαρμογή αλληλογραφίας",
    "{email} (delegated)" : "{email} (εκχωρημένο)",
    "Add mail account" : "Προσθήκη λογαριασμού αλληλογραφίας",
    "Appearance" : "Εμφάνιση",
    "Show all messages in thread" : "Εμφάνιση όλων των μηνυμάτων στη συζήτηση",
    "When off, only the selected message will be shown" : "Όταν είναι απενεργοποιημένο, θα εμφανίζεται μόνο το επιλεγμένο μήνυμα",
    "Sort favorites up" : "Ταξινόμηση αγαπημένων προς τα πάνω",
    "When on, favorite messages will be sorted to the top of folders" : "Όταν είναι ενεργοποιημένο, τα αγαπημένα μηνύματα θα ταξινομούνται στην κορυφή των φακέλων",
    "Layout" : "Διάταξη",
    "Vertical split" : "Κάθετη διαίρεση",
    "Horizontal split" : "Οριζόντια διαίρεση",
    "List" : "Λίστα",
    "Use compact mode" : "Χρήση συμπαγούς λειτουργίας",
    "Sorting" : "Ταξινόμηση",
    ...
    "Ok" : "ΟΚ",
    "Avatars from Gravatar and favicons" : "Αβατάρ από το Gravatar και favicons",
    "Manually" : "Χειροκίνητα",
    "Reply position" : "Θέση απάντησης",
    "Top" : "Πάνω",
    "Bottom" : "Κάτω",
    "Text blocks" : "Μπλοκ κειμένου",
    "Reusable pieces of text that can be inserted in messages" : "Επαναχρησιμοποιήσιμα τμήματα κειμένου που μπορούν να εισαχθούν σε μηνύματα",
    "Shared with me" : "Κοινόχρηστα μαζί μου",
    "Privacy" : "Ιδιωτικότητα",
    "Data collection" : "Συλλογή δεδομένων",
    "Allow the app to collect and process data locally to adapt to your preferences" : "Να επιτρέπεται στην εφαρμογή η τοπική συλλογή και επεξεργασία δεδομένων για προσαρμογή στις προτιμήσεις σας",
    "Always show images from" : "Πάντα εμφανίζεται εικόνες από",
    "Security" : "Ασφάλεια",
    "Manage your internal addresses and domains to ensure recognized contacts stay unmarked" : "Διαχειριστείτε τις εσωτερικές διευθύνσεις και τους τομείς σας για να διασφαλίσετε ότι οι αναγνωρισμένες επαφές παραμένουν χωρίς σήμανση",
    "S/MIME" : "S/MIME",
    ...
    "Step 1" : "Βήμα 1",
    "Install the browser extension" : "Εγκατάσταση της επέκτασης περιηγητή",
    "Step 2" : "Βήμα 2",
    "Enable for the current domain" : "Ενεργοποίηση για τον τρέχοντα τομέα",
    ...
    "Heading2" : "Επικεφαλίδα2",
    "Heading3" : "Επικεφαλίδα3",
    "About" : "Σχετικά με",
    ...
    "Automatically create tentative appointments in calendar" : "Αυτόματη δημιουργία δοκιμαστικών ραντεβού στο ημερολόγιο",
    ...
    "Remove attachment {fileName}" : "Αφαίρεση συνημμένου {fileName}",
    "Add as attachment" : "Προσθήκη ως συνημμένο",
    "Add as share link" : "Προσθήκη ως σύνδεσμος κοινής χρήσης",
    ...
    "Confirm" : "Επιβεβαίωση",
    "Delegate access" : "Εκχώρηση πρόσβασης",
    "Revoke" : "Ανάκληση",
    "{userId} will no longer be able to act on your behalf" : "Ο/Η {userId} δεν θα μπορεί πλέον να ενεργεί εκ μέρους σας",
    "Could not fetch delegates" : "Δεν ήταν δυνατή η ανάκτηση των εκπροσώπων",
    "Delegated access to {displayName}" : "Εκχωρήθηκε πρόσβαση στον/στην {displayName}",
    "Could not delegate access" : "Δεν ήταν δυνατή η εκχώρηση πρόσβασης",
    "Revoked access for {displayName}" : "Ανακλήθηκε η πρόσβαση για τον/την {displayName}",
    "Could not revoke delegation" : "Δεν ήταν δυνατή η ανάκληση της εκχώρησης",
    "Delegation" : "Εκχώρηση",
    "Allow users to send, receive, and delete mail on your behalf" : "Να επιτρέπεται σε χρήστες να στέλνουν, λαμβάνουν και διαγράφουν αλληλογραφία εκ μέρους σας",
    "Revoke access" : "Ανάκληση πρόσβασης",
    "Add delegate" : "Προσθήκη εκπροσώπου",
    "Select a user" : "Επιλογή χρήστη",
    "They will be able to send, receive, and delete mail on your behalf" : "Θα μπορούν να στέλνουν, λαμβάνουν και διαγράφουν αλληλογραφία εκ μέρους σας",
    "Revoke access?" : "Ανάκληση πρόσβασης;",
    ...
    "Message saved to Files" : "Το μήνυμα αποθηκεύτηκε στα Αρχεία",
    "Message could not be saved" : "Δεν ήταν δυνατή η αποθήκευση του μηνύματος",
    ...
    "Choose a folder to store the message in" : "Επιλέξτε ένα φάκελο για την αποθήκευση του μηνύματος",
    ...
    "Save message to Files" : "Αποθήκευση μηνύματος στα Αρχεία",
    ...
    "This description was generated by AI." : "Αυτή η περιγραφή δημιουργήθηκε από ΤΝ.",
    ...
    "Favorites" : "Αγαπημένα",
    "Favorites info" : "Πληροφορίες αγαπημένων",
    "Load more favorites" : "Φόρτωση περισσότερων αγαπημένων",
    ...
    "Could not generate direct link: Message ID is missing" : "Δεν ήταν δυνατή η δημιουργία άμεσου συνδέσμου: Λείπει το αναγνωριστικό μηνύματος (Message ID)",
    "Direct link copied to clipboard" : "Ο άμεσος σύνδεσμος αντιγράφηκε στο πρόχειρο",
    "Copy direct link" : "Αντιγραφή άμεσου συνδέσμου",
    "Forward" : "Προώθηση",
    ...
    "Suggested replies are using AI" : "Οι προτεινόμενες απαντήσεις χρησιμοποιούν ΤΝ",
    ...
    "This account cannot connect" : "Αυτός ο λογαριασμός δεν μπορεί να συνδεθεί",
    "Connection failed. Please verify your information and try again" : "Η σύνδεση απέτυχε. Παρακαλώ επαληθεύστε τις πληροφορίες σας και δοκιμάστε ξανά",
    ...
    "could not delete account" : "δεν ήταν δυνατή η διαγραφή του λογαριασμού",
    ...
    "Delegate account" : "Εκχώρηση λογαριασμού",
    ...
    "Repair folder" : "Επιδιόρθωση φακέλου",
    ...
    "attached" : "συνημμένο",
    "No \"sent\" folder configured. Please pick one in the account settings." : "Δεν έχει ρυθμιστεί φάκελος \"απεσταλμένων\". Παρακαλώ επιλέξτε έναν στις ρυθμίσεις λογαριασμού.",
    ...
    "This translation is generated using AI and may contain inaccuracies" : "Αυτή η μετάφραση δημιουργείται με τη χρήση ΤΝ και ενδέχεται να περιέχει ανακρίβειες",
    ...
    "Train" : "Τρένο",
    "Mark message as" : "Σήμανση μηνύματος ως",
    ...
    "(All or part of this reply was generated by AI)" : "(Όλη ή μέρος αυτής της απάντησης δημιουργήθηκε από ΤΝ)",
    ...
    "Sorry, the message could not be loaded. The draft may no longer exist. Please refresh the page and try again." : "Λυπούμαστε, δεν ήταν δυνατή η φόρτωση του μηνύματος. Το πρόχειρο ενδέχεται να μην υπάρχει πλέον. Παρακαλούμε ανανεώστε τη σελίδα και δοκιμάστε ξανά.",
    ...
    "Allow accepting invitations even if no participant matches this account (forwards, mailing lists)" : "Να επιτρέπεται η αποδοχή προσκλήσεων ακόμη κι αν κανένας συμμετέχων δεν ταιριάζει με αυτόν τον λογαριασμό (προωθήσεις, λίστες)",
    "Default calendar for events and invitations" : "Προεπιλεγμένο ημερολόγιο για συμβάντα και προσκλήσεις",
    "Use app default" : "Χρήση προεπιλογής εφαρμογής",
    "None of this account's addresses is a participant. Accepting adds you and notifies the organizer." : "Καμία διεύθυνση αυτού του λογαριασμού δεν είναι συμμετέχων. Η αποδοχή σε προσθέτει και ειδοποιεί τον διοργανωτή.",
    "After deleting or moving a message" : "Μετά τη διαγραφή ή μετακίνηση ενός μηνύματος",
    "Open the next message" : "Άνοιγμα του επόμενου μηνύματος",
    "Open the previous message" : "Άνοιγμα του προηγούμενου μηνύματος",
    "Go back to the message list" : "Επιστροφή στη λίστα μηνυμάτων",
    "Mark all as unread" : "Σήμανση όλων ως μη αναγνωσμένων",
    "Thread actions" : "Ενέργειες νήματος",
    "Snooze thread" : "Αναβολή νήματος",
    "Unsnooze thread" : "Ακύρωση αναβολής νήματος",
    "Snooze thread until later today" : "Αναβολή νήματος έως αργότερα σήμερα",
    "Snooze thread until tomorrow" : "Αναβολή νήματος έως αύριο",
    "Snooze thread until this weekend" : "Αναβολή νήματος έως αυτό το σαββατοκύριακο",
    "Snooze thread until next week" : "Αναβολή νήματος έως την επόμενη εβδομάδα",
    "Mark thread as spam" : "Σήμανση νήματος ως ανεπιθύμητο",
    "Mark thread as not spam" : "Σήμανση νήματος ως μη ανεπιθύμητο",
    "Marked as spam" : "Σημειώθηκε ως ανεπιθύμητο",
    "Marked as not spam" : "Σημειώθηκε ως μη ανεπιθύμητο",
    ...
    "Thread archived" : "Το νήμα αρχειοθετήθηκε",
    "Thread moved" : "Το νήμα μετακινήθηκε",
    "Thread deleted" : "Το νήμα διαγράφηκε",
    "Thread snoozed" : "Το νήμα αναβλήθηκε",
    "Could not delete thread" : "Δεν ήταν δυνατή η διαγραφή του νήματος",
    "Could not move thread" : "Δεν ήταν δυνατή η μετακίνηση του νήματος",
    "Could not update spam status" : "Δεν ήταν δυνατή η ενημέρωση της κατάστασης ανεπιθύμητων",
    "Could not update read status" : "Δεν ήταν δυνατή η ενημέρωση της κατάστασης ανάγνωσης",
    "Details" : "Λεπτομέρειες",
    "Show sender and recipient details" : "Εμφάνιση στοιχείων αποστολέα και παραληπτών",
    "_%n message_::_%n messages_" : ["%n μήνυμα","%n μηνύματα"],
    ...
    "The mail server is temporarily busy. Please try again." : "Ο διακομιστής αλληλογραφίας είναι προσωρινά απασχολημένος. Δοκιμάστε ξανά.",
    "You are offline. Mail changes will be sent when the connection returns." : "Είστε εκτός σύνδεσης. Οι αλλαγές στην αλληλογραφία θα σταλούν όταν επανέλθει η σύνδεση.",
    "The connection is unstable. Mail actions will retry automatically." : "Η σύνδεση είναι ασταθής. Οι ενέργειες αλληλογραφίας θα επαναληφθούν αυτόματα.",
    "Connection restored. Finishing pending mail changes…" : "Η σύνδεση επανήλθε. Ολοκληρώνονται οι εκκρεμείς αλλαγές αλληλογραφίας…",
    "Pending mail changes: {count}" : "Εκκρεμείς αλλαγές αλληλογραφίας: {count}",
    "This summary was AI generated" : "Αυτή η σύνοψη δημιουργήθηκε από ΤΝ",
    "This summary is AI generated and may contain mistakes." : "Αυτή η σύνοψη δημιουργήθηκε από τεχνητή νοημοσύνη και μπορεί να περιέχει λάθη."
},
