OC.L10N.register(
    ...
    "_Mark {number} as spam_::_Mark {number} as spam_" : ["Σήμανση {number} ως ανεπιθύμητο","Σήμανση {number} ως ανεπιθύμητα"],
    "_Mark {number} as not spam_::_Mark {number} as not spam_" : ["Σήμανση {number} ως μη ανεπιθύμητο","Σήμανση {number} ως μη ανεπιθύμητα"],
