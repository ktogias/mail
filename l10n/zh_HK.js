OC.L10N.register(
    ...
    "Messages with no 'To' recipients may be rejected by some mail providers." : "沒有「收件者」的郵件可能會被部分郵件服務供應商拒收。",
    "Cc" : "副本",
    "Bcc" : "密件副本",
    "Subject" : "主題",
    "Subject …" : "主題 …",
    ...
    "Add as attachment" : "添加此附件",
    "Add as share link" : "添加為分享連結",
    ...
    "Direct link copied to clipboard" : "直接連結已複製到剪貼板",
    ...
    "Text blocks are reusable pieces of text that can be inserted in messages. Visit the Settings panel to create your own." : "文字區塊是可重複使用並插入郵件中的文字內容。前往「設定」面板建立你自己的文字區塊。",
