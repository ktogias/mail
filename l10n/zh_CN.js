OC.L10N.register(
    ...
    "{account_email} has been delegated to you" : "{account_email} 已委派给您",
    "{user} delegated {account} to you" : "{user} 已将 {account} 委派给您",
    "{account_email} is no longer delegated to you" : "{account_email} 不再委派给您",
    "{user} revoked delegation for {account}" : "{user} 已撤销 {account} 的委派",
    ...
    "Messages with no 'To' recipients may be rejected by some mail providers." : "部分邮件服务提供者可能会拒绝没有“收件人”的邮件。",
    "Cc" : "抄送",
    "Bcc" : "密送",
    "Subject" : "主题",
    "Subject …" : "主题 …",
    ...
    "Mark as AI generated" : "标记为 AI 生成",
    ...
    "Add as attachment" : "添加为附件",
    "Add as share link" : "添加为共享链接",
    ...
    "Delegated access to {displayName}" : "已委派访问 {displayName}",
    "Could not delegate access" : "无法委派访问权限",
    "Revoked access for {displayName}" : "已撤销 {displayName} 的访问权限",
    ...
    "Message saved to Files" : "邮件已保存到文件",
    "Message could not be saved" : "无法保存邮件",
    "This summary was AI-generated" : "此摘要由 AI 生成",
    "Encrypted message" : "已加密邮件",
    "This message is unread" : "此邮件未读",
    "Choose a folder to store the message in" : "选择一个文件夹来存储邮件",
    "Unfavorite" : "取消收藏",
    "Favorite" : "收藏",
    "Unread" : "未读",
    "Read" : "读取",
    ...
    "Save message to Files" : "将邮件保存到文件",
    "Delete thread" : "删除线程",
    "Delete message" : "删除邮件",
    ...
    "This description was generated by AI." : "此描述由 AI 生成。",
    "Event created" : "已创建事件",
    ...
    "Could not generate direct link: Message ID is missing" : "无法生成直接链接：缺少邮件 ID",
    "Direct link copied to clipboard" : "直接链接已复制到剪贴板",
    ...
    "Restore composer" : "恢复编辑器",
    "Maximize composer" : "最大化编辑器",
    "Minimize composer" : "最小化编辑器",
    "Close contact info" : "关闭联系人信息",
    ...
    "Signature …" : "签名 …",
    "This signature is larger than 2 MB, usually because an image is embedded in it. It is added to every message you send and may slow down the editor." : "此签名大于 2 MB，通常是因为其中嵌入了图片。它会添加到您发送的每封邮件中，可能会减慢编辑器的速度。",
    "This signature contains images. New messages will use rich text, even though your writing mode is set to plain text." : "此签名包含图片。即使您的写作模式设置为纯文本，新邮件也将使用富文本。",
    "Save signature" : "保存签名",
    ...
    "Newest message" : "最新邮件",
    "This summary is AI-generated and may contain mistakes." : "此摘要由 AI 生成，可能包含错误。",
    ...
    "Text blocks are reusable pieces of text that can be inserted in messages. Visit the Settings panel to create your own." : "文本块是可重复使用的文本片段，可以插入到邮件中。请访问“设置”面板创建您自己的文本块。",
    ...
    "Insert image from Files" : "从文件插入图片",
    "Choose an image" : "选择图片",
    "Select an image" : "选择图片",
    "Insert {name}" : "插入 {name}",
    "The selected image is too large to embed" : "所选图片太大，无法嵌入",
    "Could not insert the selected image" : "无法插入所选图片",
    "All" : "全部",
    "Drafts" : "草稿",
    ...
    "Date:" : "日期：",
    "Printing from the browser menu is not supported" : "不支持从浏览器菜单打印",
    "To print this email, press {shortcut}, or use the \"Print message\" action in the message menu." : "要打印此电子邮件，请按 {shortcut}，或使用邮件菜单中的“打印邮件”操作。",
