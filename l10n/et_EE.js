OC.L10N.register(
    ...
    "You are currently using {percentage} of your mailbox storage. Please make some space by deleting unneeded emails." : "Kasutad praegu {percentage} oma postkasti andmeruumist. Palun kustuta mittevajalikud kirjad ning saad andmeruumi juurde.",
    "{account_email} has been delegated to you" : "sul on nüüd {account_email} e-postikonto volitus",
    "{user} delegated {account} to you" : "{user} volitas sind kasutama {account} e-posti kontot",
    ...
    "Aliases" : "Aliased",
    "Alias to S/MIME certificate mapping" : "Alias S/MIME sertifikaatide vastenduse jaoks",
    ...
    "The folders to use for drafts, sent messages, deleted messages, archived messages and junk messages." : "Kaustad kavandite, saadetud ja kustutatud kirjade ning arhiveeritud ning rämpskirjade jaoks.",
    ...
    "Mark messages as read" : "Märgi kirjad loetuks",
    "Immediately" : "Kohe",
    "Manually" : "Käsitsi",
    ...
    "Heading1" : "1. taseme pealkiri",
    "Heading2" : "2. taseme pealkiri",
    "Heading3" : "3. taseme pealkiri",
    ...
    "_After %n second_::_After %n seconds_" : ["%n sekundi möödumisel","%n sekundi möödumisel"],
    ...
    "Mark as AI generated" : "Märgi koostatuks tehisaru poolt",
    ...
    "Add as share link" : "Lisa jagamislingina",
    ...
    "Delegated access to {displayName}" : "Ligipääs on volitatud „{displayName}“ kasutajale",
    "Could not delegate access" : "Ligipääsu volitamine ei õnnestunud",
    "Revoked access for {displayName}" : "„{displayName}“ kasutaja ligipääs on tühistatud",
    ...
    "Message saved to Files" : "E-kKiri on salvestatud failirakendusse",
    "Message could not be saved" : "E-kirja salvestamine ei õnnestunud",
    "This summary was AI-generated" : "See kokkuvõte on koostatud tehisaru poolt",
    "Encrypted message" : "Krüptitud e-kiri",
    "This message is unread" : "See kiri on lugemata",
    "Choose a folder to store the message in" : "Vali, kaust, kuhu tahad e-kirja salvestada",
    ...
    "Save message to Files" : "Salvesta e-kiri failirakendusse",
    ...
    "No more submailboxes in here" : "Siin pole rohkem alampostkaste",
    ...
    "Could not generate direct link: Message ID is missing" : "Otselingi koostamine ei õnnestunud: kirja tunnus on puudu",
    "Direct link copied to clipboard" : "Otselink on lõikelauale kopeeritud",
    "Copy direct link" : "Kopeeri otselink",
    "Forward" : "Edasta",
    "Only for message recipients" : "Vaid kirjasaajad",
    "Link copied" : "Link on kopeeritud",
    "Move message" : "Teisalda kiri",
    "Translate" : "Tõlgi",
    "Forward message as attachment" : "Edasta kiri manusena",
    "View source" : "Vaata kirja lähtekoodi",
    "Print message" : "Prindi e-kiri",
    ...
    "Download Zip" : "Laadi zip-fail alla",
    ...
    "Connection failed. Please verify your information and try again" : "Ühendamine ei õnnestunud. Palun kontrolli, kas kogu sisestatud teave on õige ja proovi uuesti",
    ...
    "Collapse folders" : "Ahenda kaustu",
    ...
    "Subscribed" : "Tellitud",
    "Sync in background" : "Sünkrooni taustal",
    ...
    "No \"sent\" folder configured. Please pick one in the account settings." : "Saadetud kirjade kaust on seadistamata. Palun tee seda kasutajakonto seadistustes.",
    "You are trying to send to many recipients in To and/or Cc. Consider using Bcc to hide recipient addresses." : "Sa üritad saata kirja, kus saaja ja koopia väljal on hiidpalju aadresse. Kirjasaajate privaatsuse ja mugavuse nimel palun kasuta pimekoopia välja.",
    ...
    "Welcome to {productName} Mail" : "Tere tulemast  kasutama {productName}i E-postirakendust",
    ...
    "Marked as" : "Märgitud kui",
    "Has attachments" : "Leidub manuseid",
    "Mentions me" : "Mainib mind",
    "Has attachment" : "Manusega",
    "To me" : "Mulle",
    "Enable mail body search" : "Otsi kirja sisust",
    "Sieve is a powerful language for writing filters for your mailbox. You can manage the sieve scripts in Mail if your email service supports it. Sieve is also required to use Autoresponder and Filters." : "Sieve on väga võimas keel, mille abil saad koostada filtreid oma postkastide jaoks. Kui sinu e-posti teenusepakkuja seda võimalust toetab, siis saad Sieve'i kasutada ka siin rakenduses. Sieve on vajalik rakenduse automaatvastaja ja kirjafiltrite jaoks.",
    "Enable sieve filter" : "Võta Sieve'i filter kasutusele",
    "Sieve host" : "Sieve'i server",
    "Sieve security" : "Sieve'i turvalisus",
    "Sieve Port" : "Sieve'i port",
    "Sieve credentials" : "Sieve'i kasutajanimi/salasõna",
    ...
    "Signature …" : "Allkiri…",
    "This signature is larger than 2 MB, usually because an image is embedded in it. It is added to every message you send and may slow down the editor." : "See allkiri on suurem, kui 2 MB. Tavaliselt juhtub nii sinna lisatud suure pildifaili tõttu. Seega saavad kõik sinu kirjad alati olema sama andmemahu võrra suuremad ning kirjade koostamise liides toimib killuke aeglasemalt.",
    "This signature contains images. New messages will use rich text, even though your writing mode is set to plain text." : "Selles allkirjas leidub pilte. See tähendab, et kõik uued kirjad saadetakse vormindatud HTML-kirjadena ka siis, kui seadistustest oled määranud vorminguks vormindamata tavateksti.",
    ...
    "Could not print message" : "E-kirja printimine ei õnnestunud",
    ...
    "Contains AI content" : "Sisaldab tehisaru poolt koostatud sisu",
    ...
    "You have to register a new Client ID for a \"Web application\" in the Google Cloud console. Add the URL {url} as authorized redirect URI." : "Sa pead Google Cloudi juhtpaneelis registreerima veebirakenduse (Web application) jaoks uue klienditunnuse (Client ID). Korrektse edasisuunamisaadressina kasuta: {url}",
    ...
    "Redirect URI" : "Edasusuunamise aadress (URI)",
    ...
    "Text blocks are reusable pieces of text that can be inserted in messages. Visit the Settings panel to create your own." : "Tekstilõigud on korduvkasutatavad tekstiplokid, mida saad lisada sõnumitesse. Ava seadistuste vaade ja saad lisada endale vajalikke tekstilõike.",
    "Account connected" : "Kasutajakonto on ühendatud",
    ...
    "Insert image from Files" : "Lisa failirakendusest pilt",
    "Choose an image" : "Vali pilt",
    "Select an image" : "Vali pilt",
    "Insert {name}" : "Lisa „{name}“",
    "The selected image is too large to embed" : "Valitud pilt on manusena lisamiseks liiga suur",
    "Could not insert the selected image" : "Valitud pildi lisamine ei õnnestunud",
    "All" : "Kõik",
    "Drafts" : "Kavandid",
    "Priority inbox" : "Olulised kirjad",
    "All inboxes" : "Kõik saabuvad kirjad",
    "Inbox" : "Saabuvad kirjad",
    "Junk" : "Rämpspost",
    "Sent" : "Saadetud",
    "Trash" : "Prügikast",
    ...
    "Date:" : "Kuupäev:",
    "Printing from the browser menu is not supported" : "Printimine veebibrauseri menüüst pole toetatud",
    "To print this email, press {shortcut}, or use the \"Print message\" action in the message menu." : "Selle e-kirja tõlkimiseks klõpsa {shortcut} või kasuta kirjade menüüs leiduvat valikut „Prindi e-kiri“.",
