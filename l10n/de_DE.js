OC.L10N.register(
    ...
    "Google requires OAuth authentication. If your Nextcloud admin has not configured Google OAuth, you can use a Google App Password instead." : "Google erfordert eine OAuth-Authentifizierung. Wenn die Nextcloud-Administration Google OAuth nicht eingerichtet hat, kann stattdessen ein Google App-Passwort verwendet werden.",
    "Microsoft requires OAuth authentication. Ask your Nextcloud admin to configure Microsoft OAuth in the admin settings." : "Microsoft erfordert OAuth-Authentifizierung. Bitten Sie Ihre Nextcloud-Administration, Microsoft OAuth in den Administrations-Einstellungen einzurichten.",
    ...
    "_After %n second_::_After %n seconds_" : ["Nach %n Sekunde","Nach %n Sekunden"],
    ...
    "Messages with no 'To' recipients may be rejected by some mail providers." : "Nachrichten ohne 'An'-Empfänger werden u.U. von einigen E-Mail-Anbietern abgelehnt.",
    "Cc" : "Cc",
    "Bcc" : "Bcc",
    "Subject" : "Betreff",
    "Subject …" : "Betreff …",
    ...
    "Remove attachment {fileName}" : "Anhang {fileName} entfernen",
    "Add as attachment" : "Als Anhang hinzufügen",
    "Add as share link" : "Als Freigabe-Link hinzufügen",
    ...
    "Delegated access to {displayName}" : "Zugriff delegiert an {displayName}",
    "Could not delegate access" : "Zugriff konnte nicht delegiert werden",
    "Revoked access for {displayName}" : "Zugriff für {displayName} widerrufen",
    ...
    "Message saved to Files" : "Nachricht wurde in Dateien gespeichert",
    "Message could not be saved" : "Nachricht konnte nicht gespeichert werden",
    "This summary was AI-generated" : "Diese Zusammenfassung wurde von KI erstellt",
    "Encrypted message" : "Verschlüsselte Nachricht",
    "This message is unread" : "Diese Nachricht ist ungelesen",
    "Choose a folder to store the message in" : "Ordner zum Speichern der Nachricht auswählen",
    ...
    "Save message to Files" : "Nachricht in Dateien speichern",
    ...
    "Suggested replies are using AI" : "Empfohlene Antworten verwenden KI",
    ...
    "Your message has no subject. Do you want to send it anyway?" : "Ihre Nachricht hat keinen Betreff. Soll sie trotzdem gesendet werden?",
    ...
    "This signature contains images. New messages will use rich text, even though your writing mode is set to plain text." : "Diese Signatur enthält Bilder. Neue Nachrichten werden im formatierten Text angezeigt, auch wenn Ihr Schreibmodus auf Nur-Text eingestellt ist.",
    ...
    "Are you sure to delete the mail filter?" : "Soll dieser Mailfilter gelöscht werden?",
    ...
    "Insert image from Files" : "Bild aus Dateien einfügen",
    "Choose an image" : "Bild auswählen",
    "Select an image" : "Ein Bild auswählen",
    "Insert {name}" : "{name} einfügen",
    "The selected image is too large to embed" : "Das ausgewählte Bild ist zu groß um es einzubetten",
    "Could not insert the selected image" : "Das ausgwählte Bild konnte nicht eingefügt werden",
    "All" : "Alle",
    "Drafts" : "Entwürfe",
    ...
    "(All or part of this reply was generated by AI)" : "(Diese Antwort wurde ganz oder teilweise von KI erstellt)",
