OC.L10N.register(
    ...
    "You are currently using {percentage} of your mailbox storage. Please make some space by deleting unneeded emails." : "Vous utilisez actuellement {percentage} de l'espace de stockage de votre boîte aux lettres. Veuillez faire de la place en supprimant les e-mails inutiles.",
    ...
    "Reply-To email: %1$s is different from sender email: %2$s" : "L’adresse de réponse %1$s est différente de l’adresse e-mail de l’expéditeur %2$s",
    ...
    "Microsoft requires OAuth authentication. Ask your Nextcloud admin to configure Microsoft OAuth in the admin settings." : "Microsoft exige une authentification OAuth. Demandez à votre administrateur Nextcloud de configurer Microsoft OAuth dans les paramètres administrateur.",
    ...
    "Activate" : "Activer",
    "Make mails available to Context Chat" : "Rendre les e-mails disponibles dans le chat contextuel",
    ...
    "Mark messages as read" : "Marquer les messages comme lus",
    ...
    "_After %n second_::_After %n seconds_" : ["Après %n seconde","Après %n secondes","Après %n secondes"],
    ...
    "Remove attachment {fileName}" : "Supprimer la pièce jointe {fileName}",
    "Add as attachment" : "Ajouter en pièce jointe",
    "Add as share link" : "Ajouter comme lien de partage",
    ...
    "Delegated access to {displayName}" : "Accès délégué à {displayName}",
    "Could not delegate access" : "Impossible de déléguer l'accès",
    "Revoked access for {displayName}" : "Accès révoqué pour {displayName}",
    ...
    "Message saved to Files" : "Message enregistré dans Fichiers",
    "Message could not be saved" : "Impossible d’enregistrer le message",
    "This summary was AI-generated" : "Ce résumé a été généré par une IA",
    "Encrypted message" : "Message chiffré",
    "This message is unread" : "Ce message est non-lu",
    "Choose a folder to store the message in" : "Choisissez un dossier où enregistrer le message",
    ...
    "Save message to Files" : "Enregistrer le message dans Fichiers",
    "Delete thread" : "Supprimer ce fil de discussion",
    "Delete message" : "Supprimer le message",
    "Back to all actions" : "Retour à toutes les actions",
    "Manage quick actions" : "Gérer les actions rapides",
    ...
    "This description was generated by AI." : "Cette description a été générée par IA.",
    ...
    "Messages will automatically be marked as important using AI. The system learns from which messages you interact with or mark as important. In the beginning you might have to manually change the importance to teach it, but it will improve over time" : "Les messages seront automatiquement marqués comme important en utilisant l'IA. Le système apprend des messages avec lesquels vous interagissez ou marquez comme important. Au départ, vous devez changer manuellement l'importance pour lui apprendre, mais il s'améliorera avec le temps",
    ...
    "AI identifies messages sent by you that likely require a reply but did not receive one after a couple of days and shows them here" : "L'IA identifie les messages envoyés par vous qui attendent une réponse mais n'en ont pas encore reçu après quelques jours et les montrent ici.",
    "Favorites" : "Favoris",
    "Favorites info" : "Informations sur les favoris",
    ...
    "Could not generate direct link: Message ID is missing" : "Impossible de générer un lien direct : l'identifiant du message est manquant.",
    ...
    "Suggested replies are using AI" : "Les réponses suggérées utilisent l'IA",
    ...
    "Save all to Files" : "Tout enregistrer dans Fichiers",
    ...
    "Add to Contact" : "Ajouter à un contact",
    ...
    "Has attachments" : "Possédant des pièces jointes",
    "Mentions me" : "Me mentionnant",
    ...
    "Signature …" : "Signature  …",
    "This signature is larger than 2 MB, usually because an image is embedded in it. It is added to every message you send and may slow down the editor." : "Cette signature fait plus de 2 Mo, généralement parce qu'elle intègre une image. Elle est ajoutée à chaque message que vous envoyez et peut ralentir l'éditeur.",
    "This signature contains images. New messages will use rich text, even though your writing mode is set to plain text." : "Cette signature contient des images. Les nouveaux messages utiliseront le texte enrichi même si votre mode d'écriture est défini sur texte brut.",
    ...
    "This summary is AI-generated and may contain mistakes." : "Ce résumé est généré par une IA et peut contenir des erreurs.",
    ...
    "This translation is generated using AI and may contain inaccuracies" : "La traduction a été générée en utilisant l'IA et peut être imprécise",
    ...
    "Text blocks are reusable pieces of text that can be inserted in messages. Visit the Settings panel to create your own." : "Les blocs de texte sont des éléments réutilisables qui peuvent être insérés dans les messages. Accédez au panneau des paramètres pour créer les vôtres.",
    ...
    "Insert image from Files" : "Insérer une image depuis Fichiers",
    "Choose an image" : "Choisir une image",
    "Select an image" : "Sélectionner une image",
    "Insert {name}" : "Insérer {name}",
    "The selected image is too large to embed" : "L’image sélectionnée est trop volumineuse pour être intégrée",
    "Could not insert the selected image" : "Impossible d’insérer l’image sélectionnée",
    "All" : "Tout",
    "Drafts" : "Brouillons",
    ...
    "(All or part of this reply was generated by AI)" : "(Tout ou partie de cette réponse a été générée par IA)",
    ...
    "Sorry, the message could not be loaded. The draft may no longer exist. Please refresh the page and try again." : "Désolé, le message n'a pas pu être chargé. Le brouillon n'existe peut-être plus. Merci de rafraîchir la page et essayer à nouveau.",
    ...
    "Date:" : "Date :",
    "Printing from the browser menu is not supported" : "L'impression depuis le menu du navigateur n'est pas supportée.",
    "To print this email, press {shortcut}, or use the \"Print message\" action in the message menu." : "Pour imprimer cet email, appuyez sur {shortcut}, ou cliquez sur \"Imprimer le message\" dans le menu du message.",
