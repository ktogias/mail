...
* **deps:** Fix npm audit ([ac88d31](https://github.com/nextcloud/mail/commit/ac88d31f42f98eb0bedb82b72c462dc82eedcd9b))
* **drafts:** preserve Bcc header when saving drafts ([5e0117e](https://github.com/nextcloud/mail/commit/5e0117e5c84544e00e3c893c26a88cb41f416e77))
* Exclude shared mailboxes from special mailbox auto-detection ([aea9e4b](https://github.com/nextcloud/mail/commit/aea9e4b50538526891fd0625a0eca383a48c9db1))
* fixed "ORGANIZER" in ICS generated by "Reply with meeting" and delivered to DAV endpoint ([7116159](https://github.com/nextcloud/mail/commit/7116159fa08523dfc29328d4c623f1573cb37460))
* hide "create task" option when no task calendar is available ([67e21a1](https://github.com/nextcloud/mail/commit/67e21a12b1ba384dfb30991669fb740b9d01bce6))
* **l10n:** Update translations from Transifex ([b4606f0](https://github.com/nextcloud/mail/commit/b4606f08ddcbd45e174d5a4d2c9819cdb8f82d8b))
* **l10n:** Update translations from Transifex ([73a0dd9](https://github.com/nextcloud/mail/commit/73a0dd92e1a904101c8d201757e3505ad656c7ae))
* **l10n:** Update translations from Transifex ([6944219](https://github.com/nextcloud/mail/commit/69442196cddfc6cdc3685c287dee09e6cffa09d2))
* **l10n:** Update translations from Transifex ([24518c6](https://github.com/nextcloud/mail/commit/24518c621fb33eca47e5c9497f20bc9365c54995))
* **l10n:** Update translations from Transifex ([2919106](https://github.com/nextcloud/mail/commit/2919106e599e04a962eee8399c323c596dde27d6))
* moved "Delete thread" at the end of the contextual actions menu ([997f5ab](https://github.com/nextcloud/mail/commit/997f5ab7c8e064370a978174f35ce375d2978595))
* only pin favorites when it s not part of the query ([3e4e22f](https://github.com/nextcloud/mail/commit/3e4e22faa90c035189f940a3dfd68312f090e718))
* restore sender copy-to-clipboard and fix thread subject alignment ([02d21de](https://github.com/nextcloud/mail/commit/02d21de6eaabba2e4bf61e3339d69c291545b463)), closes [#12952](https://github.com/nextcloud/mail/issues/12952) [#12946](https://github.com/nextcloud/mail/issues/12946) [#12666](https://github.com/nextcloud/mail/issues/12666)
* sorting of items in "Mail settings" dialog ([0184f58](https://github.com/nextcloud/mail/commit/0184f58657bd3ea0490b1da3364eb5875bd7afc5))
* allow scripts in message iframe sandbox so the body resizes ([400a4aa](https://github.com/nextcloud/mail/commit/400a4aa866f9e1c3709347a55d1b6960561109ec)), closes [#13088](https://github.com/nextcloud/mail/issues/13088) [#13527](https://github.com/nextcloud/mail/issues/13527)



# [5.11.0](https://github.com/nextcloud/mail/compare/v5.11.0-rc.2...v5.11.0) (2026-08-20)


### Bug Fixes

* add sandbox for iframe ([823e6ae](https://github.com/nextcloud/mail/commit/823e6aef9d35509fa90dafcb47b4a95afb3df93f))
* **attachments:** don't preview attachments when viewer app is disabled ([2a8f841](https://github.com/nextcloud/mail/commit/2a8f841e6b613814ff21e8096b956907faf95f6f))
* **composer:** keep resized image dimensions in sent messages ([ee35cf4](https://github.com/nextcloud/mail/commit/ee35cf4dea1805a43f309555d09fd755f3a1cb01))
* **deps:** bump dompurify from ^3.4.11 to v3.4.13 ([5b658c3](https://github.com/nextcloud/mail/commit/5b658c36d06d547c10332d1daac8c7aeea26a898))
* **l10n:** Update translations from Transifex ([b218981](https://github.com/nextcloud/mail/commit/b2189816f67fdc57c4fcafacb504665c0e364479))



# [5.11.0-rc.2](https://github.com/nextcloud/mail/compare/v5.11.0-rc.1...v5.11.0-rc.2) (2026-08-19)


### Bug Fixes

* **l10n:** Update translations from Transifex ([83739be](https://github.com/nextcloud/mail/commit/83739beddc349e8ae144e4f61959b278d7bed819))
* **migration:** support the new OCP DB schema API ([6ebcbca](https://github.com/nextcloud/mail/commit/6ebcbcaa27c131145d7024006edd030bbb9a4b84))



# [5.11.0-rc.1](https://github.com/nextcloud/mail/compare/v5.11.0-beta.3...v5.11.0-rc.1) (2026-08-18)


### Bug Fixes

* **dav:** use the default webdav client instead of patching axios ([2226b57](https://github.com/nextcloud/mail/commit/2226b579564eccb1081d224386dac0247d081492))
* **l10n:** Update translations from Transifex ([3353f51](https://github.com/nextcloud/mail/commit/3353f5166623c3a8cfecc738b87277a6f9a969c5))
* **l10n:** Update translations from Transifex ([f757709](https://github.com/nextcloud/mail/commit/f757709f3fd2a1bfbbfee08d27f37b80fd3bde34))
* **l10n:** Update translations from Transifex ([6c58de0](https://github.com/nextcloud/mail/commit/6c58de0b4c9dd66a39a3f9ba269d14f90bf016eb))
* **l10n:** Update translations from Transifex ([12146a1](https://github.com/nextcloud/mail/commit/12146a12d3b595df934fe06fdde551df91906380))
* **l10n:** Update translations from Transifex ([d673308](https://github.com/nextcloud/mail/commit/d673308a267bbfbb6527118794eb57b453d35afb))
* **l10n:** Update translations from Transifex ([bb652d3](https://github.com/nextcloud/mail/commit/bb652d32eed33aa48a0cf3cec0c91dfecb8952f8))
* **l10n:** Update translations from Transifex ([84f2000](https://github.com/nextcloud/mail/commit/84f20004178bce4854e6b9b740894ee11f6b9ba9))
* **l10n:** Update translations from Transifex ([162a8dc](https://github.com/nextcloud/mail/commit/162a8dc972a14efc92170b35edac4cfd0e92f855))



# [5.11.0-beta.3](https://github.com/nextcloud/mail/compare/v5.11.0-beta.2...v5.11.0-beta.3) (2026-08-10)


### Bug Fixes

* force user identifier when saving tags ([383ed96](https://github.com/nextcloud/mail/commit/383ed96cfa719d8c2ba3c6dbe508435c97dcb8d5))
* handle empty replyTo array properly ([c6dfd90](https://github.com/nextcloud/mail/commit/c6dfd909901b4fe265d0732599e78add9bac9273))
* **l10n:** Update translations from Transifex ([6aa70c5](https://github.com/nextcloud/mail/commit/6aa70c5ab8c826a7bff12997f0839576928bdf20))
* **l10n:** Update translations from Transifex ([f0df881](https://github.com/nextcloud/mail/commit/f0df881b13e4d39832ff9fca03dafa10f1e3d89d))
* **l10n:** Update translations from Transifex ([ee29ae6](https://github.com/nextcloud/mail/commit/ee29ae615d99099c5401e73cb753dc2967a210ee))
* Rename messageId to uid ([9fb470f](https://github.com/nextcloud/mail/commit/9fb470f53a09bcb95eb3e1d3bcbedc4f4f712cd6))


### Features

* make some events webhook compatible ([759ea03](https://github.com/nextcloud/mail/commit/759ea030153f9e6dd7391c66fe0478aeb21d8824))
* passing full reference to mailbox in BeforeMessageDeletedEvent ([7bbf139](https://github.com/nextcloud/mail/commit/7bbf139b83e06b0188389624f5afc405523d6f2f))
* text blocks empty state ([b8dd79c](https://github.com/nextcloud/mail/commit/b8dd79c7e333a3d66cdb24317f0d242de55c345b))



# [5.11.0-beta.2](https://github.com/nextcloud/mail/compare/v5.11.0-beta.1...v5.11.0-beta.2) (2026-08-06)


### Bug Fixes

* Adjust relative date display to also use timestamp for yesterday ([0f7dc0d](https://github.com/nextcloud/mail/commit/0f7dc0d9b70ba5f3285716c1da8e93e684ca3896))
* **ai-integrations:** check for star/end email in message bodies and validate json output for smart replies ([bdc1c1c](https://github.com/nextcloud/mail/commit/bdc1c1cbb05ee4c915d97bc5353045c05f4e6238))
* **composer:** keep signature images by switching to rich text ([e1ab04d](https://github.com/nextcloud/mail/commit/e1ab04dcdbd2f7b556c6f299715f7f5321b55e06))
* configurable timeout for connectivity tester ([18217d0](https://github.com/nextcloud/mail/commit/18217d06de2bb0b80e4cbd2c76b067feea45b677))
* Correct hasLocks() expiry check ([e5cfdaa](https://github.com/nextcloud/mail/commit/e5cfdaa1c38363fa3afc6cd012c82baa663becbf))
* correct spelling errors in error messages and comments ([7e774ef](https://github.com/nextcloud/mail/commit/7e774ef3cafcf8589f411e180740ec7192defe83))
* **deps:** bump postcss from ^8.5.16 to v8.5.18 ([#13365](https://github.com/nextcloud/mail/issues/13365)) ([e0a8523](https://github.com/nextcloud/mail/commit/e0a852320698ceefcaa447a7017c5c2186103dcd))
* **deps:** bump postcss from ^8.5.16 to v8.5.23 ([#13419](https://github.com/nextcloud/mail/issues/13419)) ([ef2bf1c](https://github.com/nextcloud/mail/commit/ef2bf1c3e26bbf51edb4c8b133ea54d38c81a9ae))
* **dns:** Update public suffix list ([eb88857](https://github.com/nextcloud/mail/commit/eb88857a98c164361209ddb3dfb1f48d8b6ed37d))
* **html:** prevent invalid UTF-8 from blanking mail body ([05b3289](https://github.com/nextcloud/mail/commit/05b3289cb0c20f011ea5cd515079d50acb599693))
* **html:** strip conditional markup from html mail bodies ([f90b646](https://github.com/nextcloud/mail/commit/f90b646d627a7dc36df6de18fc6bd5f9254b701a))
* **imap:** use PEEK when fetching attachment/body content ([b4463ef](https://github.com/nextcloud/mail/commit/b4463ef02b11f8fda9158d77772cd80b28a28c32))
* **imip:** log why an iMIP message was flagged as failed ([8121dd4](https://github.com/nextcloud/mail/commit/8121dd498f1e3afa714ab21465f152d5ec7c4e70))
* **l10n:** Update translations from Transifex ([b65261f](https://github.com/nextcloud/mail/commit/b65261f4d641c902316aff07c75266b2aa7d37ff))
* **l10n:** Update translations from Transifex ([54fc382](https://github.com/nextcloud/mail/commit/54fc382fd25634d9dfa3cdf5f5394dffbb44a42d))
* **l10n:** Update translations from Transifex ([3e6d415](https://github.com/nextcloud/mail/commit/3e6d415172bb3bb7abef1d9784d2cf41c1ae8f74))
* **l10n:** Update translations from Transifex ([d1cc084](https://github.com/nextcloud/mail/commit/d1cc084e2f3dbb46468dced01009063e4f77fe25))
* **l10n:** Update translations from Transifex ([3d29118](https://github.com/nextcloud/mail/commit/3d291183730fc1deef02f6f80041e69cad8a8a92))
* **l10n:** Update translations from Transifex ([ce89d03](https://github.com/nextcloud/mail/commit/ce89d03e87da330afa6ee01552cd7a7486713bb9))
* **l10n:** Update translations from Transifex ([a064b99](https://github.com/nextcloud/mail/commit/a064b99606eaf83f73cda6afb4ba3268c177e49c))
* **l10n:** Update translations from Transifex ([cd5c729](https://github.com/nextcloud/mail/commit/cd5c72999d00067c58c1e3e3659e4b1f764f999d))
* **l10n:** Update translations from Transifex ([61e5828](https://github.com/nextcloud/mail/commit/61e5828a5af95ba1a2109d750bc0bf5d02e6b702))
* **l10n:** Update translations from Transifex ([452e9c1](https://github.com/nextcloud/mail/commit/452e9c1de6e98097263eee3a16b4c2e77b38673c))
* **l10n:** Update translations from Transifex ([88dbf02](https://github.com/nextcloud/mail/commit/88dbf027343a8abefa50de8efcc01c110e5e67c6))
* **mailbox:** Flag shared mailboxes as shared ([2c71bdc](https://github.com/nextcloud/mail/commit/2c71bdcd6486eca2213964fc3896fc2595b35b32))
* **mailbox:** Ignore prefix-less namespaces in shared detection ([e9061ca](https://github.com/nextcloud/mail/commit/e9061cad97e66a0804a4fb60334f964a6e2d9fc8))
* **search:** use deep link ([7456e21](https://github.com/nextcloud/mail/commit/7456e21a946212ea4aee630a52ccc42e9ecfce57))
* **settings:** Add loading states ([94c5159](https://github.com/nextcloud/mail/commit/94c51599fb00f778c47e0d8fa610ad2c10967560))
* **settings:** bind signature editor to the account writing mode ([89f8bf0](https://github.com/nextcloud/mail/commit/89f8bf0a63085bea08ab8e749797e647bf84edd8))
* **UI:** 2 columns for filtering checkboxes instead of 3 (better readability) ([46657fd](https://github.com/nextcloud/mail/commit/46657fd6e3521f0bc320e8a86bdabd561755d172))
* unify mail printing ([d141a57](https://github.com/nextcloud/mail/commit/d141a5740d92a18ac1d66a3df121c2697f1c0a41))


### Features

* filtering folders in mailbox picker ([54fdfab](https://github.com/nextcloud/mail/commit/54fdfab8a2504f28c833a48d03d69b796735c9aa))
* sync imap and smtp credentials while filling new account form ([08bad9d](https://github.com/nextcloud/mail/commit/08bad9d127ce6134670a6a2fc59d20ceb7f2fbae))
* **ui:** Add options for auto mark as read delay ([e261143](https://github.com/nextcloud/mail/commit/e2611434bb5b00eeb97e5f2931f2c5bb59190adf))



# [5.11.0-beta.1](https://github.com/nextcloud/mail/compare/v5.10.0-rc.1...v5.11.0-beta.1) (2026-07-23)


### Bug Fixes

* **a11y:** add missing ARIA labels to form inputs and buttons ([3023f78](https://github.com/nextcloud/mail/commit/3023f78b249417b66763bb9fa1151ecf82e5afcd))
* account settings section font size ([9ad7042](https://github.com/nextcloud/mail/commit/9ad7042a6d9594329e1990d13249b9c032e146d1))
* **AccountSettings:** overflow bug when using autoresponder checkbox ([768ff4c](https://github.com/nextcloud/mail/commit/768ff4c64bdfa277aef9775c1c51171de4ad60cc))
* adjust sender details styling and alignment in thread view ([e50927b](https://github.com/nextcloud/mail/commit/e50927b8eac554959039e5e7b8ddcdcb6da0dfc9))
* **ai:** migrate AiIntegrationsService off deprecated TextProcessing API ([2dc1683](https://github.com/nextcloud/mail/commit/2dc168355a9fe7edd4f1c29b970a18f91590533c))
* **attachments:** store uploads under account owner for delegated sends ([d78ef2c](https://github.com/nextcloud/mail/commit/d78ef2ceb23181b7cae7bfde6e775eb71e4421db))
* check tag while renaming ([cbc008d](https://github.com/nextcloud/mail/commit/cbc008df76f81a71a8fdf264c57b0ad96d7e4208))
* **composer:** do not re-insert signature when opening a draft ([9e36af9](https://github.com/nextcloud/mail/commit/9e36af99933a54d85a0dd1e521bb8b306d08140e))
* **delegation:** clean delegations on user deletion ([#13147](https://github.com/nextcloud/mail/issues/13147)) ([ef21807](https://github.com/nextcloud/mail/commit/ef21807e9debfa2a8e292437bd92315d23d3c283))
* **delegation:** show delegates' display names instead of usernames ([de41602](https://github.com/nextcloud/mail/commit/de4160213cbf88657752097a8c50c9449d7c5d75))
* **deps:** bump @nextcloud/cdav-library from ^2.2.0 to ^2.6.2 ([#13237](https://github.com/nextcloud/mail/issues/13237)) ([12a5919](https://github.com/nextcloud/mail/commit/12a5919db8f44dcda2dc754a8b940fc8075ac371))
* **deps:** bump address-rfc2822 from ^2.2.3 to ^2.2.4 ([#13042](https://github.com/nextcloud/mail/issues/13042)) ([e6f4e54](https://github.com/nextcloud/mail/commit/e6f4e543494506c94391b38f028ff00560dbeea5))
* **deps:** bump color-convert from ^2.0.1 to v3 ([cafd6ba](https://github.com/nextcloud/mail/commit/cafd6bafea53a35e385c4682177f7eb8df98e158))
* **deps:** bump dompurify from ^3.4.11 to v3.4.12 ([#13335](https://github.com/nextcloud/mail/issues/13335)) ([5e2fe71](https://github.com/nextcloud/mail/commit/5e2fe71ffa9d94ebec113079d78eebe281627eaf))
* **deps:** bump dompurify from ^3.4.8 to ^3.4.11 ([#13229](https://github.com/nextcloud/mail/issues/13229)) ([bea9841](https://github.com/nextcloud/mail/commit/bea98416790d07f411a938622fb72702f8bcb544))
* **deps:** bump dompurify from ^3.4.8 to v3.4.11 ([#13122](https://github.com/nextcloud/mail/issues/13122)) ([41eaf65](https://github.com/nextcloud/mail/commit/41eaf65f8f486326dfe636a481b499efccaefb2f))
* **deps:** bump html-to-text from ^9.0.5 to v10 ([f88a29f](https://github.com/nextcloud/mail/commit/f88a29fd1c2598d7685229d5e3055b0b7703f108))
* **deps:** bump js-base64 from ^3.7.8 to ^3.8.0 ([#13239](https://github.com/nextcloud/mail/issues/13239)) ([3172b34](https://github.com/nextcloud/mail/commit/3172b34a0eaa5557bcb0a66ffcaacab461bce1b5))
* **deps:** bump p-limit from ^6.2.0 to v7 ([86621a1](https://github.com/nextcloud/mail/commit/86621a148eb4b719bc68b061e4e655a481d0f242))
* **deps:** bump sabberworm/php-css-parser from ^9.3.0 to ^9.4.0 ([#13240](https://github.com/nextcloud/mail/issues/13240)) ([78b4966](https://github.com/nextcloud/mail/commit/78b49662074b46816b2cc66894a707baf3333431))
* **deps:** bump stylelint from ^17.9.1 to ^17.14.0 ([#13241](https://github.com/nextcloud/mail/issues/13241)) ([9d2803b](https://github.com/nextcloud/mail/commit/9d2803b80b18f6cc69c25fcf367f1f8c01a4a19b))
* **deps:** bump uuid from ^14.0.0 to ^14.0.1 ([#13230](https://github.com/nextcloud/mail/issues/13230)) ([94eb990](https://github.com/nextcloud/mail/commit/94eb9904afd968ea5811779859243f896b171c79))
* **deps:** Fix npm audit ([dbf837c](https://github.com/nextcloud/mail/commit/dbf837c80b953ef68528eca30772b7dd0cf35bd4))
* **deps:** Fix npm audit ([fd644ef](https://github.com/nextcloud/mail/commit/fd644ef6efc60653651e80384cbebd8865e02067))
* **dns:** Update public suffix list ([a49706f](https://github.com/nextcloud/mail/commit/a49706f485a89eb7794684a6ffd1961251d2f340))
* **dns:** Update public suffix list ([a33969f](https://github.com/nextcloud/mail/commit/a33969ffe1735c192eee341631173d3c65936534))
* **drafts:** preserve Bcc header when saving drafts ([6e98d88](https://github.com/nextcloud/mail/commit/6e98d88aa5e30a7df1a1ee006e5ee8a493dfefc0))
* **envelope:** show full summary on hover and refine AI notice ([2c27d7b](https://github.com/nextcloud/mail/commit/2c27d7b348bc856eb747236bc0044f244abdee23))
* Exclude shared mailboxes from special mailbox auto-detection ([54dda27](https://github.com/nextcloud/mail/commit/54dda275692faf07381aaa0cb071a448b3bcbe8a))
* fixed "ORGANIZER" in ICS generated by "Reply with meeting" and delivered to DAV endpoint ([13ef350](https://github.com/nextcloud/mail/commit/13ef35005c9599afe478ee5cd2f66973ab21bce2))
* hide "create task" option when no task calendar is available ([4cac1b8](https://github.com/nextcloud/mail/commit/4cac1b861a0a8e62d81d70d8494c89bc3ab95daa))
* **imap:** rate limit all IMAP server auth rejections ([99d9842](https://github.com/nextcloud/mail/commit/99d9842b0eebb795dc3c39257a7ea20dc95b21a6))
* **imap:** render inline images referenced only by Content-ID ([0b35738](https://github.com/nextcloud/mail/commit/0b35738e8620d66707ceb8d49c060b1530e98717))
* interactions in actions menu for mailboxes ([cf3350e](https://github.com/nextcloud/mail/commit/cf3350ee0ea3a23a6bbafc5efb5a9bed2d1043fa))
* **l10n:** Update translations from Transifex ([bf70f13](https://github.com/nextcloud/mail/commit/bf70f13edd9b2c05fd8d0ba00288fae0ce584bef))
* **l10n:** Update translations from Transifex ([93cfe2e](https://github.com/nextcloud/mail/commit/93cfe2e3526a853db1b28ee91d23938a279f697e))
* **l10n:** Update translations from Transifex ([2501bbf](https://github.com/nextcloud/mail/commit/2501bbfbda9e66c18d235dc9e1ad5974a405aefa))
* **l10n:** Update translations from Transifex ([da344a0](https://github.com/nextcloud/mail/commit/da344a0e2b9202b403bfc8075107cb275babaff0))
* **l10n:** Update translations from Transifex ([e50eedf](https://github.com/nextcloud/mail/commit/e50eedf20f48f3ca52b2878ddae645070a79650b))
* **l10n:** Update translations from Transifex ([1e1dd96](https://github.com/nextcloud/mail/commit/1e1dd96baba3c4524e2020b1473c78f4c841acab))
* **l10n:** Update translations from Transifex ([979e6a9](https://github.com/nextcloud/mail/commit/979e6a9d0b9e3abd93aede88dfd4d9d852b9610d))
* **l10n:** Update translations from Transifex ([4f229df](https://github.com/nextcloud/mail/commit/4f229df64c323f1f75efec9077d5083f8e461201))
* **l10n:** Update translations from Transifex ([d64ec2a](https://github.com/nextcloud/mail/commit/d64ec2a98886bdbb3fbaa0c81be71607f6d7365f))
* **l10n:** Update translations from Transifex ([4742cb1](https://github.com/nextcloud/mail/commit/4742cb11a73b5d6c8cef812be466c145c1bcb64b))
* **l10n:** Update translations from Transifex ([fc2c216](https://github.com/nextcloud/mail/commit/fc2c2163cee3aa3e3e3094328a97f0b2bdf2566b))
* **l10n:** Update translations from Transifex ([b017f4f](https://github.com/nextcloud/mail/commit/b017f4f7e1a7cf5d75d4d6d9e3c8fc894c335fc9))
* **l10n:** Update translations from Transifex ([96ac3ed](https://github.com/nextcloud/mail/commit/96ac3ed6962f48defcc1344ad132a28a2b7aa0fb))
* **l10n:** Update translations from Transifex ([97d2bc6](https://github.com/nextcloud/mail/commit/97d2bc6532cc97475c1e8b2bea50ceb71ace217f))
* **l10n:** Update translations from Transifex ([0241d3b](https://github.com/nextcloud/mail/commit/0241d3b0513f5d0fc4250d8e826ac49c04a216ce))
* **l10n:** Update translations from Transifex ([4662e6f](https://github.com/nextcloud/mail/commit/4662e6f65784eb60d52109bf9a11514dbe8001dd))
* **l10n:** Update translations from Transifex ([b4b5e03](https://github.com/nextcloud/mail/commit/b4b5e033d03ecc4230997dad0dc57a2a733e8a08))
* **l10n:** Update translations from Transifex ([b0a7e00](https://github.com/nextcloud/mail/commit/b0a7e005206e47b13233f92a2e0d319f0bcc03ce))
* **l10n:** Update translations from Transifex ([5ed4a0a](https://github.com/nextcloud/mail/commit/5ed4a0a687af961936d2edfac015efd94e4597b4))
* **l10n:** Update translations from Transifex ([d87b546](https://github.com/nextcloud/mail/commit/d87b546c6c29dd8290d56e860168a605216d622f))
* **l10n:** Update translations from Transifex ([f1c577b](https://github.com/nextcloud/mail/commit/f1c577bdd3f3a779267cc09ea1c34d21ad423ab1))
* **l10n:** Update translations from Transifex ([6043365](https://github.com/nextcloud/mail/commit/60433655ac772a8d89a64fbe12cb9d1d200aa239))
* **l10n:** Update translations from Transifex ([3f45fe0](https://github.com/nextcloud/mail/commit/3f45fe0bea65f2b960d4398fe0cac2629e4d04fc))
* **l10n:** Update translations from Transifex ([8868534](https://github.com/nextcloud/mail/commit/8868534ad2dacdf02189abd4d7e15b487cfa1697))
* **l10n:** Update translations from Transifex ([ab5268b](https://github.com/nextcloud/mail/commit/ab5268b5dd527d924c4871e3b926312760f3c514))
* **l10n:** Update translations from Transifex ([a0c1a95](https://github.com/nextcloud/mail/commit/a0c1a9522692a75b20126a05b0d95a5d0fe34879))
* **l10n:** Update translations from Transifex ([19cb9ff](https://github.com/nextcloud/mail/commit/19cb9ffeb12558f1c9289d25f92fa17063eeb8bc))
* moved "Delete thread" at the end of the contextual actions menu ([358fdf8](https://github.com/nextcloud/mail/commit/358fdf87e0377bbe536aae626bd682d769b858de))
* **oauth:** generate state token server-side before redirect ([c2ed79f](https://github.com/nextcloud/mail/commit/c2ed79f87fd8508c868c4547d43dc78179b40e39))
* Omit fileid for attachments ([c8e3de3](https://github.com/nextcloud/mail/commit/c8e3de38b1f3960588e70cdeef9ddf8cb1ccac0b))
* only pin favorites when it s not part of the query ([726601c](https://github.com/nextcloud/mail/commit/726601c73fbba2c71c80b67899f84ad8251f194a))
* **outbox:** reset status and failure flag on message update ([91fb1cc](https://github.com/nextcloud/mail/commit/91fb1cc0704abb2b02e4a5f9363582ba182ae934))
* **psalm:** adapt to updated OCP dev-master return types ([67d20f2](https://github.com/nextcloud/mail/commit/67d20f263f0ebd63f32e2ccca1975ba5718c6b0a))
* reply to own message addresses original recipient ([42eb49a](https://github.com/nextcloud/mail/commit/42eb49addb664bf4c9c2739f36e0446afb3911f4))
* reply to sender only ([45766ae](https://github.com/nextcloud/mail/commit/45766aef5136e9a734aa47ce5805ad15985ada57))
* resolve strict type issues flagged by Psalm 6 ([f86e2b8](https://github.com/nextcloud/mail/commit/f86e2b8091b82a01cefd9c1688e653604115e9c3)), closes [#11224](https://github.com/nextcloud/mail/issues/11224)
* restore sender copy-to-clipboard and fix thread subject alignment ([b0420e3](https://github.com/nextcloud/mail/commit/b0420e335f9c4a5be0a711c59c42d73ca648ef72)), closes [#12952](https://github.com/nextcloud/mail/issues/12952) [#12946](https://github.com/nextcloud/mail/issues/12946) [#12666](https://github.com/nextcloud/mail/issues/12666)
* search shortcut buttons having thier own space ([092567d](https://github.com/nextcloud/mail/commit/092567d6a639d0f0b7e1c86aa3a68f07ad160801))
* **sending:** preserve Bcc header in Sent mailbox copy ([d5540c2](https://github.com/nextcloud/mail/commit/d5540c255e7873cd317ca78f49c31b343f6fb23c))
* shortcut search buttons ([fabbf17](https://github.com/nextcloud/mail/commit/fabbf1770e169170190bf0b3071aa58770c12716))
* signature editor on mobile, enlarged menu for formatting options ([62aaa2d](https://github.com/nextcloud/mail/commit/62aaa2d226716934724e4c63f7fa73b7968e0775))
* small fix on the state of the action button to edit tags ([7610aa1](https://github.com/nextcloud/mail/commit/7610aa17a7cd8e6fea302190c22a9e63ef8d4e93))
* sorting of items in "Mail settings" dialog ([7cfbeaf](https://github.com/nextcloud/mail/commit/7cfbeafb0f2269d08bb5994d80e906a9d898414d))
* subfolder selection for quick actions ([f8dedb1](https://github.com/nextcloud/mail/commit/f8dedb197e67faa650ef896efa0d0981a22a3f52))
* **tags:** add accessible title to tag modal ([0a6eb9d](https://github.com/nextcloud/mail/commit/0a6eb9da79c0960dd867fc0c838c654b9ca1d7b3))
* **ui:** archive shortcut in unified mailboxes ([933a6da](https://github.com/nextcloud/mail/commit/933a6da3161b1928a9c9cc8009bd8a79110f6243))
* **ui:** build valid search query when toggling favorites sort ([569dfa4](https://github.com/nextcloud/mail/commit/569dfa45c41af476a5ffa8828ab527b94f967d14))
* **ui:** do not mount favorites list when sorting is off ([130e21f](https://github.com/nextcloud/mail/commit/130e21f7f124e136e230f9f613c2d86fce025132))
* **ui:** harden error handling for AI summaries ([a2bd5c4](https://github.com/nextcloud/mail/commit/a2bd5c43e395a57da7d058773d12c45abaebe45c))
* **ui:** improve quick actions modal design ([63d08c1](https://github.com/nextcloud/mail/commit/63d08c1ff86fc7f9050e54341eccbb43c44f7a8d))
* **ui:** rename beforeUnmount hooks back to beforeDestroy ([6ba42aa](https://github.com/nextcloud/mail/commit/6ba42aa9c3334a543977a0a16a5afd8955a1d29d)), closes [#13031](https://github.com/nextcloud/mail/issues/13031)
* **ui:** restore folder expand state after drag-and-drop ([de027b8](https://github.com/nextcloud/mail/commit/de027b8d00ce86f80f20a17e39028b58fd8dd388))
* **ui:** restore message loading position and slow hint ([a01b2f1](https://github.com/nextcloud/mail/commit/a01b2f1992da2cf2dd984de0f633de6fccb17392))
* **ui:** show favorites section based on the current folder ([72e4342](https://github.com/nextcloud/mail/commit/72e434212b9e6b94bc3a7892e3616e07c7b30335))
* **ui:** unset error state after account setting update ([9231abe](https://github.com/nextcloud/mail/commit/9231abec91dea5fe2b67ca3ae6b06e676567049b))
* validating email addresses from Contacts ([4f33d3f](https://github.com/nextcloud/mail/commit/4f33d3f08191d43d4e17fae63c48b154f7456eca))
* visualization of multiple attachments ([ccb8a65](https://github.com/nextcloud/mail/commit/ccb8a652a4af456f5f08a60d6cbbde1d9f3c3f6f))
* whitespaces in visualization of plaintext email ([9d297bd](https://github.com/nextcloud/mail/commit/9d297bdc2e13a8d2f2ccd9a1c9637aa36b9db96b))


### Features

* Add 'copy direct link' action to message menu ([1cb78a3](https://github.com/nextcloud/mail/commit/1cb78a309eb65ce01a3404f4325b4c3e57e8efd1))
* adds drag, drop and pasting of attachments ([16d4a09](https://github.com/nextcloud/mail/commit/16d4a09889490fa243a8047e2f5b588972c42bc4))
* adds heading shortcuts ([3a6ccd4](https://github.com/nextcloud/mail/commit/3a6ccd486a8ad731b4bca1fcc57ca5377904b907))
* capturing Ctrl+S key on email composer to save draft ([b38b41f](https://github.com/nextcloud/mail/commit/b38b41fa77ecbdd016433545dd32f538c76cb7a9))
* **editor:** preserve arbitrary font sizes and families in content ([cd3b8c5](https://github.com/nextcloud/mail/commit/cd3b8c5d6931867363b87da6e309a2b96fff8fac))
* jmap support - initial ([61bfd97](https://github.com/nextcloud/mail/commit/61bfd975681afa6b4c969028b1f82a11124c9a11))
* save email as .eml file in Files ([81ef139](https://github.com/nextcloud/mail/commit/81ef139b4a89990fa3b94460771b49e861439878))
* unified attachments (as file and as link) from Files ([db12725](https://github.com/nextcloud/mail/commit/db127252cf61dd2b17e807a0a57f888b6282a081))


### Performance Improvements

* caching a bit missing avatars ([b597d42](https://github.com/nextcloud/mail/commit/b597d42a724b61e4e03993e00b3ec6785714a229))
* **frontend:** prevent overlapping background inbox syncs ([7228653](https://github.com/nextcloud/mail/commit/7228653dca84ab71797278b7f0c704f47b0cb1aa))
* reduce multiple ID IMAP commands by Horde client ([c960268](https://github.com/nextcloud/mail/commit/c960268f8b0a1dcabb2f325ebbe48742a0a8b075))
...
* account settings section font size ([2eb0ba8](https://github.com/nextcloud/mail/commit/2eb0ba82b9bb452b10bef698fb18a09c6db4a0ee))
* **AccountSettings:** overflow bug when using autoresponder checkbox ([3343cfd](https://github.com/nextcloud/mail/commit/3343cfdc6211b5ff3624a16f784ddfb6f4339f2b))
* **delegation:** show delegates' display names instead of usernames ([557a51e](https://github.com/nextcloud/mail/commit/557a51e3e945a0c4538caaf0af31f1eacd48750e))
* **l10n:** Update translations from Transifex ([5137bf5](https://github.com/nextcloud/mail/commit/5137bf5fd120cc3ae5b95568faacd516de854973))
* shortcut search buttons ([df91057](https://github.com/nextcloud/mail/commit/df91057374a25577f305af5a1bcf0845ce159606))
* **ui:** harden error handling for AI summaries ([9793f89](https://github.com/nextcloud/mail/commit/9793f8927a7aa4d1be959eaee9c6e545fd1bbf49))
* **ui:** unset error state after account setting update ([e56cd98](https://github.com/nextcloud/mail/commit/e56cd98c34dc759538ff069f5a1fc454889e5951))



# [5.10.0](https://github.com/nextcloud/mail/compare/v5.10.0-rc.1...v5.10.0) (2026-06-18)


### Bug Fixes

* **l10n:** Update translations from Transifex ([f28d17d](https://github.com/nextcloud/mail/commit/f28d17d05a12ec10a8faf2a16a107ca1d9a3051a))
* **psalm:** adapt to updated OCP dev-master return types ([94e2d86](https://github.com/nextcloud/mail/commit/94e2d86e2e467f6dd61bada686906f57624bcd0a))
* caching a bit missing avatars ([019854c](https://github.com/nextcloud/mail/commit/019854c300a5d03fd9f1ac902eb800b8f55c7f4c))
* **frontend:** prevent overlapping background inbox syncs ([#13129](https://github.com/nextcloud/mail/issues/13129)) ([39fd543](https://github.com/nextcloud/mail/commit/39fd543dc6a3ab41a1fed54e97d5691516cc931c))
* reduce multiple ID IMAP commands by Horde client ([64bf799](https://github.com/nextcloud/mail/commit/64bf799620b1d757115452c0ac57f9b8c1453cd8))



# [5.10.0-rc.1](https://github.com/nextcloud/mail/compare/v5.9.0-rc.1...v5.10.0-rc.1) (2026-06-17)


### Bug Fixes

* **delegation:** missing mailbox id in audit log ([57c1d41](https://github.com/nextcloud/mail/commit/57c1d41b60064016f92ad2f79047dcbb8d177e51))
* deleting a message should move the focus one below ([b2bbd4e](https://github.com/nextcloud/mail/commit/b2bbd4e29f13b774bacb963bedc44e4e6c2911a6))
* **deps:** bump @nextcloud/vue from ^8.38.0 to ^8.39.0 ([cb6c2e2](https://github.com/nextcloud/mail/commit/cb6c2e23a72df9e6d5a983174a005ef99e848856))
* **deps:** bump dompurify from ^3.4.2 to ^3.4.7 ([#13043](https://github.com/nextcloud/mail/issues/13043)) ([5845e27](https://github.com/nextcloud/mail/commit/5845e270b21757762b42d01aa5424a5718bdff17))
* **deps:** bump dompurify from ^3.4.8 to v3.4.9 ([3355ac5](https://github.com/nextcloud/mail/commit/3355ac532693504453f5b19d0ef4af38ffc3fc39))
* **deps:** bump vitest from ^3.2.4 to v4 ([5e31000](https://github.com/nextcloud/mail/commit/5e3100021605ff4ba4c47a7e699b09673e6a9c58))
* disable CSRF check for message-id deeplinks ([86a46a9](https://github.com/nextcloud/mail/commit/86a46a9c09c3983db1057151bb3bb30417613a4f))
* **dns:** Update public suffix list ([b45cf9b](https://github.com/nextcloud/mail/commit/b45cf9b63fe21ea152c85e253a2441de6d900759))
* **frontend:** log swallowed errors in catch blocks ([79629b6](https://github.com/nextcloud/mail/commit/79629b60cb1aa755b1361575e7d6f9c63ed3a3af))
* **l10n:** Update translations from Transifex ([b133d88](https://github.com/nextcloud/mail/commit/b133d883fccc016048a1b2a243e4181274a2a17f))
* **l10n:** Update translations from Transifex ([1e9d3e8](https://github.com/nextcloud/mail/commit/1e9d3e829c3d66c54dd4c5e15162b71ea7652779))
* **l10n:** Update translations from Transifex ([35839ac](https://github.com/nextcloud/mail/commit/35839ac152de3e0221497743de668ad3aa44ca05))
* **l10n:** Update translations from Transifex ([f68b723](https://github.com/nextcloud/mail/commit/f68b7238c24c1b9cd6f281a0a241abaed01a51ca))
* **l10n:** Update translations from Transifex ([8f7f7c9](https://github.com/nextcloud/mail/commit/8f7f7c99f967d8a4c8b2f8919f0331bd2fb33656))
* **l10n:** Update translations from Transifex ([4a4104b](https://github.com/nextcloud/mail/commit/4a4104b1d0ac52dfb104c66e8d7b72e74e3aa5dd))
* **l10n:** Update translations from Transifex ([c9ee373](https://github.com/nextcloud/mail/commit/c9ee3732149ae62141e093633bca6c93a50eef1d))
* **l10n:** Update translations from Transifex ([f9f5dde](https://github.com/nextcloud/mail/commit/f9f5dde5be1e759e30cebfe02d5022402c3b1919))
* **l10n:** Update translations from Transifex ([b4764be](https://github.com/nextcloud/mail/commit/b4764bea3d51e2cdcc4915747e3301b66ea3f9cd))
* **l10n:** Update translations from Transifex ([04d1a48](https://github.com/nextcloud/mail/commit/04d1a48007a67902441f8d65e3e133de19a67e2f))
* **l10n:** Update translations from Transifex ([7e4eab6](https://github.com/nextcloud/mail/commit/7e4eab620aa9931d6141b1febab6d512653e5bf9))
* **l10n:** Update translations from Transifex ([809d826](https://github.com/nextcloud/mail/commit/809d826ae9e7b08d289c4ae519a7982459b6464f))
* **l10n:** Update translations from Transifex ([7551ba5](https://github.com/nextcloud/mail/commit/7551ba5e8af95a1019b34386eaac814b1a48774f))
* **l10n:** Update translations from Transifex ([9d67a65](https://github.com/nextcloud/mail/commit/9d67a65f9ed59c6799687feab14236e917c8e9d0))
* mail printing ([47820ad](https://github.com/nextcloud/mail/commit/47820ad24482622c1c9e5593186a76ccd09595a0))
* **smtp:** handle non ascii sender names ([f9803f9](https://github.com/nextcloud/mail/commit/f9803f9fbd043de726b08f1bdc04a7795a8a7f00))
* **ui:** prefer sans-serif over Noto Color Emoji for text rendering ([3473b1d](https://github.com/nextcloud/mail/commit/3473b1dfdb05602ea4baaee0e1a5c6e9c0e0bd75))
* **ui:** prevent type error during shortkey usage ([c9cbc09](https://github.com/nextcloud/mail/commit/c9cbc098a0ea38db1ed2ab87b58a17e9865f3575))
* **ui:** restore isSubscribed getter on mailbox update ([c44f12b](https://github.com/nextcloud/mail/commit/c44f12b2f294d04cac1c73b41b68d6f9ce8e9af1))
* **ui:** sub-mailbox drops blocked by parent cascade ([0e81d91](https://github.com/nextcloud/mail/commit/0e81d91f3b4f2a86a2fa80e08f63907f104978f8))


### Features

* add ai hint on reply with meeting when ai is used ([fe60745](https://github.com/nextcloud/mail/commit/fe607453a5a320e8324e1c81a2c6f353bde4917a))
* **ui:** add password change shortcut to server settings ([ac447f2](https://github.com/nextcloud/mail/commit/ac447f2e6e3acacbaeba28b585046ed253edaa6b))



# [5.9.0-rc.1](https://github.com/nextcloud/mail/compare/v5.9.0-alpha.1...v5.9.0-rc.1) (2026-05-27)


### Bug Fixes

* **api:** validate targetPath is an existing folder on saveAttachment ([0f5d81c](https://github.com/nextcloud/mail/commit/0f5d81cf8ae5994f36d2364088c02834e18bce4e))
* **deps:** Fix npm audit ([45b32cf](https://github.com/nextcloud/mail/commit/45b32cfb49e03a1bff58d6a08155cfacb691acef))
* **dns:** Update public suffix list ([119a96b](https://github.com/nextcloud/mail/commit/119a96bec966268116776044c6866dc547a801ff))
* **l10n:** Update translations from Transifex ([9b6ba58](https://github.com/nextcloud/mail/commit/9b6ba5871b0895c9a15e88131921d4228ee45200))
* **l10n:** Update translations from Transifex ([fba5807](https://github.com/nextcloud/mail/commit/fba580735f9f0b89269b7885adb00a264c4ee397))
* **l10n:** Update translations from Transifex ([b37655d](https://github.com/nextcloud/mail/commit/b37655d8d5fd9ad84f2ddb1ef94b2e60e7488140))
* **l10n:** Update translations from Transifex ([0367a07](https://github.com/nextcloud/mail/commit/0367a07118c904d5522a9047520104145ec7f219))
* **package:** exclude dev config and patch files from release tarball ([6d20e3f](https://github.com/nextcloud/mail/commit/6d20e3f06afb127e5e5f19fca8fd6a810747eb46))
* **ui:** add NcModal name prop to SmimeCertificateModal for accessibility ([525c3ab](https://github.com/nextcloud/mail/commit/525c3ab9d53f19082c137cc0050f4038c54f0b70))
* **ui:** use v-model for assistance setting switches ([9bbae7d](https://github.com/nextcloud/mail/commit/9bbae7d7d55a5e22f0c1f67e1d58f987ffe80233))


### Features

* add notifications for account delegation ([2e1ddae](https://github.com/nextcloud/mail/commit/2e1ddaec2d45636f69a70c338fe5caa7b659ffd2))
* **deps:** Add Nextcloud 35 support ([e3dcc0e](https://github.com/nextcloud/mail/commit/e3dcc0e0ac3b644199abb36def63c6737a89919c))
* **ui:** paste or copy several e-mail addresses into address fields at once ([98f6282](https://github.com/nextcloud/mail/commit/98f6282008460663bd312d66d4398ae01aa7c188))



# [5.9.0-alpha.1](https://github.com/nextcloud/mail/compare/v5.9.0-dev.1...v5.9.0-alpha.1) (2026-05-18)


### Bug Fixes

* **auth:** detect and warn about MS accounts without oauth setup ([836b36a](https://github.com/nextcloud/mail/commit/836b36afa096a89334986653fff2f8a3d3c69b9c))
* correct favorite/unfavorite bulk action logic ([fcb160a](https://github.com/nextcloud/mail/commit/fcb160ac78f58e93df9c2cddcf2189a81b42c876)), closes [#12149](https://github.com/nextcloud/mail/issues/12149)
* **deps:** Fix npm audit ([8df6bdf](https://github.com/nextcloud/mail/commit/8df6bdf5f161345ce4d64b472ff05fa6f1ac79a6))
* **dns:** Update public suffix list ([23d0823](https://github.com/nextcloud/mail/commit/23d0823dd1d930fbaf72b93c089b30c6622e5661))
* **imap:** log number of connections during CLI sync ([d9c240c](https://github.com/nextcloud/mail/commit/d9c240cac5ea17029c8272707614de1ae63a88d1))
* **l10n:** Update translations from Transifex ([7838385](https://github.com/nextcloud/mail/commit/78383856e07df0c2a7ba0bd2f7f8e66b7ddcf69c))
* **l10n:** Update translations from Transifex ([203ce36](https://github.com/nextcloud/mail/commit/203ce3603f6abf3640dbc4856e422162a55e5531))
* **l10n:** Update translations from Transifex ([c6b89ed](https://github.com/nextcloud/mail/commit/c6b89edbcbe08ec9d9e7cadf3aa89d148728a4c2))
* **l10n:** Update translations from Transifex ([8cb01dc](https://github.com/nextcloud/mail/commit/8cb01dc41e437aa9e0aeee6bf9cfe20cefd71b8f))
* **l10n:** Update translations from Transifex ([17d048a](https://github.com/nextcloud/mail/commit/17d048a2deac844415f28d98e7bc5cd7bf3d3a3c))
* **l10n:** Update translations from Transifex ([40cc7c2](https://github.com/nextcloud/mail/commit/40cc7c2469ef49a470cbbe2a9b5b5e9b574f26c7))
* **l10n:** Update translations from Transifex ([af4c704](https://github.com/nextcloud/mail/commit/af4c704e8653a70b56784bb15a3c1a78b377078e))
* **lint:** fix all lint errors introduced by recipient display changes ([f19e780](https://github.com/nextcloud/mail/commit/f19e780abfa5df2a01d4805707deee2c22a03ae0))
* Load translations via filesystem path ([042cc1e](https://github.com/nextcloud/mail/commit/042cc1e468f771018a86c043141f1e61ebea8e17))
* Modal open bug ([5f21187](https://github.com/nextcloud/mail/commit/5f21187f8458322e5be8ae3728cb4d9156eceff3))
* **thread:** address PR review comments ([dcbf341](https://github.com/nextcloud/mail/commit/dcbf3414f3cf4973304aa64156ed6f23fcb1a6d2))
* **thread:** address review feedback on recipient CSS ([478f2f6](https://github.com/nextcloud/mail/commit/478f2f6011ce1dae128de9a7a28fa0b065583322))
* **thread:** collapse recipients by default behind toggle chevron ([13041d9](https://github.com/nextcloud/mail/commit/13041d9f913c8cea46adff73e028cb4a7977a964))
* **thread:** move recipient bubbles outside router-link to fix click handling ([971a59d](https://github.com/nextcloud/mail/commit/971a59dec9534917cb608c90fd27a9adfe992e83))
* **thread:** polish sender/recipients display in thread envelope ([d02a261](https://github.com/nextcloud/mail/commit/d02a2618bfabd715998110c14c4bdfb3aa64b374))
* **thread:** size recipient bubbles to 24px via CSS overrides ([2add2e4](https://github.com/nextcloud/mail/commit/2add2e4f0800570122ffa492ff64a1e06df9a785))
* **ui:** close attachment actions menu after clicking Download or Save to Files ([dade396](https://github.com/nextcloud/mail/commit/dade396308420d2507f75ab7491782572f18c85e))


### Features

* add delegation ([cf3bd8b](https://github.com/nextcloud/mail/commit/cf3bd8bf04307bcc91c28dc98928f171eca1a475))
* add html and source editing support ([0eaad6f](https://github.com/nextcloud/mail/commit/0eaad6fb1f1408d1b17a3a3ceca27583f5b5fac2))
* **Agents.md:** add styling instructions ([5dd4fd1](https://github.com/nextcloud/mail/commit/5dd4fd14cf85b420685a3e4915255d7167a40c03))
* Keep inline images on forwarding ([bcf94f4](https://github.com/nextcloud/mail/commit/bcf94f40267edb19b96a3c1d03297cf28fd1e51b))
* **thread:** match design spec from [#4258](https://github.com/nextcloud/mail/issues/4258) ([14fdd9a](https://github.com/nextcloud/mail/commit/14fdd9ab94d3fee82eff3ca71b4fd644094de49f))
* **thread:** show per-message To/Cc/Bcc recipients in thread view ([332ffef](https://github.com/nextcloud/mail/commit/332ffefd5c42d6b387b00834d0d167b3531c173c)), closes [#11305](https://github.com/nextcloud/mail/issues/11305) [#9311](https://github.com/nextcloud/mail/issues/9311) [#4258](https://github.com/nextcloud/mail/issues/4258)


### Performance Improvements

* **imap:** reuse client connection during initial sync ([c0f3a79](https://github.com/nextcloud/mail/commit/c0f3a79ff0e5a4bf6ef022677bf1417e66be851e))



# [5.9.0-dev.1](https://github.com/nextcloud/mail/compare/v5.8.0-alpha.1...v5.9.0-dev.1) (2026-05-06)


### Bug Fixes

* **l10n:** Update translations from Transifex ([e27a4ad](https://github.com/nextcloud/mail/commit/e27a4addb73ea82d3500844297658ac47447028b))



# [5.8.0-alpha.1](https://github.com/nextcloud/mail/compare/v5.7.0-rc.1...v5.8.0-alpha.1) (2026-05-05)


### Bug Fixes

* **AccountService:** Invalidate cache after account creation/change/deletion ([f205e15](https://github.com/nextcloud/mail/commit/f205e1529b55a5d199589e5e90d758e3019d3b23))
* **account:** use classification state from account ([662eeff](https://github.com/nextcloud/mail/commit/662eeff58c7196b01dfe8ace35a9765bf86ca05d))
* adding smart reply text when reply all ([1c32ab1](https://github.com/nextcloud/mail/commit/1c32ab15920853ad4c81056e1a58e5dd32ba200b))
* **agents.md:** adjust license ([380a961](https://github.com/nextcloud/mail/commit/380a961ff60008270f1df98b071544e68e36643a))
* **ai:** handle invalid JSON and possible null for smart replies ([27e443b](https://github.com/nextcloud/mail/commit/27e443b66369afbdb538cf9e9ce47f259bd1de61))
* **attachementNames:** lower log level ([22a111f](https://github.com/nextcloud/mail/commit/22a111fd5051421279fd7237daac903e557a2293))
* **attachements:** unify icons with the rest of nextcloud ([ea58f99](https://github.com/nextcloud/mail/commit/ea58f9963bd620e62e52ab9c78ecb20e8409d0f0))
* **autocomplete:** respect privacy settings for sharing ([b7e6088](https://github.com/nextcloud/mail/commit/b7e608827e355c416069f3a3b6a306aee6d113f4))
* Avoid undefined array key for address list ([f3497f8](https://github.com/nextcloud/mail/commit/f3497f824df3781400bb5ceb6ae4c40fddf03501))
* Broken encryption with Mailvelope ([4b543b4](https://github.com/nextcloud/mail/commit/4b543b4719341f2e0cf0f01b325e88c37e138c51))
* **cache:** expire the IMAP ratelimit keys via TTL ([f1ac885](https://github.com/nextcloud/mail/commit/f1ac8858927a560df03fc76e4950d8e24896219e))
* **ckeditor:** Better matching for CKEditor translations ([990f94a](https://github.com/nextcloud/mail/commit/990f94ad09d646c27de6a3ed33c062b4d9f7ecc9))
* clean text blocks on user deletion ([93b07d4](https://github.com/nextcloud/mail/commit/93b07d4c45cdaa2377d407d8b7944b0b321183d6))
* compact view UI fixes ([d8cec2c](https://github.com/nextcloud/mail/commit/d8cec2c744fbf94fb4e255c9da229a0fd5c4f120))
* **composer:** Adjust border color of vertical separator to be in line with other borders ([71d88f2](https://github.com/nextcloud/mail/commit/71d88f2c0b8b3d30bf60f84d7ed3db9862eff440))
* **composer:** Adjust border colors of CKEditor element to be in line with other borders ([496b8f6](https://github.com/nextcloud/mail/commit/496b8f654953ef51ef2906165da55a6c32f59291))
* **composer:** Don't show 'No results' dropdown when To/Cc/Bcc focused, only with search term put in ([6e78828](https://github.com/nextcloud/mail/commit/6e788289f2ab89dfe2191d377e477aa9f6e4bffb))
* **composer:** Forwarding emails with attachments ([4dd6a0e](https://github.com/nextcloud/mail/commit/4dd6a0e766831ea1b91b01c2fc71335fb0e85705))
* **composer:** handle missing message body gracefully ([1d40201](https://github.com/nextcloud/mail/commit/1d402012a443e7fd343f9412f511208fc2f1ca43))
* **Composer:** make initial focus be on to field ([010f648](https://github.com/nextcloud/mail/commit/010f6485bad8fa9c2ad95616ba1b6d5ac5ad4f70))
* **composer:** Use v-model for send later radio buttons ([bb99cfa](https://github.com/nextcloud/mail/commit/bb99cfa7404a08e80a543813c7d6511127bdf1b6))
* **contactsIntegration:** avoid incorrect cache results ([ae4af81](https://github.com/nextcloud/mail/commit/ae4af81430e0cf0de04b771a20ef910bd01ab93c))
* **contacts:** Use correct default for shareapi_allow_share_dialog_user_enumeration ([2e8ed36](https://github.com/nextcloud/mail/commit/2e8ed36f10f5f01c8ff3a26a4ac8949a4b4a2e6d))
* Copilot suggestions ([3c7341f](https://github.com/nextcloud/mail/commit/3c7341f44b1760126846881586e16e168b9aed09))
* **db:** add missing messages table index for Postgres ([747cf7d](https://github.com/nextcloud/mail/commit/747cf7dd6a7414a7e19b78fa4377ec9fd5789d6a))
* **db:** refactor delete by alias to separate queries ([8f3fcd4](https://github.com/nextcloud/mail/commit/8f3fcd4f611770ebbf5bd485efa2236afbb54d35))
* **db:** widen recipients table index for email+type+message_id ([19514ac](https://github.com/nextcloud/mail/commit/19514ac550a18741aef7dd8d8b15ef62c48d78ae))
* **deps:** bump @iframe-resizer/child from 5.5.7 to ^5.5.8-beta.2 ([#12350](https://github.com/nextcloud/mail/issues/12350)) ([396b3ea](https://github.com/nextcloud/mail/commit/396b3eae4a32686f247c9bdf513f9d7dd88f10b1))
* **deps:** bump @iframe-resizer/child from 5.5.8 to ^5.5.8 ([#12377](https://github.com/nextcloud/mail/issues/12377)) ([7618a40](https://github.com/nextcloud/mail/commit/7618a40010869c826346ae76b0ee4e57fdc57ddc))
* **deps:** bump @iframe-resizer/child from 5.5.8 to ^5.5.9 ([#12444](https://github.com/nextcloud/mail/issues/12444)) ([912105c](https://github.com/nextcloud/mail/commit/912105cc5f3b311e41ab6b82fe170a3583be464c))
* **deps:** bump @iframe-resizer/parent from 5.5.7 to ^5.5.8-beta.2 ([#12351](https://github.com/nextcloud/mail/issues/12351)) ([26ed10a](https://github.com/nextcloud/mail/commit/26ed10a41f56da1c860ab0260576fa320b821af7))
* **deps:** bump @iframe-resizer/parent from 5.5.8 to ^5.5.8 ([#12389](https://github.com/nextcloud/mail/issues/12389)) ([0c6b4d1](https://github.com/nextcloud/mail/commit/0c6b4d13984810824eba8538f75800c776224cad))
* **deps:** bump @iframe-resizer/parent from 5.5.9 to ^5.5.9 ([#12478](https://github.com/nextcloud/mail/issues/12478)) ([29cfec6](https://github.com/nextcloud/mail/commit/29cfec6cefdb1ca99391ca1c0e15d53bdb841d4f))
* **deps:** bump @nextcloud/auth from 2.5.3 to ^2.6.0 ([#12758](https://github.com/nextcloud/mail/issues/12758)) ([789eb32](https://github.com/nextcloud/mail/commit/789eb321875d9bd9ca42012c3e2a9681f0091eb0))
* **deps:** bump @nextcloud/axios from 2.5.2 to ^2.6.0 ([#12837](https://github.com/nextcloud/mail/issues/12837)) ([3b9474c](https://github.com/nextcloud/mail/commit/3b9474ccb57296ec12ef30de8c5089116dc904ee))
* **deps:** bump @nextcloud/calendar-js from 8.1.4 to ^8.1.6 ([889e313](https://github.com/nextcloud/mail/commit/889e31327bcec9de65c1121b6b1c216a3a45d47a))
* **deps:** bump @nextcloud/cdav-library from 2.1.1 to ^2.2.0 ([#12759](https://github.com/nextcloud/mail/issues/12759)) ([41d27cc](https://github.com/nextcloud/mail/commit/41d27cc6755cea0a501621051d25b5c32295c978))
* **deps:** bump @nextcloud/sharing from 0.3.0 to ^0.4.0 ([efab69f](https://github.com/nextcloud/mail/commit/efab69fe258db00c1c7a3c191761fdb9a3e6f2a6))
* **deps:** bump @nextcloud/timezones from 0.2.0 to v1 ([6eb78b9](https://github.com/nextcloud/mail/commit/6eb78b992297a72e9862367304b95facc9ffe368))
* **deps:** bump @nextcloud/vue from 8.36.0 to ^8.36.0 ([d68bbc6](https://github.com/nextcloud/mail/commit/d68bbc69e069dc9767970ce00e127046b6e1e229))
* **deps:** bump @nextcloud/vue from 8.37.0 to ^8.37.0 ([fdd6478](https://github.com/nextcloud/mail/commit/fdd6478797e818ace28eb2c2a88c5615d081c9d8))
* **deps:** bump @nextcloud/vue from 8.38.0 to ^8.38.0 ([c142309](https://github.com/nextcloud/mail/commit/c142309f43496b6fe1a95da34baf355c3a91d94e))
* **deps:** bump bamarni/composer-bin-plugin from 1.8.3 to ^1.9.1 ([#12847](https://github.com/nextcloud/mail/issues/12847)) ([cc683c1](https://github.com/nextcloud/mail/commit/cc683c181c76bd66cdfce3cdc7b9be1024cca9bb))
* **deps:** bump bytestream/horde-imap-client from 2.33.6 to ^2.33.7 ([#12627](https://github.com/nextcloud/mail/issues/12627)) ([06fd337](https://github.com/nextcloud/mail/commit/06fd3372f0095de252f02f2c55664418699e12b7))
* **deps:** bump bytestream/horde-imap-client from 2.33.7 to ^2.34.0 ([#12675](https://github.com/nextcloud/mail/issues/12675)) ([56e76df](https://github.com/nextcloud/mail/commit/56e76df878f2469128d8daf99e10a0a37d07b3eb))
* **deps:** bump bytestream/horde-imap-client from 2.34.0 to ^2.34.1 ([#12798](https://github.com/nextcloud/mail/issues/12798)) ([834a0a6](https://github.com/nextcloud/mail/commit/834a0a65330b86a0a7030628b5c66e5530cc1df5))
* **deps:** bump bytestream/horde-mime from 2.14.0 to ^2.14.1 ([87d83e8](https://github.com/nextcloud/mail/commit/87d83e897243e9c09731b116f72748551c790e0a))
* **deps:** bump ckeditor from v45 to v46 ([6884f5b](https://github.com/nextcloud/mail/commit/6884f5b2512ed91c0d74cda8f4031da8c44156dc))
* **deps:** bump ckeditor5 from 46.1.1 to v47 ([e6fc646](https://github.com/nextcloud/mail/commit/e6fc6467b48ff721a03d1666fc8afd48d90093bc))
* **deps:** bump ckeditor5 from 47.6.1 to ^47.6.1 ([#12704](https://github.com/nextcloud/mail/issues/12704)) ([682ad03](https://github.com/nextcloud/mail/commit/682ad03814433a1ae2564a8373fda5b0d72179a1))
* **deps:** bump ckeditor5 from 47.6.2 to ^47.6.2-alpha.0 ([#12730](https://github.com/nextcloud/mail/issues/12730)) ([cc00d75](https://github.com/nextcloud/mail/commit/cc00d75505b639c704e98633582b332eb317e18a))
* **deps:** bump core-js from 3.48.0 to ^3.49.0 ([#12760](https://github.com/nextcloud/mail/issues/12760)) ([660f2ff](https://github.com/nextcloud/mail/commit/660f2fffac7aaaf957f26cae01838e6de4221fc1))
* **deps:** bump dompurify from 3.3.1 to v3.3.2 ([#12521](https://github.com/nextcloud/mail/issues/12521)) ([68d4a79](https://github.com/nextcloud/mail/commit/68d4a799b84b27822cbca1fb1f0bd3a1ab5825ef))
* **deps:** bump dompurify from 3.3.2 to ^3.3.3 ([#12653](https://github.com/nextcloud/mail/issues/12653)) ([1316686](https://github.com/nextcloud/mail/commit/1316686d5ac9aaa9437052f9660a2e765ccf2e5e))
* **deps:** bump dompurify from 3.3.3 to v3.4.0 ([#12744](https://github.com/nextcloud/mail/issues/12744)) ([8a96e08](https://github.com/nextcloud/mail/commit/8a96e082cf4edc459350027a4628cd78135c66c1))
* **deps:** bump dompurify from 3.4.0 to ^3.4.0 ([#12761](https://github.com/nextcloud/mail/issues/12761)) ([675d538](https://github.com/nextcloud/mail/commit/675d538a37c295ebf0020ccfeeff445f9a83b3f5))
* **deps:** bump dompurify from 3.4.1 to ^3.4.1 ([#12827](https://github.com/nextcloud/mail/issues/12827)) ([3c9adc6](https://github.com/nextcloud/mail/commit/3c9adc6aa80c7efa148c669a4153e41dc0ae731a))
* **deps:** bump dompurify from 3.4.1 to ^3.4.2 ([#12869](https://github.com/nextcloud/mail/issues/12869)) ([cf0f574](https://github.com/nextcloud/mail/commit/cf0f57409ada028d741c187db8391084a67bd5f1))
* **deps:** bump flatted from 3.3.3 to 3.4.2 ([#12659](https://github.com/nextcloud/mail/issues/12659)) ([ff40a35](https://github.com/nextcloud/mail/commit/ff40a35d4c9398e09e1f9cc2f113071b0d0d903c))
* **deps:** bump lodash from 4.17.23 to v4.18.1 ([#12693](https://github.com/nextcloud/mail/issues/12693)) ([3d45186](https://github.com/nextcloud/mail/commit/3d451865b93ad3742dd76f4bd6f86cc5d0d8f6e4))
* **deps:** bump lodash from 4.18.1 to ^4.18.1 ([#12731](https://github.com/nextcloud/mail/issues/12731)) ([679effc](https://github.com/nextcloud/mail/commit/679effcb68a12bdb79d762afea51f9e21c905c04))
* **deps:** bump node-forge from 1.3.3 to v1.4.0 ([#12663](https://github.com/nextcloud/mail/issues/12663)) ([fb5b0e6](https://github.com/nextcloud/mail/commit/fb5b0e602a1e2b265af862123cb254e6b7566b3f))
* **deps:** bump node-forge from 1.4.0 to ^1.4.0 ([#12752](https://github.com/nextcloud/mail/issues/12752)) ([3330a0b](https://github.com/nextcloud/mail/commit/3330a0b45939edf348715741207f9929c2e753d5))
* **deps:** bump rollup from 4.52.4 to 4.60.0 ([#12658](https://github.com/nextcloud/mail/issues/12658)) ([dfd6a36](https://github.com/nextcloud/mail/commit/dfd6a36b2277ec31d865fb7a5fca6e818dc7923f))
* **deps:** bump sabberworm/php-css-parser from 8.9.0 to v9 ([d32bef1](https://github.com/nextcloud/mail/commit/d32bef15e529e6ba89cc594ad50f243749224e42))
* **deps:** bump stylelint from 17.9.1 to ^17.8.0 ([#12851](https://github.com/nextcloud/mail/issues/12851)) ([dceef09](https://github.com/nextcloud/mail/commit/dceef09db387cc6daa55e51f5a0dd9c89a1b85a7))
* **deps:** bump stylelint from 17.9.1 to ^17.9.1 ([#12870](https://github.com/nextcloud/mail/issues/12870)) ([0685aa5](https://github.com/nextcloud/mail/commit/0685aa5324cb671034e653ae482c11fab00d7b52))
* **deps:** bump uuid from 11.1.0 to v14 ([6e98a10](https://github.com/nextcloud/mail/commit/6e98a10c7d15067b285895f4a1ae995a0503279a))
* **deps:** Fix npm audit ([0c92bdb](https://github.com/nextcloud/mail/commit/0c92bdb20aa8e0a2c656f682bf4fdc348acfbcaf))
* **deps:** Fix npm audit ([38e8a60](https://github.com/nextcloud/mail/commit/38e8a6059f31f16ce569bb89e2a9d80acd47e9f9))
* **deps:** Fix npm audit ([3809bc3](https://github.com/nextcloud/mail/commit/3809bc35bfb9c3ad6d1fcc6077fb68d400fe89b1))
* **deps:** Fix npm audit ([3bab2ea](https://github.com/nextcloud/mail/commit/3bab2eaa703c93e0370b37ece6cb042844efdd73))
* **deps:** Update symfony/process to fix MSYS2 argument escaping vulnerability ([e1e288f](https://github.com/nextcloud/mail/commit/e1e288fb8427e2b3108f888fe869b0a07029c93e))
* **deps:** update webpack-cli to v6 ([3b43ed9](https://github.com/nextcloud/mail/commit/3b43ed90afba2e6c541e2f0d67403c8f494cfa33))
* **dns:** Update public suffix list ([7efd7f3](https://github.com/nextcloud/mail/commit/7efd7f39ca23deb268ab6918e31be047b9fe3b9e))
* **dns:** Update public suffix list ([064b615](https://github.com/nextcloud/mail/commit/064b615d6ae879e57231fb115492e54f2a46e42d))
* **dns:** Update public suffix list ([3e660c7](https://github.com/nextcloud/mail/commit/3e660c71ebbf740842038317c75263aca2ec75f9))
* **dns:** Update public suffix list ([c46c0c0](https://github.com/nextcloud/mail/commit/c46c0c0eeae2bf9b09fbed0472ffa07b2e7811ce))
* **dns:** Update public suffix list ([23d0ebf](https://github.com/nextcloud/mail/commit/23d0ebfc7ea82906b1647455fde6748e6e26999f))
* **dns:** Update public suffix list ([c583ad5](https://github.com/nextcloud/mail/commit/c583ad5159a4de8a634d7f7da8516e1c3f17a96e))
* Dont hijack mailto links ([3c025c9](https://github.com/nextcloud/mail/commit/3c025c94f6989364311a48f6f5aa1ebc45506ee9))
* **drag-and-drop:** track all droppable-mailbox directive instances independently ([6729ad8](https://github.com/nextcloud/mail/commit/6729ad88d7e3c8d0a942e641b208f3398a0ebb09))
* Fix deprecation warnings when using PHP >= 8.5 ([6f33f46](https://github.com/nextcloud/mail/commit/6f33f4673fbd3f12e519db8caaf3889d816ea996))
* Handle SmimeDecryptException when getting attachments ([4e7e9e0](https://github.com/nextcloud/mail/commit/4e7e9e03cd40d06ea912b1ce215f09fe8fd47c18))
* **http:** guard against more null users in controllers ([50cef92](https://github.com/nextcloud/mail/commit/50cef92ce36849d55a83f9c2c25d16a5cce0fbb0))
* **http:** guard against null user in MailboxesController ([a602571](https://github.com/nextcloud/mail/commit/a60257198725ab372baa74e9e42630550a9378a6))
* **http:** guard against null user in MessagesController ([3f6cad9](https://github.com/nextcloud/mail/commit/3f6cad922120259cc9039ef4697f26550028b5a8))
* **http:** prevent NPE by non-null controller parameters ([8ab9849](https://github.com/nextcloud/mail/commit/8ab9849f929f38b2e8ca2bfc041e13d99b9bb9a7))
* Ignore attachments without a name ([caba948](https://github.com/nextcloud/mail/commit/caba948c62f21f5dbf3eb0673e8331e5813faadd))
* **imap:** avoid expanding UID ranges ([8af9849](https://github.com/nextcloud/mail/commit/8af9849d362260d03a7a68de928fef73b0f84017))
* **IMAP:** don't add whitespaces to drafts ([d8b4a85](https://github.com/nextcloud/mail/commit/d8b4a859e7784b80906fc3e3686a8d5415128576))
* **imap:** Handle unselectable mailboxe ([86d5fee](https://github.com/nextcloud/mail/commit/86d5feef879187f473df613490c0e10126e8137b))
* **imap:** log details of the sync to debug OOMs ([432ec82](https://github.com/nextcloud/mail/commit/432ec829f94d0bf11214191c8b1f0ad9e4897851))
* **imap:** log more sync details ([b9ff2d0](https://github.com/nextcloud/mail/commit/b9ff2d03bd1356e32c7cf7f1d02fca22b7cd0199))
* **imap:** log partial sync criteria ([88eccd0](https://github.com/nextcloud/mail/commit/88eccd09404da76485e1284375f257b2bf57f965))
* **imap:** prevent null HIGHESTMODSEQ after initial sync ([7980d9e](https://github.com/nextcloud/mail/commit/7980d9e4015c894c4c5a7215546e7c61f5abe1c3))
* Invalid cache lookup for emails without attachment ([a76426e](https://github.com/nextcloud/mail/commit/a76426e2fb37bb315850e690f979955aaa39d3c5))
* **js:** reset envelope lists to object, not array ([5d96714](https://github.com/nextcloud/mail/commit/5d967141f8cacc8a138f14ca23a7a13346039072))
* Keep raw message on smtp/mime failure ([58c860e](https://github.com/nextcloud/mail/commit/58c860ed4a6e1b357028c50828a27347addccde7))
* **l10n:** Update translations from Transifex ([64f21c6](https://github.com/nextcloud/mail/commit/64f21c6065987059fcd23f4d049eee318988a4f5))
* **l10n:** Update translations from Transifex ([0c3ccf1](https://github.com/nextcloud/mail/commit/0c3ccf171784d88bfffabdfc2b74b9a5832fe730))
* **l10n:** Update translations from Transifex ([b07f5a9](https://github.com/nextcloud/mail/commit/b07f5a9912795352155a9a3db07b52de7c692bd4))
* **l10n:** Update translations from Transifex ([929b01c](https://github.com/nextcloud/mail/commit/929b01c6841913040f9ddd0c8d85d7dea1cf53e7))
* **l10n:** Update translations from Transifex ([9d799da](https://github.com/nextcloud/mail/commit/9d799da288e845db089d69fc714f12d2d75c8fcc))
* **l10n:** Update translations from Transifex ([0fc8509](https://github.com/nextcloud/mail/commit/0fc85095b70bff9334edcba38641cbf17deb7f7a))
* **l10n:** Update translations from Transifex ([41b55e1](https://github.com/nextcloud/mail/commit/41b55e17969ce101b6ec8489ef4924a82cffd4a8))
* **l10n:** Update translations from Transifex ([ca874d6](https://github.com/nextcloud/mail/commit/ca874d68a5964c7177506341865bb69d2387a4d3))
* **l10n:** Update translations from Transifex ([361fcf7](https://github.com/nextcloud/mail/commit/361fcf755babcd8c25c65aa3eff6fa333e44f2b1))
* **l10n:** Update translations from Transifex ([331d67a](https://github.com/nextcloud/mail/commit/331d67a1a288418a2bf70c23980e050682f4e733))
* **l10n:** Update translations from Transifex ([1335815](https://github.com/nextcloud/mail/commit/1335815a1de24f9f4494d0f8f75991f9c852e372))
* **l10n:** Update translations from Transifex ([31fe982](https://github.com/nextcloud/mail/commit/31fe982bce3533a2feaecce0f255aa2de7bf21b7))
* **l10n:** Update translations from Transifex ([7b57369](https://github.com/nextcloud/mail/commit/7b57369afb7f3bda596ea0e90eaf995f43490f78))
* **l10n:** Update translations from Transifex ([1e74c52](https://github.com/nextcloud/mail/commit/1e74c520a61df0854d05396a8fa803daa20b5362))
* **l10n:** Update translations from Transifex ([3ddace2](https://github.com/nextcloud/mail/commit/3ddace263b82dc7504ea7346d6156c7d2f4e7868))
* **l10n:** Update translations from Transifex ([1277bc8](https://github.com/nextcloud/mail/commit/1277bc892e45e34d78a2755bf7e3ed4dc59d0127))
* **l10n:** Update translations from Transifex ([4c93f30](https://github.com/nextcloud/mail/commit/4c93f307e36007340b32f80e75b753ea87cc4c07))
* **l10n:** Update translations from Transifex ([5db8d9a](https://github.com/nextcloud/mail/commit/5db8d9a72733c47019735044aaa6a2d1cc064a06))
* **l10n:** Update translations from Transifex ([14e87a1](https://github.com/nextcloud/mail/commit/14e87a15b56ba40daeef8ff328637a80e93afc95))
* **l10n:** Update translations from Transifex ([4211056](https://github.com/nextcloud/mail/commit/42110564979994a6fdbe8baefa2671640241acba))
* **l10n:** Update translations from Transifex ([0eef59d](https://github.com/nextcloud/mail/commit/0eef59d49324b1a79a7ef8b7fcb20b8ed13778f3))
* **l10n:** Update translations from Transifex ([6ce413b](https://github.com/nextcloud/mail/commit/6ce413bb6365d6b82b6d55a78160ea68b33d8359))
* **l10n:** Update translations from Transifex ([0f90f19](https://github.com/nextcloud/mail/commit/0f90f19d946e0cdf0430a5ab973754b630884c99))
* **l10n:** Update translations from Transifex ([5d1535d](https://github.com/nextcloud/mail/commit/5d1535d4a1d18cb658d69400a4c20822f553af2a))
* **l10n:** Update translations from Transifex ([693771f](https://github.com/nextcloud/mail/commit/693771fae8887724bc3337b2bdb0b5137ede3090))
* **l10n:** Update translations from Transifex ([2841421](https://github.com/nextcloud/mail/commit/28414219b5bc1b34c04a99d4623b986c7fd2514d))
* **l10n:** Update translations from Transifex ([0a746cf](https://github.com/nextcloud/mail/commit/0a746cfef45de9707a9b866a3d591666b781cecb))
* **l10n:** Update translations from Transifex ([4ee2065](https://github.com/nextcloud/mail/commit/4ee2065b1c16fdc3c2991eaeb16796f523ed1b11))
* **l10n:** Update translations from Transifex ([8027c52](https://github.com/nextcloud/mail/commit/8027c5244ab9f6f2dda5f15d703206699a5a2654))
* **l10n:** Update translations from Transifex ([8d84ac9](https://github.com/nextcloud/mail/commit/8d84ac90cc01dd50c0b02c36baf53829245eca31))
* **l10n:** Update translations from Transifex ([1c088bb](https://github.com/nextcloud/mail/commit/1c088bbe13525a5aca1540ce1ed1e387a45e8751))
* **l10n:** Update translations from Transifex ([3e6bc95](https://github.com/nextcloud/mail/commit/3e6bc95128afb3a00e570cba136814a5b681601b))
* **l10n:** Update translations from Transifex ([5d0df22](https://github.com/nextcloud/mail/commit/5d0df22ddfd0dbb5b35f702700e3d7e9741523f4))
* **l10n:** Update translations from Transifex ([ee2e98e](https://github.com/nextcloud/mail/commit/ee2e98e589c8e467aa15ececa50b80825e42582b))
* **l10n:** Update translations from Transifex ([d4b222a](https://github.com/nextcloud/mail/commit/d4b222ad37d39e08f92c19590792196049ec3725))
* **l10n:** Update translations from Transifex ([4301b55](https://github.com/nextcloud/mail/commit/4301b557c537da6a57bbe51df50c41e340017825))
* **l10n:** Update translations from Transifex ([ff4f00c](https://github.com/nextcloud/mail/commit/ff4f00c8d0e6e15af9d2b3a68df891bfbcf20089))
* **l10n:** Update translations from Transifex ([385edc0](https://github.com/nextcloud/mail/commit/385edc0e283226c295ebf10b20b79f2d35e5651f))
* **l10n:** Update translations from Transifex ([2dbc479](https://github.com/nextcloud/mail/commit/2dbc479359d9c2a6851f49fdc283a2f1b7f1b8e4))
* **l10n:** Update translations from Transifex ([35f1831](https://github.com/nextcloud/mail/commit/35f18314a61d61014f5f439aea66d255ad9db85d))
* **l10n:** Update translations from Transifex ([9a1d23f](https://github.com/nextcloud/mail/commit/9a1d23fcf3d6167bf84374bb34ea8562505aed62))
* **l10n:** Update translations from Transifex ([261dd36](https://github.com/nextcloud/mail/commit/261dd368c06fde0643a7e164ebf75587835fc062))
* **l10n:** Update translations from Transifex ([966bdf9](https://github.com/nextcloud/mail/commit/966bdf9a283cf9695d8b5580e7d174a18d63f355))
* **l10n:** Update translations from Transifex ([7a3f2b5](https://github.com/nextcloud/mail/commit/7a3f2b51a9e1dd41af78c8a3e364419c69373a3f))
* **l10n:** Update translations from Transifex ([de92421](https://github.com/nextcloud/mail/commit/de924212f802c351ef708890c7b6a677f6a98402))
* **l10n:** Update translations from Transifex ([4da1267](https://github.com/nextcloud/mail/commit/4da12670673bbde80c2f439702832d5947b8a238))
* **l10n:** Update translations from Transifex ([a8bf321](https://github.com/nextcloud/mail/commit/a8bf321975cff3a310edb7ca33338431631d34a5))
* **l10n:** Update translations from Transifex ([d387e38](https://github.com/nextcloud/mail/commit/d387e38620a26d00255627a1e52862a765b055a3))
* **l10n:** Update translations from Transifex ([7b77cf1](https://github.com/nextcloud/mail/commit/7b77cf1fd39e04d3f853c39be5e9862fe4351b5f))
* **l10n:** Update translations from Transifex ([100238a](https://github.com/nextcloud/mail/commit/100238a833bb77d2a3d9320630ab5027e2929e8c))
* **l10n:** Update translations from Transifex ([4d38cbf](https://github.com/nextcloud/mail/commit/4d38cbf8b5abd9d5dbfefc7a688e2ed33f0c63f1))
* **l10n:** Update translations from Transifex ([f6fcf2d](https://github.com/nextcloud/mail/commit/f6fcf2d9f529d5277d38bf6569f96e33f33628e7))
* **l10n:** Update translations from Transifex ([32536d3](https://github.com/nextcloud/mail/commit/32536d36512288317e8d28c7d2e0976664224d13))
* **l10n:** Update translations from Transifex ([3e37229](https://github.com/nextcloud/mail/commit/3e3722954b8966ce67d72c9a4692944b92d0be68))
* **l10n:** Update translations from Transifex ([3653082](https://github.com/nextcloud/mail/commit/36530829bc02816a2a7d29af03863049c8c7539c))
* **l10n:** Update translations from Transifex ([7ae6d85](https://github.com/nextcloud/mail/commit/7ae6d85fe7310e722dfbdb1162924d967243660f))
* **l10n:** Update translations from Transifex ([9efbb1a](https://github.com/nextcloud/mail/commit/9efbb1a53708b4147049beb17dd4efd95ec2066b))
* **l10n:** Update translations from Transifex ([e4fa916](https://github.com/nextcloud/mail/commit/e4fa916cfaec39d6205e192a2e3255269b204372))
* **l10n:** Update translations from Transifex ([671a425](https://github.com/nextcloud/mail/commit/671a425f9c1ecfc16540c127eb07eadb65ecb9e1))
* **l10n:** Update translations from Transifex ([d1a4df6](https://github.com/nextcloud/mail/commit/d1a4df62a8076c513ff042e2b407655fcc1f7cc7))
* **l10n:** Update translations from Transifex ([bf96880](https://github.com/nextcloud/mail/commit/bf96880672ff4a077e5994263d686826bc50c2b9))
* **l10n:** Update translations from Transifex ([f88feea](https://github.com/nextcloud/mail/commit/f88feea46903496a77ccc8842826008171f132e4))
* **l10n:** Update translations from Transifex ([5112079](https://github.com/nextcloud/mail/commit/511207976608f7b2382da25242b757c681b4cbfb))
* **l10n:** Update translations from Transifex ([a5e79e5](https://github.com/nextcloud/mail/commit/a5e79e5462bffd4cecdaff8152fe6beb0a6dca32))
* **MailTransmission:** Handle clients/servers picky about empty headers ([f60fd3b](https://github.com/nextcloud/mail/commit/f60fd3bc101d6d7090bf74d8ca83cff881135d15))
* make list rendering work on mobile ([fa921ec](https://github.com/nextcloud/mail/commit/fa921ecb68667dce91a001151a6f227690dbdfb3))
* Match default tag colors with Thunderbird ([c755afb](https://github.com/nextcloud/mail/commit/c755afbf288f3852886e096c6a0d11cff3a5708f))
* **mention:** custom range for usernames and error handling ([eacc8b5](https://github.com/nextcloud/mail/commit/eacc8b5b5fc6bbe80c38621e0620585f7c5b8d9b))
* Normalize message IDs via RFC822 parser to handle malformed input ([d03c3f1](https://github.com/nextcloud/mail/commit/d03c3f1801c5d3bbb725426887e125b4983a78c3))
* **oauth:** do not force a Microsoft 365 consent ([23216da](https://github.com/nextcloud/mail/commit/23216da8f4e30f0e8a154d53eb2e2c232415236e))
* only showing classification check box in setup form ([9f6a675](https://github.com/nextcloud/mail/commit/9f6a675e44c992e6c51b956486e43f56a0a71f82))
* **outbox:** Skip messages with status error ([438419b](https://github.com/nextcloud/mail/commit/438419b8e069aa657dc587fb5d66119e30e4cae8))
* **OutOfOfficeForm:** datepicker overlapping with sidebar ([e92759d](https://github.com/nextcloud/mail/commit/e92759d6bdfb97596a8db09891bcdf475674df3a))
* Pass actual message body to dompurify ([82000ac](https://github.com/nextcloud/mail/commit/82000acaa53a954e36e31c1feec7038cda4c9991))
* Pass error message from response to error object ([1bd84f1](https://github.com/nextcloud/mail/commit/1bd84f1b15bf78c834e85e39d97ec9bc10e576b0))
* **phishing:** change header property accessor ([db47778](https://github.com/nextcloud/mail/commit/db47778e3af93b4a3d178a489b9c7b825680ffbb))
* **php:** avoid implicit throwable to string conversion ([c83ab66](https://github.com/nextcloud/mail/commit/c83ab6630837bc289b3e7c279800894f5db5ae63))
* **php:** harden return-false-on-error type function result handling ([4dfc60e](https://github.com/nextcloud/mail/commit/4dfc60ea15c4adf72523c5528e72212674499d0d))
* **php:** refactor int/float conversions ([029d589](https://github.com/nextcloud/mail/commit/029d589d06c0303823955b927249cbf27d1be729))
* **php:** throw on json encode errors ([d501d21](https://github.com/nextcloud/mail/commit/d501d210f2c992ee30d7160d6c0cfe6ec88f3e9e))
* **php:** use type-safe string concatenation ([c8b3c1b](https://github.com/nextcloud/mail/commit/c8b3c1bdc18c03b38f7d14b00942857d256d15e1))
* **provisioning:** Do not provision users without access to mail app ([0c8864c](https://github.com/nextcloud/mail/commit/0c8864cf6f4adc765424ae237294d6c2ef4b68c0))
* quick search filters ([fd59d5f](https://github.com/nextcloud/mail/commit/fd59d5f70c2066c33336fcd043a874c60d35fcdd))
* Remove call to deprecated allowEvalScript ([77e7e3f](https://github.com/nextcloud/mail/commit/77e7e3fb89f5cc4a3e74768d9f96a282f4773eb1))
* Remove unused proxy redirect route ([32a6d46](https://github.com/nextcloud/mail/commit/32a6d46999c4e50afc45c578997b7aada3e2e297))
* Replace array with weakmap so lookup is O(1) instead of O(n^2) ([580fad6](https://github.com/nextcloud/mail/commit/580fad6f3a1668587aec2ffc32c55a0e1fb3a151))
* replace deprecated and removed OC\Server getters ([e157960](https://github.com/nextcloud/mail/commit/e157960f0d88ba82a51820c8d40a88755d429afe))
* set createdAt timestamp for local attachments ([29f84a6](https://github.com/nextcloud/mail/commit/29f84a604cdc49a476759fbfe35c61eef5537470))
* show indication that transaltion modal uses AI ([b1843d5](https://github.com/nextcloud/mail/commit/b1843d5b35e8f43a46c001470341cdb85d812964))
* show loading inidcator when searching messages ([89a2c5a](https://github.com/nextcloud/mail/commit/89a2c5a9a55b8f96242663065ce57a73b1c6b240))
* Skip iconv without a charset ([d28e6ce](https://github.com/nextcloud/mail/commit/d28e6ceff0589ddf2c53c817866e40982b03fd58))
* Skip link check for empty message ([4c7db57](https://github.com/nextcloud/mail/commit/4c7db57b2e0624c2036b1fa30eef49057ba9ad55))
* **smime:** parse email addresses from Subject Alternative Names ([#12486](https://github.com/nextcloud/mail/issues/12486)) ([b3d7c9a](https://github.com/nextcloud/mail/commit/b3d7c9a1374688b4536c9ea4ba91f4f00383c24c)), closes [nextcloud/mail#11738](https://github.com/nextcloud/mail/issues/11738)
* **textblocks:** guard removal of non existing text block ([89df2c7](https://github.com/nextcloud/mail/commit/89df2c7a88bebab3d34147c056cb267f557b7522))
* thread scrolling position ([7d4f1be](https://github.com/nextcloud/mail/commit/7d4f1be591dec2af5bacb0920ae145c0b3b3ae9c))
* **Thread:** title printing ([e9d8f77](https://github.com/nextcloud/mail/commit/e9d8f7718dcfbd18abe679693739117a43d3e063))
* **ui:** add missing @ to provisioning user ([cb11601](https://github.com/nextcloud/mail/commit/cb116018411a912c24738b362e731587a1dda3fc))
* **ui:** fix paragraph end tag ([9d9a69f](https://github.com/nextcloud/mail/commit/9d9a69fb8160671c5a77720f52e77ce4b2d493fc))
* **ui:** Handle focus trap through provide / inject ([197e25a](https://github.com/nextcloud/mail/commit/197e25ab54f621a17e2c48fb45b5f0b215203450))
* unlock mailboxes after OOM ([789c7d0](https://github.com/nextcloud/mail/commit/789c7d04fc939b455ab395f968188676dcee6179))
* use HMAC for proxied HTML iframe content ([b346f0b](https://github.com/nextcloud/mail/commit/b346f0bfa09a096c66fe1e020e57808edb736eb2))


### Features

* add ai hint for smart replys ([89c2fd6](https://github.com/nextcloud/mail/commit/89c2fd66a98371786219b3a9d1a8e5522e1d7263))
* add rtl/ltr buttons to ckeditor toolbar ([4ac9c06](https://github.com/nextcloud/mail/commit/4ac9c063b52bb68be62eee54b567af6a98d755d7))
* **deeplink:** implement message-id search and routing ([54ce486](https://github.com/nextcloud/mail/commit/54ce4865420afeedbb6cefa5bbfe8b87f163bb26))
* improve follow up and PI ML note ([c952761](https://github.com/nextcloud/mail/commit/c952761657e420795745cb7879b86b62edf12985))


### Performance Improvements

* **imap:** reuse existing IMAP client/connection for mailbox sync ([08c5031](https://github.com/nextcloud/mail/commit/08c5031ac8ef83987c36cdebd9b12f35fdd3473c))



# [5.7.0-rc.1](https://github.com/nextcloud/mail/compare/v5.7.0-beta.4...v5.7.0-rc.1) (2026-01-29)


### Bug Fixes

* action items icons on compact mode ([8b090ba](https://github.com/nextcloud/mail/commit/8b090ba2a827c47e3ffad4255b854b43e9e61b10))
* **composer:** drop envelope from store when saving a draft ([a8db9ae](https://github.com/nextcloud/mail/commit/a8db9ae14e5d33c3f80ec2399b485f589fcb1dbf))
* **deps:** bump @nextcloud/paths from 2.4.0 to v3 ([a511f5b](https://github.com/nextcloud/mail/commit/a511f5b9bfc172b91296d416ccc3b22f95d7fa2e))
* **deps:** bump core-js from 3.47.0 to ^3.48.0 ([806b9a3](https://github.com/nextcloud/mail/commit/806b9a33b0fe9d1dd5522213cd0468eae5c8fd70))
* **deps:** bump lodash from 4.17.23 to ^4.17.23 ([a1619ba](https://github.com/nextcloud/mail/commit/a1619ba3263647bc641f174c80f167699caf2337))
* **deps:** bump PHPUnit to v9.6.33 ([d4e419e](https://github.com/nextcloud/mail/commit/d4e419e5a4f2058c892aaf406ae2ddf83e8cdb74))
* **l10n:** Update translations from Transifex ([1d14470](https://github.com/nextcloud/mail/commit/1d1447052df63ee7e1bb98ecfdc857dfe56dfae0))
* **l10n:** Update translations from Transifex ([5dc7d62](https://github.com/nextcloud/mail/commit/5dc7d626fd1e2301c08e52958833f53920371667))
* **ui:** render HTML body error responses as blank pages ([a391aba](https://github.com/nextcloud/mail/commit/a391abad9560135bf159093371e432f7fc125b34))


### Performance Improvements

* **sync:** Reuse existing sync token ([cf8137a](https://github.com/nextcloud/mail/commit/cf8137a18d474fac99aa98e569374b8ed526a647))



# [5.7.0-beta.4](https://github.com/nextcloud/mail/compare/v5.7.0-beta.3...v5.7.0-beta.4) (2026-01-27)


### Bug Fixes

* **admin-settings:** bring back the setting to disable classification by default ([2eb9f0c](https://github.com/nextcloud/mail/commit/2eb9f0c07d2e1f9b6e55e5d41d3d64b6d7268c62))
* catch invalid URL exception in the HTML image proxy ([1767db6](https://github.com/nextcloud/mail/commit/1767db684ae4ee37c1ae7529c107e57798cdcc0d))
* **classification:** log if classification was executed or skipped ([172b477](https://github.com/nextcloud/mail/commit/172b4779d55497f6c9a737681c04b810e960695b))
* **deps:** bump @nextcloud/paths from 2.3.0 to ^2.4.0 ([#12286](https://github.com/nextcloud/mail/issues/12286)) ([ea43460](https://github.com/nextcloud/mail/commit/ea4346049b1b8bd899042c4861132d2fb712c697))
* **deps:** bump @nextcloud/vue from 8.35.0 to ^8.35.3 ([98b9403](https://github.com/nextcloud/mail/commit/98b9403ce9b847a772c17e8d4a7d292f813cd2e0))
* **deps:** bump lodash from 4.17.21 to v4.17.23 ([#12291](https://github.com/nextcloud/mail/issues/12291)) ([4d43742](https://github.com/nextcloud/mail/commit/4d4374223962d43b72e608d2298232e9ed86c1de))
* **imap:** Add support for mail services that enforce a client id ([0f64a8b](https://github.com/nextcloud/mail/commit/0f64a8bc7a4a01704837310a1296c6573a8f0668))
* **imap:** Send ID only when capability is announced ([820e7e3](https://github.com/nextcloud/mail/commit/820e7e37ec53b338342a535b1427cd71f15d2301))
* **l10n:** Update translations from Transifex ([f162d15](https://github.com/nextcloud/mail/commit/f162d15efebd9db5fe2053a3f7334eb4a3836d19))
* **l10n:** Update translations from Transifex ([b937da1](https://github.com/nextcloud/mail/commit/b937da1081e1260d107c9c2e29f085bd87e987da))
* **l10n:** Update translations from Transifex ([b8e73c8](https://github.com/nextcloud/mail/commit/b8e73c87c3abeb519a7d2626a13db5f2a75cb702))
* **l10n:** Update translations from Transifex ([85ec54f](https://github.com/nextcloud/mail/commit/85ec54f6e6f0650e64fe47736ced5f8f893742e5))
* **l10n:** Update translations from Transifex ([8bccd39](https://github.com/nextcloud/mail/commit/8bccd397f9bb495eb729725b8e17e580a98036c0))
* **l10n:** Update translations from Transifex ([b12a513](https://github.com/nextcloud/mail/commit/b12a5138244fff0179f49d2edd356ff4b68a2a77))
* **l10n:** Update translations from Transifex ([01442f4](https://github.com/nextcloud/mail/commit/01442f49b764fbb4da3821295b0e7591d9e524c0))
* **l10n:** Update translations from Transifex ([decb02c](https://github.com/nextcloud/mail/commit/decb02c680d7fad30aabdc5e8febd322c28f0946))
* **MessageMapper:** Use message headers as fallback when processing MIME content ([7efe164](https://github.com/nextcloud/mail/commit/7efe1640c4d4d6bcabe5ffdd3ce24b66aa62f8b7))
* **phishing:** compare links using lowercase ([2d437a9](https://github.com/nextcloud/mail/commit/2d437a9e1b71e674cc8bf1980995c485cc1de18b))
* retrieve classification preference ([5eabb5e](https://github.com/nextcloud/mail/commit/5eabb5efd13e6370592cdad4c05894b97d9f3bf4))
* **settings:** dont show acknowledgements twice ([b30d10e](https://github.com/nextcloud/mail/commit/b30d10e68f82803f1a86d1531edccd7e552a29d2))
* **smtp:** log SMTP error code ([bd3a68e](https://github.com/nextcloud/mail/commit/bd3a68e78d71a6a60ca01f29ba34bd925fc65dbe))
* **text-block:** revive sharing ([c76cea9](https://github.com/nextcloud/mail/commit/c76cea9f0a75e65a1d2a11fa28d0cfdbbe09c18d))


### Features

* add context chat provider ([#11150](https://github.com/nextcloud/mail/issues/11150)) ([0b4c310](https://github.com/nextcloud/mail/commit/0b4c3106943442ff95e272fdf9e668b7952c4859))
* **deps:** add Nextcloud 34 support, remove 31 (EOL) ([4059a84](https://github.com/nextcloud/mail/commit/4059a84cfe3e6bc43a5fd1cd4ce0ba0a81b500bd))



# [5.7.0-beta.3](https://github.com/nextcloud/mail/compare/v5.7.0-beta.2...v5.7.0-beta.3) (2026-01-19)


### Bug Fixes

* **l10n:** Update translations from Transifex ([a0302e7](https://github.com/nextcloud/mail/commit/a0302e7292c0a003311bc0ae13c93fdc66477034))
* **l10n:** Update translations from Transifex ([301879c](https://github.com/nextcloud/mail/commit/301879cccc134ccdf0b57968264eba5b9e6af3d3))
* **l10n:** Update translations from Transifex ([eb08d2d](https://github.com/nextcloud/mail/commit/eb08d2d6b8b46021982ed6d3eccfc95b45a2373a))


### Features

* automated appointment creation ([4fe0325](https://github.com/nextcloud/mail/commit/4fe03253203db6c3481e1fb5611b2291f2ac6476))



# [5.7.0-beta.2](https://github.com/nextcloud/mail/compare/v5.7.0-beta.1...v5.7.0-beta.2) (2026-01-16)


### Bug Fixes

* **ColorPicker:** Use v-model for injecting selected color to color picker ([eee627a](https://github.com/nextcloud/mail/commit/eee627a613a3c3884af4ebc19f23d15ba5c4b1a4))
* **DKIMValidator:** Add patch from upstream against broken canonical handling ([ddb30a9](https://github.com/nextcloud/mail/commit/ddb30a95fe8f106c2abebb323bc5c13bacfc0e0f))
* ensure drafts folder exists ([c01706f](https://github.com/nextcloud/mail/commit/c01706f6dea5f3acd5ebfb5859026c4110a4a653))
* Fix incorrect tag for MDN sent and hide junk flag used by Thunderbird ([5eb1709](https://github.com/nextcloud/mail/commit/5eb1709f405175c28060a0f85f1f8fedcfa8c45d))
* **l10n:** Update translations from Transifex ([5e479aa](https://github.com/nextcloud/mail/commit/5e479aa5c3403ef8fa020236da9e0af81683eae1))
* **l10n:** Update translations from Transifex ([e3d87b7](https://github.com/nextcloud/mail/commit/e3d87b737b08b0af46266bb5429ed8f3a18d9d7f))
* **l10n:** Update translations from Transifex ([7f7046e](https://github.com/nextcloud/mail/commit/7f7046e664c2abccf59a77d51708b78792302ec1))
* **l10n:** Update translations from Transifex ([3ec8cc7](https://github.com/nextcloud/mail/commit/3ec8cc741ca13b7f84de80f659ad1698f318d029))
* **l10n:** Update translations from Transifex ([77fad89](https://github.com/nextcloud/mail/commit/77fad89b78dd4175557d7f0a6880db3b474d73fd))
* **l10n:** Update translations from Transifex ([69c30ee](https://github.com/nextcloud/mail/commit/69c30ee6ed066f30cdb3dfc6043eb86cb0d3026c))
* **mail-settings:** avoid duplicate api calls ([d43846f](https://github.com/nextcloud/mail/commit/d43846f3f39a1d4232dccb3c81953bd747d11e28))
* outbox icon opacity ([8697eb7](https://github.com/nextcloud/mail/commit/8697eb72f1835a0c110ad0c0ccfef85c043f1ead))
* **OutOfOfficeParser:** Exclude newsletters and mailing lists from auto responder ([4dd3824](https://github.com/nextcloud/mail/commit/4dd382487bc50b84076dace4c45b2a3c2f73b7c3))
* revive mentioning in composer ([2658a3b](https://github.com/nextcloud/mail/commit/2658a3bbdaf4ebd6828493193fff8856ec058455))
* safe-guard limit argument ([bd856c0](https://github.com/nextcloud/mail/commit/bd856c0f261df1fd8f73d1952cbeb5773fad0d8a))


### Features

* **deps:** add PHP8.5 support ([0cab661](https://github.com/nextcloud/mail/commit/0cab6615ab3575264fe5ad01622be13f40216e10))
* list attachements ([7cb3b70](https://github.com/nextcloud/mail/commit/7cb3b70922d8ad9f0ab39388d0c5280aa7245b0c))
* provide attachement names for messages ([aebeb8d](https://github.com/nextcloud/mail/commit/aebeb8de6c62a7a89f78247b5539d48ee6213d61))



# [5.7.0-beta.1](https://github.com/nextcloud/mail/compare/v5.6.0-rc.1...v5.7.0-beta.1) (2026-01-09)


### Bug Fixes

* add Opt-out classification settings to account settings and setup ([773e9fd](https://github.com/nextcloud/mail/commit/773e9fda4ae667c7be730093f3b2b05f23e67936))
* **auth:** show more specific error for denied authentication ([9887471](https://github.com/nextcloud/mail/commit/9887471c972f99103f18f8bd85ac945045886a33))
* **database:** Add foreign key to *_mailbox_id fields in mail_accounts table ([d6e5430](https://github.com/nextcloud/mail/commit/d6e5430211bb0c70b047ef6eb6709f35a1692509))
* **deps:** bump @nextcloud/dialogs from 6.4.1 to ^6.4.1 ([ea96397](https://github.com/nextcloud/mail/commit/ea96397ffc21590dacf241ff96a27507bd6d4160))
* **deps:** bump @nextcloud/dialogs from 6.4.1 to ^6.4.2 ([#12194](https://github.com/nextcloud/mail/issues/12194)) ([e0bde6a](https://github.com/nextcloud/mail/commit/e0bde6a0df760b82906631a0b172e6da4083c23d))
* **deps:** bump @nextcloud/files from 3.12.0 to ^3.12.2 ([#12180](https://github.com/nextcloud/mail/issues/12180)) ([2d31d47](https://github.com/nextcloud/mail/commit/2d31d47ef1b4977a0fc3a12465b310412aeb1231))
* **deps:** bump @nextcloud/l10n from 3.4.0 to ^3.4.1 ([#12054](https://github.com/nextcloud/mail/issues/12054)) ([9204207](https://github.com/nextcloud/mail/commit/92042075da02b2eb0cd104132f7e456353b4638d))
* **deps:** bump @nextcloud/logger from 3.0.2 to ^3.0.3 ([#12181](https://github.com/nextcloud/mail/issues/12181)) ([a2cc94f](https://github.com/nextcloud/mail/commit/a2cc94fbf3df4b9acbb1151c2ef817a8236f4b1f))
* **deps:** bump @nextcloud/paths from 2.2.1 to ^2.3.0 ([d79f091](https://github.com/nextcloud/mail/commit/d79f091deed13cc59551431faeaae31ad9667e98))
* **deps:** bump @nextcloud/router from 3.0.1 to ^3.1.0 ([fecbbd4](https://github.com/nextcloud/mail/commit/fecbbd42eacbdb920e4e14f054474688bd211eca))
* **deps:** bump bamarni/composer-bin-plugin from 1.8.2 to ^1.8.3 ([#12083](https://github.com/nextcloud/mail/issues/12083)) ([d768ec2](https://github.com/nextcloud/mail/commit/d768ec2e6fd19fc3164d304c41f3ffdd69f1c45c))
* **deps:** bump core-js from 3.45.1 to ^3.47.0 ([10cb94d](https://github.com/nextcloud/mail/commit/10cb94d3abfe5fd61087c5a5fe76c5e469eb31ab))
* **deps:** bump dompurify from 3.3.0 to ^3.3.1 ([#12153](https://github.com/nextcloud/mail/issues/12153)) ([8414b45](https://github.com/nextcloud/mail/commit/8414b459171e748b0bda9707c083dc4d457b8610))
* **deps:** bump ezyang/htmlpurifier from 4.18.0 to v4.19.0 ([490c501](https://github.com/nextcloud/mail/commit/490c501838ea78db143064557b599a9d9b377a0d))
* **deps:** bump nextcloud/openapi-extractor from 1.8.6 to ^1.8.7 ([4ad219b](https://github.com/nextcloud/mail/commit/4ad219b224b20649ea2da3b288078a3fdba276ef))
* **deps:** bump node-forge from 1.3.1 to ^1.3.2 ([#12084](https://github.com/nextcloud/mail/issues/12084)) ([1076149](https://github.com/nextcloud/mail/commit/1076149f447356f0d8256f8011e73a66bde45e76))
* **deps:** bump node-forge from 1.3.2 to ^1.3.3 ([#12201](https://github.com/nextcloud/mail/issues/12201)) ([bf00dc9](https://github.com/nextcloud/mail/commit/bf00dc96b2486c6f1c74406f8f323306c420726e))
* **deps:** bump ramda from 0.31.3 to ^0.32.0 ([99e93d3](https://github.com/nextcloud/mail/commit/99e93d350bb2ac7fb77b487ac7fcfc6a2923ba6d))
* **deps:** bump stylelint from 16.25.0 to ^16.26.1 ([6f16930](https://github.com/nextcloud/mail/commit/6f16930cf5fef0ad4ee8747e186de58326000d80))
* **deps:** Fix npm audit ([ba1c955](https://github.com/nextcloud/mail/commit/ba1c9555e04c9acc7f9b75ad9914062b16ef81ac))
* **deps:** Fix npm audit ([94220b5](https://github.com/nextcloud/mail/commit/94220b5a296c07c0b1a5035685671e5fb34531c7))
* **dns:** Update public suffix list ([8629a40](https://github.com/nextcloud/mail/commit/8629a403aa29dfad58955c07ac7575e86fb97dde))
* **envelope:** apply read/unread for whole thread ([04141fb](https://github.com/nextcloud/mail/commit/04141fb8cb75893d93a4ab144e6c50acba78fc35))
* handle imip failures properly ([3a200ac](https://github.com/nextcloud/mail/commit/3a200ac432e3a8d85eafa93b01f0b2d4ab1b3080))
* **imap:** cache message body ([9d02d5a](https://github.com/nextcloud/mail/commit/9d02d5ab90fdcf2c9fd2e09a3a3e7547b74227c3))
* **l10n:** Update translations from Transifex ([42b9b4d](https://github.com/nextcloud/mail/commit/42b9b4d9bf4c798930bb2714f546aac39c87c2b1))
* **l10n:** Update translations from Transifex ([ed559d1](https://github.com/nextcloud/mail/commit/ed559d1e80ad7745eeaa1fa7eabf715b96594403))
* **l10n:** Update translations from Transifex ([addd0f4](https://github.com/nextcloud/mail/commit/addd0f430807e08befd63f327857c33a379702e1))
* **l10n:** Update translations from Transifex ([fb376e5](https://github.com/nextcloud/mail/commit/fb376e51cb9437c9621e6fca3287d5983e8ac00f))
* **l10n:** Update translations from Transifex ([83c7bc8](https://github.com/nextcloud/mail/commit/83c7bc8f05ad4d4fc37e9d49a9aaf37e07c9f0fd))
* **l10n:** Update translations from Transifex ([1003f6c](https://github.com/nextcloud/mail/commit/1003f6c59a6377c247f7ddcc1dff0a65120389c6))
* **l10n:** Update translations from Transifex ([2dd51c8](https://github.com/nextcloud/mail/commit/2dd51c8bb9670998eb0ef5114ecdb0811ae17ab7))
* **l10n:** Update translations from Transifex ([4d25ae4](https://github.com/nextcloud/mail/commit/4d25ae4430bf9278283d2f10007e5d8ea8f4a36f))
* **l10n:** Update translations from Transifex ([6de0c2a](https://github.com/nextcloud/mail/commit/6de0c2a0df34804c008308cb2c7b490376f650d0))
* **l10n:** Update translations from Transifex ([7f70324](https://github.com/nextcloud/mail/commit/7f70324ab39a463b09b5fbb96083a8fd94e97f66))
* **l10n:** Update translations from Transifex ([8551ded](https://github.com/nextcloud/mail/commit/8551ded3ca1c3782404b2404bd5e21ec30ddedee))
* **l10n:** Update translations from Transifex ([d1f55af](https://github.com/nextcloud/mail/commit/d1f55af88b2375550165db7edc0fbcab31c310a4))
* **l10n:** Update translations from Transifex ([a6ea034](https://github.com/nextcloud/mail/commit/a6ea0343b0badc571c3d29d2a4efb31ef8bb05dc))
* **l10n:** Update translations from Transifex ([a3416c7](https://github.com/nextcloud/mail/commit/a3416c7815ab1bb9947119d9a354bf3f4ad90860))
* **l10n:** Update translations from Transifex ([d3e93a1](https://github.com/nextcloud/mail/commit/d3e93a1ced32dee98d09aa2e6ba7bddc3b369910))
* **l10n:** Update translations from Transifex ([0ce95b3](https://github.com/nextcloud/mail/commit/0ce95b38c98ef7f3d6907e15862b71a1b5bfab2d))
* **l10n:** Update translations from Transifex ([c771327](https://github.com/nextcloud/mail/commit/c7713273832adc78c0af6a00dbe6be80f01846f6))
* **l10n:** Update translations from Transifex ([172f154](https://github.com/nextcloud/mail/commit/172f15485357e8602e2dfa5277baa26aaabe8455))
* **l10n:** Update translations from Transifex ([b5a785c](https://github.com/nextcloud/mail/commit/b5a785c4e128a82181f200d72c0298e6bd8879e3))
* **l10n:** Update translations from Transifex ([c37fc3e](https://github.com/nextcloud/mail/commit/c37fc3eab5db926794d33e19a7bd9ea21a55a0fa))
* **l10n:** Update translations from Transifex ([dbafedc](https://github.com/nextcloud/mail/commit/dbafedc1533cb2c24f6b3638fd635ba6824c392b))
* **l10n:** Update translations from Transifex ([dd44f8b](https://github.com/nextcloud/mail/commit/dd44f8bc4babdcfb171fc34b8a0b8d667e7c1031))
* **l10n:** Update translations from Transifex ([26c72b0](https://github.com/nextcloud/mail/commit/26c72b0ba59f8d6e1bbde63a71cbf223466e5744))
* **l10n:** Update translations from Transifex ([55eda0d](https://github.com/nextcloud/mail/commit/55eda0de06adce44f751f545bd02bbed3dfbe064))
* **l10n:** Update translations from Transifex ([d3a945b](https://github.com/nextcloud/mail/commit/d3a945b2634924e2af5cc0e774d13719d9755484))
* **l10n:** Update translations from Transifex ([76b9c96](https://github.com/nextcloud/mail/commit/76b9c966e0dec4cc2efb12be3a30483d56632d3a))
* **l10n:** Update translations from Transifex ([76688a4](https://github.com/nextcloud/mail/commit/76688a4e62240200c84755a191358f437bf042b6))
* **l10n:** Update translations from Transifex ([4eb03df](https://github.com/nextcloud/mail/commit/4eb03df9d408e24f6c168eebfdfb8f10469d4b62))
* **l10n:** Update translations from Transifex ([7365ec4](https://github.com/nextcloud/mail/commit/7365ec43d8fbc1d72f1ca502a57916afe2a3e2aa))
* **l10n:** Update translations from Transifex ([11779b5](https://github.com/nextcloud/mail/commit/11779b5623c5aa566e42c7bb6faa50f57eaefcb3))
* **l10n:** Update translations from Transifex ([7836ba5](https://github.com/nextcloud/mail/commit/7836ba59530d27a1836ab8fdedcd9bb71d60deb2))
* **l10n:** Update translations from Transifex ([333fa26](https://github.com/nextcloud/mail/commit/333fa26765abcda6c2fa957e9cbbeb6314051cd2))
* **l10n:** Update translations from Transifex ([7bed24d](https://github.com/nextcloud/mail/commit/7bed24d426cf5fa35456f5d14375758a84c5e780))
* **l10n:** Update translations from Transifex ([770b95a](https://github.com/nextcloud/mail/commit/770b95a67ef91a35e439c74ce361219bf0afd543))
* **l10n:** Update translations from Transifex ([2a8d58b](https://github.com/nextcloud/mail/commit/2a8d58be6f25064dbe8a7ac4bbbc689af6aef267))
* **l10n:** Update translations from Transifex ([1fbba54](https://github.com/nextcloud/mail/commit/1fbba545b28dace804e98eeb5418cd8508e070d1))
* **l10n:** Update translations from Transifex ([2f6b08c](https://github.com/nextcloud/mail/commit/2f6b08ced35c3c103fdf20f9f127146f2d93cd95))
* **l10n:** Update translations from Transifex ([27deb8e](https://github.com/nextcloud/mail/commit/27deb8ed2738a002736333535e88232e95d03481))
* lost line breaks ([056e1cf](https://github.com/nextcloud/mail/commit/056e1cf6ba1116b47b60fd45d84bf75209c59f59))
* **mailto:** populate body from mailto ([6e66374](https://github.com/nextcloud/mail/commit/6e663740308588aeefc6bc7db90d1ef24ba7cafd))
* **NavigationMailbox:** reword ([8bd6dd8](https://github.com/nextcloud/mail/commit/8bd6dd804864cd2af42e76cff87f89b614a65a46))
* **NewMessageModal:** remove null focus trap selectors ([0412d17](https://github.com/nextcloud/mail/commit/0412d17db83afb84b6a104c3c85de93cdbd60623))
* **oauth:** close popup window in parent window ([1fdf307](https://github.com/nextcloud/mail/commit/1fdf307f4755ef43aedde1263c46d187b2995d5c))
* search input field doesnt extend properly ([2581870](https://github.com/nextcloud/mail/commit/2581870a78cc5b7d3f6b3a5dbe2287e0302a75c1))
* **search:** apply correct search query when fetching envelopes ([4fe8329](https://github.com/nextcloud/mail/commit/4fe8329e1e2fee7be6853df3ddf98fe9fb2a6e3b))
* **Settings:** followup on redesign ([67dae9c](https://github.com/nextcloud/mail/commit/67dae9c9b70330ffe9742ab8660c3998423ef007))
* **setup:** allow setup with ms oauth and no password ([899f6f4](https://github.com/nextcloud/mail/commit/899f6f4d71ff39ac9d54212c2cb6b165a2d48bc0))
* **sieve:** allow system flags like seen ([226e2d3](https://github.com/nextcloud/mail/commit/226e2d35e10ee9183158b35fc8fd47f7c5dfeec6))
* **sieve:** ensure the stop action is always last ([e3d43c4](https://github.com/nextcloud/mail/commit/e3d43c4b9fb2339b45ee813fc8089e040930c582))
* **text-block:** preserve line breaks on plain text ([9d5d3a9](https://github.com/nextcloud/mail/commit/9d5d3a92f41100b76730837c39fece9a210e463e))
* **ui:** bind attr to popover trigger ([b17e04c](https://github.com/nextcloud/mail/commit/b17e04c217d32d4be97fc249c8d062f8d730368b))


### Features

* add sort favorites user preference ([b22afd4](https://github.com/nextcloud/mail/commit/b22afd4a18a99d4ea84b45e73d1a677b02a7744a))
* compact view for mail layouts ([7eb1ff0](https://github.com/nextcloud/mail/commit/7eb1ff092b27253583a29dfae9ab14a2cc07e677))
* imporove search filter buttons ([a21c29b](https://github.com/nextcloud/mail/commit/a21c29b423a16eec1aa3aa4d25de4a191065851e))
* improve the search filter shortcut buttons ([b0c3559](https://github.com/nextcloud/mail/commit/b0c355921a0fc8e31170a3314f28ffb4a22724de))
* make email wide on phone ([09ada44](https://github.com/nextcloud/mail/commit/09ada44d35871db527c902c14210fa2e8181b252))
* manually refresh folder list ([22c7181](https://github.com/nextcloud/mail/commit/22c71813ded17ab3ac26f3e3b993abce1fe9d729))
* **PhishingDetection:** Add support for the $Phishing IMAP flag ([6c01c8a](https://github.com/nextcloud/mail/commit/6c01c8a2db557231bdf8a84d4b921ab9e80871b1))
* pin favorites ([6718656](https://github.com/nextcloud/mail/commit/67186566f2f30025409a9948e0ae362ca3cd22f4))
* support user migration ([cc7c592](https://github.com/nextcloud/mail/commit/cc7c5926d3cba10009d86db6b1ff2bf5a8172b49))


### Performance Improvements

* **quick-actions:** eliminate dublicate api calld for each envelope ([71cccdf](https://github.com/nextcloud/mail/commit/71cccdfef182a4dfaaf4b14e5f17d0e042ac7870))
