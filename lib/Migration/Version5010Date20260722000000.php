...
/**
 * Cover the mailbox-local keyset pagination path.
 *
 * PostgreSQL builds this concurrently so a multi-million-row mail table can
 * remain readable and writable throughout the migration. Other supported
 * platforms use the portable schema API; all can scan the same btree in
 * either direction for newest-first and oldest-first listings.
 *
 * @psalm-api
 */
